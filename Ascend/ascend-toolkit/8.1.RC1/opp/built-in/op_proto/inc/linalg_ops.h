...
*@li adjoint: An optional bool. Defaults to False. Boolean indicating whether to solve
...
*@par Attributes:
*@li compute_uv: An optional bool. Defaults to True. If True then left and right singular vectors will be computed and
returned in u and v, respectively. Otherwise, only the singular values will
be computed, which can be significantly faster .
*@li full_matrices: An optional bool that param effect u,v. Defaults to False. \n
...
* @par Inputs:
* @li x: A Tensor. Must be one of the following types: double, float32, float16, bfloat16, complex32, complex64, complex128,
