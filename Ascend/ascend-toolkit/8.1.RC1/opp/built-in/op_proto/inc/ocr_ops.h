...
*@par Attributes:
*@li batch_size: An optional int. Batch size. Defaults to 8.
*@li queue_name: An optional string. Queue name. Defaults to "".
*@li queue_depth: An optional int. Queue depth. Defaults to 100.
...
*@par Outputs:
*@li imgs: A Tensor of type uint8. Multi imgs data after reconition pre handle.
*@li imgs_relation: A Tensor of type int32. Output imgs orders in input imgs.
*@li imgs_lang: A Tensor of type int32. Output batch imgs langs.
*@li imgs_piece_fillers: A Tensor of type int32. Output batch imgs piece fillers.

*@par Attributes:
*@li batch_size: An optional int. Defaults to 8. Batch size.
...
*@par Attributes:
*@li value_mode: An optional int. Defaults to 0. \n
*/
...
*@par Outputs:
*@li imgs_data: A Tensor of type uint8. imgs_data of original image.
