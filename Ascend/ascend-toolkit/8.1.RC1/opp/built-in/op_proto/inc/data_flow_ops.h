...
*@li shapes:An optional attribute. A list of fully-defined TensorShape objects with the
same length as dtypes, or None.
*@li capacity:An optional int. The upper bound on the number of elements that may
...
*@li shared_name: An optional string. Defaults to "". If non-empty, this queue will be shared under
...
*@par Attributes:
*@li capacity: An optional int. A list of DTypes
...
*@li dtypes: An optional attribute. A list of DTypes. \n
...
*@li container: An optional string. Defaults to "".
*@li shared_name: An optional string. Defaults to "".
*@li dtypes: An optional attribute. A list of DTypes that has length >= 1. \n
...
*@li capacity: An optional int that is >= 0. Defaults to "0".
*@li memory_limit: An optional int that is >= 0. Defaults to "0".
*@li dtypes: An optional atribute. A list of tf.DTypes.
*@li container: An optional string. Defaults to "".
*@li shared_name: An optional string. Defaults to "". \n
...
*@li capacity: An optional int that is >= 0. Defaults to "0".
*@li memory_limit: An optional int that is >= 0. Defaults to "0".
*@li dtypes: An optional attribute. A list of tf.DTypes.
*@li container: An optional string. Defaults to "".
*@li shared_name: An optional string. Defaults to "". \n
...
*@li capacity: An optional int that is >= 0. Defaults to "0".
*@li memory_limit: An optional int that is >= 0. Defaults to "0".
*@li dtypes: An optional attribute. A list of tf.DTypes that has length >= 1.
*@li container: An optional string. Defaults to "".
*@li shared_name: An optional string. Defaults to "". \n
...
*@li element_shape: An optional attribute. The TensorShape of elements in this TensorArray.
*@li dynamic_size: An optional bool. A boolean that determines whether writes to the
TensorArray are allowed to grow the size. Default is false.
*@li clear_after_read: An optional bool. Default is true. If true, clear
TensorArray values
after reading them. This disables read-many semantics, but allows early
release of memory.
*@li identical_element_shapes: An optional bool. Default is false. If true, then all elements
in the TensorArray will be expected to have have identical shapes.
*@li tensor_array_name: An optional string, the name of the TensorArray. Default is "". \n
...
*@li shapes: An optional attribute. A list of fully-defined TensorShape objects with
the same length as dtypes, or None.
*@li capacity: An optional int. The upper bound on the number of elements that may
be stored in this queue. Default is -1.
*@li min_after_dequeue: An optional int that described above. Default is 0.
*@li seed: An optional int. Used to create a random seed. Default is 0.
*@li seed2: An optional int. Used to create a random seed. Default is 0.
*@li container: An optional string. Defaults to "".
*@li shared_name: An optional string. Defaults to "". \n
...
*@li container: An optional string. Defaults to "". If non-empty, this queue
is placed in the given container. Otherwise, a default container is used.
*@li capacity:An integer. Defaults to "-1". The upper bound on the number of elements that may be stored in this queue.
...
*@par Attributes:
*@li channel_name: name of operator channel, defaults to "".
...
*@li channel_name: A string. Defaults to "". \n
...
* @par Inputs:
* @li inputs: A list of input tensor objects. Must be one of the following types: 
...
* @par Inputs:
* @li x: the tensor to split. Must be one of the following types:
...
* @par Attributes:
* @li axis: An optional int, which axis to split on, a negative value means counting dimensions from
* the back, accepted range is [-rank, rank - 1]. Default is 0.
* @li keep_dims: An optional bool, whether to keep the split dimension or not. If true, which means we keep split
...
* @par Outputs:
* @li y: concatenated tensor. Must be one of the following types:
* uint8, uint16, uint32, uint64, int8, int16, int32, int64, float16, float,
* double, bool, complex64, complex128.\n

* @par Attributes:
* @li axis: An optional int, which axis to concat on, accepted range in [-r, r - 1], where r is the rank of input
* tensor, when new_axis is 1,accepted range is [-r - 1, r]
* @li new_axis: An optional int, insert and concatnate on a new axis or not. default 0 means do not insert new axis.
*/
