...
*@par Attributes:
*@li dtype: required, output data typetype. Must be one of the following types: int32, int64. \n
...
*@par Attributes:
*@li dtype: required, output data type. Must be one of the following types: float16, float32, double, int32, int64. \n
