...
* The shape, data type and format must be the same as grad.\n

*@par Attributes:
* axis: An optional list of ints. Defaults to "{-1}" . \n

*@par Outputs:
* y: A Tensor. Has the same type and shape with "grad" . \n
...
*@par Inputs:
* Two inputs, including:
* @li features: A Tensor. Unnormalized scores from model output. Must be one of the following types: float16, bfloat16, float32, double.
...
* @li labels: A Tensor. of the same type and format as "features". The true labels of the samples. A "batch_size * num_classes" matrix.
* Has the type, format and shape as "features". \n

*@par Outputs:
* @li loss: A Tensor for per example loss (a "batch_size" vector). Has the same type and format as "features". Support 1D, 3D.
...
* @li weight: A 1-dimensional Tensor of type float16 or float32, specifying the weight value. \n
...
* @par Inputs:
* Three inputs, including:
* @li x: A 1D or 2D Tensor of type bfloat16, float16 or float32, 
*   specifying a predictive value, Support ND or 5HD.
* @li y: A 1D or 2D Tensor of type bfloat16, float16 or float32, 
*   indicating a tag, Support ND or 5HD.
* @li weight: An optional 1D or 2D Tensor of type bfloat16, float16 or float32, 
*   specifying the weight, Support ND or 5HD.

* @par Attributes:
* reduction: A character string from "none", "mean", and "sum", specifying the reduction type to be 
* applied to the output. Defaults to "mean".

* @par Outputs:
* output: a Tensor for Output loss. Has the same type and dimension with the inputs. 
* When "reduction" is set to "none", a Tensor with the same size as "x" is output. Otherwise, a Scalar is output.
...
* @par Attributes:
* @li axes: A optional list of int. The dimension softmax would be performed on. Defaults
*  to "[-1]" . \n
...
*@par Inputs:
*One input:
* logits: A ND tensor. Must be one of the following types: double, bfloat16, float16, float32 . \n

*@par Attributes:
* axes: An optional list of ints. Defaults to "{-1}" . \n

*@par Outputs:
* logsoftmax: A ND tensor. Has the same type as "logits" . \n
...
* Indicates the reverse input tensor. The format must be FRACTAL_NZ. Support 4D ~ 8D. 
* @li x1: A tensor dtype of bfloat16, float16, float32. Indicates the inverse gradient.
* The format must be FRACTAL_NZ. Support 4D ~ 8D.
...
*@li keep_dims: A bool attr. Whether to keep the dimension number. Defaults to false.
...
* @li gamma: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li beta: A ND Tensor. Must be one of the following types: float16, float32, bfloat16. \n
...
*Four inputs, including:
* @li x: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li normalized_shape: A ND Tensor. Must be one of the following types: int32
...
*@par Inputs:
*One input, including:
* x: A Tensor. Support following types: float16, float32, bfloat16 type. \n
...
*     float16, float32, bfloat16 (bfloat16 only supported on Atlas A2 Training Series Product/Atlas 800I A2
...
*@attention Constraints:
*For Atlas 200/300/500 Inference Product, the result accuracy fails to reach 1<89> due to the square root instruction.
...
* @par Inputs:
* Five inputs, including:
* @li dy: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW].
* @li x: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW].
* @li variance: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW](DHW=1).
* @li mean: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW](DHW=1).
* @li gamma: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW](DHW=1). \n

* @par Outputs:
* Three outputs, including:
* @li pd_x: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW].
* @li pd_gamma: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW](DHW=1).
* @li pd_beta: A 4D or 5D Tensor. Must be one of the following types: float16, float32.
*  support format: [NCHW, NHWC, NDHWC, NCDHW](DHW=1).
...
* specifying the target value. Has the same type as "predict".\n

* @par Attributes:
* @li sigma: An optional float. Specifies the threshold of loss. Defaults
* to "1.0". \n
...
* @li x: A tensor. Must be one of the following types: int8, uint8, int16, uint16, int32, int64, float16, float32, double.
* @li shift: The number of places by which the elements of the tensor are shifted. Must be one of the following types: int32, int64.
* @li axes: Axis along which to roll. Must be one of the following types:  int32, int64. \n
