 ...
 * @par Inputs:
 * @li start: An int32 scalar. The lower bound.
 * @li limit: An int32 scalar. The upper bound.
 * @li delta: An int32 scalar. The step size.
 ...
 * @par Inputs:
 * @li x: The data of input. All types are available. It's a dynamic input.
 * @li outputshape: The shape of previous op output shape. All types are available. It's a dynamic input. \n

 * @par Outputs:
 * @li tiling_data: A Tensor. Must be one of the following types: uint8. Tiling data of tiling function.
 *                 It should be a buffer.
 * @li tiling_key: A Tensor. Must be one of the following types: uint64. Tiling key of tiling function.
 * @li block_dim: A Tensor. Must be one of the following types: int32. Block dim of tiling function.
 * @li tiling_cond: A Tensor. Must be one of the following types: int32.
