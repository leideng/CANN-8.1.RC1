...
class Mask2Argmax():
    ...
    def fun_no_cut(self, block_index, nc1_size, nc1_index):
        ...
        index_16 = self.tik_instance.Tensor("float32", (64,),
                                            name="index_16",
                                            scope=tbe_platform.scope_ubuf)
        tmp_w = self.tik_instance.Tensor("int32", (16,), name="tmp_w", scope=tbe_platform.scope_ubuf)
        tmp_w2 = self.tik_instance.Tensor("float16", (16,), name="tmp_w2", scope=tbe_platform.scope_ubuf)
        tmp_w3 = self.tik_instance.Tensor("float32", (16,), name="tmp_w3", scope=tbe_platform.scope_ubuf)
