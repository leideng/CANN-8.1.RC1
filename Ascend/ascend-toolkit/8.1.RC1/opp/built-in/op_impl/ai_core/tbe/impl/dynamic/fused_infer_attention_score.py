...
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.DYNAMIC_INPUT, para_check.DYNAMIC_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def fused_infer_attention_score(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, actual_seq_lengths_kv_in__=None, dequant_scale1_in__=None, quant_scale1_in__=None, dequant_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, block_table_in__=None, query_padding_size_in__=None, kv_padding_size_in__=None, key_antiquant_scale_in__=None, key_antiquant_offset_in__=None, value_antiquant_scale_in__=None, value_antiquant_offset_in__=None, key_shared_prefix_in__=None, value_shared_prefix_in__=None, actual_shared_prefix_len_in__=None, query_rope_in__=None, key_rope_in__=None, key_rope_antiquant_scale_in__=None, attention_out_out_=None, softmax_lse_out_=None, num_heads=0, scale=1, pre_tokens=2147483647, next_tokens=2147483647, input_layout="BSH", num_key_value_heads=0, sparse_mode=0, inner_precise=1, block_size=0, antiquant_mode=0, softmax_lse_flag=False, key_antiquant_mode=0, value_antiquant_mode=0, kernel_name="fused_infer_attention_score", impl_mode=""):
    ...
    msg = "start compile Acend C Operator FusedInferAttentionScore, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, query_padding_size_in__, kv_padding_size_in__, key_antiquant_scale_in__, key_antiquant_offset_in__, value_antiquant_scale_in__, value_antiquant_offset_in__, key_shared_prefix_in__, value_shared_prefix_in__, actual_shared_prefix_len_in__, query_rope_in__, key_rope_in__, key_rope_antiquant_scale_in__], origin_outputs = [attention_out_out_, softmax_lse_out_],\
                param_type_dynamic = True, mc2_ctx = [], param_type_list = ['required', 'dynamic', 'dynamic', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required', 'required'], init_value_list = [None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{}')

def op_select_format(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, actual_seq_lengths_kv_in__=None, dequant_scale1_in__=None, quant_scale1_in__=None, dequant_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, block_table_in__=None, query_padding_size_in__=None, kv_padding_size_in__=None, key_antiquant_scale_in__=None, key_antiquant_offset_in__=None, value_antiquant_scale_in__=None, value_antiquant_offset_in__=None, key_shared_prefix_in__=None, value_shared_prefix_in__=None, actual_shared_prefix_len_in__=None, query_rope_in__=None, key_rope_in__=None, key_rope_antiquant_scale_in__=None, attention_out_out_=None, softmax_lse_out_=None, num_heads=0, scale=1, pre_tokens=2147483647, next_tokens=2147483647, input_layout="BSH", num_key_value_heads=0, sparse_mode=0, inner_precise=1, block_size=0, antiquant_mode=0, softmax_lse_flag=False, key_antiquant_mode=0, value_antiquant_mode=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, query_padding_size_in__, kv_padding_size_in__, key_antiquant_scale_in__, key_antiquant_offset_in__, value_antiquant_scale_in__, value_antiquant_offset_in__, key_shared_prefix_in__, value_shared_prefix_in__, actual_shared_prefix_len_in__, query_rope_in__, key_rope_in__, key_rope_antiquant_scale_in__, attention_out_out_, softmax_lse_out_, num_heads, scale, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise, block_size, antiquant_mode, softmax_lse_flag, key_antiquant_mode, value_antiquant_mode)
