...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['x', 'w', 'b', 'seq_length', 'init_h', 'init_c', 'wci', 'wcf', 'wco', 'mask']
...
@tbe_register.register_operator("DynamicRNN", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_BOOL, para_check.KERNEL_NAME)
def dynamic_rnn(x_in__, w_in__, b_in__, seq_length_in__=None, init_h_in__=None, init_c_in__=None, wci_in__=None, wcf_in__=None, wco_in__=None, mask_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, i_out_=None, j_out_=None, f_out_=None, o_out_=None, tanhc_out_=None, cell_type="LSTM", direction="UNIDIRECTIONAL", cell_depth=1, use_peephole=False, keep_prob=1, cell_clip=-1, num_proj=0, time_major=True, activation="tanh", forget_bias=0, gate_order="ijfo", is_training=True, kernel_name="dynamic_rnn", impl_mode=""):
    ...
    origin_func_name = "dynamic_rnn"
    ascendc_src_dir_ex = "dynamic_rnn"
    ascendc_src_dir = "dynamic_r_n_n"
    ascendc_src_file = "dynamic_rnn_910b.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator DynamicRNN, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "DynamicRNN"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[x_in__, w_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__], origin_outputs = [y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required', 'required', 'required', 'required', 'required', 'required', 'required', 'required'], init_value_list = [None, None, None, None, None, None, None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{"auto_sync": false}')

def op_select_format(x_in__, w_in__, b_in__, seq_length_in__=None, init_h_in__=None, init_c_in__=None, wci_in__=None, wcf_in__=None, wco_in__=None, mask_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, i_out_=None, j_out_=None, f_out_=None, o_out_=None, tanhc_out_=None, cell_type="LSTM", direction="UNIDIRECTIONAL", cell_depth=1, use_peephole=False, keep_prob=1, cell_clip=-1, num_proj=0, time_major=True, activation="tanh", forget_bias=0, gate_order="ijfo", is_training=True, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, w_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__, y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_, cell_type, direction, cell_depth, use_peephole, keep_prob, cell_clip, num_proj, time_major, activation, forget_bias, gate_order, is_training)
    result = check_op_cap("op_select_format", "DynamicRNN", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, w_in__, b_in__, seq_length_in__=None, init_h_in__=None, init_c_in__=None, wci_in__=None, wcf_in__=None, wco_in__=None, mask_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, i_out_=None, j_out_=None, f_out_=None, o_out_=None, tanhc_out_=None, cell_type="LSTM", direction="UNIDIRECTIONAL", cell_depth=1, use_peephole=False, keep_prob=1, cell_clip=-1, num_proj=0, time_major=True, activation="tanh", forget_bias=0, gate_order="ijfo", is_training=True, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, w_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__, y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_, cell_type, direction, cell_depth, use_peephole, keep_prob, cell_clip, num_proj, time_major, activation, forget_bias, gate_order, is_training)
    result = check_op_cap("get_op_specific_info", "DynamicRNN", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
