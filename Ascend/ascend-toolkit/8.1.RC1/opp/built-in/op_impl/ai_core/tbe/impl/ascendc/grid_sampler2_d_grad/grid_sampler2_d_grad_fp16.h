...
__aicore__ inline void GridSampler2DGradFP16<T, Dtype, GridSamplerGradTilingData>::ComputeSourceIndexSetGrad(
  ...
  int32_t newCalCount =
    ((calCount * FLOAT_BYTES - 1 + ALGIN_256_BYTES) / ALGIN_256_BYTES * ALGIN_256_BYTES) / 4;
  if (padding == 1) {
...
template <typename T, typename Dtype,  typename GridSamplerGradTilingData>
__aicore__ inline void GridSampler2DGradFP16<T, Dtype, GridSamplerGradTilingData>::ComputeIndex(LocalTensor<int32_t> dstIndex,
...
template <typename T, typename Dtype,  typename GridSamplerGradTilingData>
__aicore__ inline void GridSampler2DGradFP16<T, Dtype, GridSamplerGradTilingData>::ComputeWeight(
...
template <typename T, typename Dtype,  typename GridSamplerGradTilingData>
__aicore__ inline void GridSampler2DGradFP16<T, Dtype, GridSamplerGradTilingData>::Compute(const int32_t computeCount,
