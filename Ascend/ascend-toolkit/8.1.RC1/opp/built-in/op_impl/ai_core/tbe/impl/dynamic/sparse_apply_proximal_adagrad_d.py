...
def sparse_apply_proximal_adagrad_d_compute(var, accum, lr, l1, l2, grad, indices, var_out, accum_out,
                                            use_locking=False, kernel_name="sparse_apply_proximal_adagrad_d"):
...
@register_operator("SparseApplyProximalAdagradD", pattern="SparseApply")
...
def sparse_apply_proximal_adagrad_d(var,
    ...
    for (ins_var, ins_accum, ins_grad, ins_indices) in ins:
        with tbe.compute():
            ...
            data_lr = tvm.placeholder((1,), lr.get("type"), "lr")
            data_l1 = tvm.placeholder((1,), lr.get("type"), "l1")
            data_l2 = tvm.placeholder((1,), lr.get("type"), "l2")
            res = sparse_apply_proximal_adagrad_d_compute(data_var, data_accum, data_lr, data_l1, data_l2, data_grad,
