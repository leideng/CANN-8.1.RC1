...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['query', 'key', 'value', 'scale_quant', 'scale_dequant1', 'scale_dequant2', 'bias_quant', 'bias_dequant1', 'bias_dequant2', 'padding_mask1', 'padding_mask2']
...
def _build_args(query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__, bias_dequant1_in__, bias_dequant2_in__, padding_mask1_in__, padding_mask2_in__, attention_score_out_, query_transpose, key_transpose, value_transpose, softmax_axes):
    __inputs__ = []
    for arg in [query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__, bias_dequant1_in__, bias_dequant2_in__, padding_mask1_in__, padding_mask2_in__]:
        if arg != None:
            ...
            __inputs__.append(arg)
    __outputs__ = []
    for arg in [attention_score_out_]:
        if arg != None:
            if isinstance(arg, (list, tuple)):
                if len(arg) == 0:
                    continue
            ...
            __outputs__.append(arg)
    __attrs__ = []
    if query_transpose != None:
        attr = {}
        attr["name"] = "query_transpose"
        attr["dtype"] = "bool"
        attr["value"] = query_transpose
        __attrs__.append(attr)
    if key_transpose != None:
        attr = {}
        attr["name"] = "key_transpose"
        attr["dtype"] = "bool"
        attr["value"] = key_transpose
        __attrs__.append(attr)
    if value_transpose != None:
        attr = {}
        attr["name"] = "value_transpose"
        attr["dtype"] = "bool"
        attr["value"] = value_transpose
        __attrs__.append(attr)
    if softmax_axes != None:
        attr = {}
        attr["name"] = "softmax_axes"
        attr["dtype"] = "int"
        attr["value"] = softmax_axes
        __attrs__.append(attr)
    return __inputs__, __outputs__, __attrs__

@tbe_register.register_operator("SwinAttentionScoreQuant", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def swin_attention_score_quant(query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__=None, bias_dequant1_in__=None, bias_dequant2_in__=None, padding_mask1_in__=None, padding_mask2_in__=None, attention_score_out_=None, query_transpose=False, key_transpose=False, value_transpose=False, softmax_axes=-1, kernel_name="swin_attention_score_quant", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__, bias_dequant1_in__, bias_dequant2_in__, padding_mask1_in__, padding_mask2_in__, attention_score_out_, query_transpose, key_transpose, value_transpose, softmax_axes)
    ...
    origin_func_name = "swin_attention_score_quant"
    ascendc_src_dir_ex = "swin_attention_score_quant"
    ascendc_src_dir = "swin_attention_score_quant"
    ascendc_src_file = "swin_attention_score_quant.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator SwinAttentionScoreQuant, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "SwinAttentionScoreQuant"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__, bias_dequant1_in__, bias_dequant2_in__, padding_mask1_in__, padding_mask2_in__], origin_outputs = [attention_score_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'required', 'required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'required'], init_value_list = [None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{"auto_sync": false}')

def op_select_format(query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__=None, bias_dequant1_in__=None, bias_dequant2_in__=None, padding_mask1_in__=None, padding_mask2_in__=None, attention_score_out_=None, query_transpose=False, key_transpose=False, value_transpose=False, softmax_axes=-1, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__, bias_dequant1_in__, bias_dequant2_in__, padding_mask1_in__, padding_mask2_in__, attention_score_out_, query_transpose, key_transpose, value_transpose, softmax_axes)
    result = check_op_cap("op_select_format", "SwinAttentionScoreQuant", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__=None, bias_dequant1_in__=None, bias_dequant2_in__=None, padding_mask1_in__=None, padding_mask2_in__=None, attention_score_out_=None, query_transpose=False, key_transpose=False, value_transpose=False, softmax_axes=-1, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, scale_quant_in__, scale_dequant1_in__, scale_dequant2_in__, bias_quant_in__, bias_dequant1_in__, bias_dequant2_in__, padding_mask1_in__, padding_mask2_in__, attention_score_out_, query_transpose, key_transpose, value_transpose, softmax_axes)
    result = check_op_cap("get_op_specific_info", "SwinAttentionScoreQuant", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
