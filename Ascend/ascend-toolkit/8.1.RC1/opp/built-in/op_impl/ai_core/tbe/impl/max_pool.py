...
from impl.util.platform_adapter import max_pool_compute as tbe_max_pool_compute
...
# 'pylint: disable=unused-argument,unused-variable,too-many-arguments,huawei-too-many-arguments
...
@register_operator_compute("max_pool", op_mode="static", support_fusion=True)
def max_pool_fuse_compute(input_data, output_data, ksize, strides, padding=None,
    ...
    if conv_pooling_flag:
        res = tbe_max_pool_compute(input_data, (window_h, window_w),
