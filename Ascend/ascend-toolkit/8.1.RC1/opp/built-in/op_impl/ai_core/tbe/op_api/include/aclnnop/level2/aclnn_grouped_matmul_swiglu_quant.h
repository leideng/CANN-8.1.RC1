...
/**
 * @brief aclnnGroupedMatmulSwiglu的第一段接口，根据具体的计算流程，计算workspace大小。
 ...
 * @param [in] groupList: 可选参数，代表输入和输出分组轴上的索引情况，数据类型支持INT64。
...
/**
 * @brief aclnnGroupedMatmulSwiglu的第二段接口，用于执行计算。
