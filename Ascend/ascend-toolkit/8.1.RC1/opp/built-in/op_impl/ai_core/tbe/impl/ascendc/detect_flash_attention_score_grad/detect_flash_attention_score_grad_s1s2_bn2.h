...
/*!
 * \file detect_flash_attention_score_grad_s1s2_bn2.h
 * \brief
 */

#ifndef _DETECT_FLASH_ATTENTION_SCORE_GRAD_S1S2_BN2_H_
#define _DETECT_FLASH_ATTENTION_SCORE_GRAD_S1S2_BN2_H_

#include "lib/matmul_intf.h"
#include "kernel_operator.h"
#include "../detect_flash_attention_score/detect_flash_attention_pse.h"
#include "../detect_flash_attention_score/detect_flash_attention_dropmask.h"
...
public:
    ...
    __aicore__ inline void Init(GM_ADDR query, GM_ADDR key, GM_ADDR value, GM_ADDR dy, GM_ADDR pse_shift,
                                ...
                                const DetectFlashAttentionScoreGradTilingDataS1s2Bn2 *__restrict ordTilingData,
                                TPipe *pipe_in);
...
protected:
    ...
    __aicore__ inline void InitParams(const DetectFlashAttentionScoreGradTilingDataS1s2Bn2 *__restrict ordTilingData,
...
protected:
    ...
    */
    ...
    TPipe *pipe;
    int64_t blockIdx;
    const DetectFlashAttentionScoreGradTilingDataS1s2Bn2 *__restrict tilingData;
...
FlashAttentionScoreGradS1s2Bn2<T1, T2, MM_CFG, MM_OUT_FORMAT, PSE_CFG, ATTEN_MASK_CFG, DROPOUT_CFG, LAYOUT,
    ...
    GM_ADDR dpse, GM_ADDR workspace, const DetectFlashAttentionScoreGradTilingDataS1s2Bn2 *__restrict ordTilingData,
    TPipe *pipe_in)
{
...
FlashAttentionScoreGradS1s2Bn2<T1, T2, MM_CFG, MM_OUT_FORMAT, PSE_CFG, ATTEN_MASK_CFG, DROPOUT_CFG, LAYOUT,
    ...
    const DetectFlashAttentionScoreGradTilingDataS1s2Bn2 *__restrict ordTilingData, GM_ADDR actual_seq_qlen,
...
#endif // _DETECT_FLASH_ATTENTION_SCORE_GRAD_S1S2_BN2_H_
