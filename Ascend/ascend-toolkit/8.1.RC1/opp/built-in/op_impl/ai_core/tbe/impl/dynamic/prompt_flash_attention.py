...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['query', 'key', 'value', 'pse_shift', 'atten_mask', 'actual_seq_lengths', 'actual_seq_lengths_kv', 'deq_scale1', 'quant_scale1', 'deq_scale2', 'quant_scale2', 'quant_offset2']
...
def _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, deq_scale1_in__, quant_scale1_in__, deq_scale2_in__, quant_scale2_in__, quant_offset2_in__, attention_out_out_, num_heads, scale_value, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise):
    __inputs__ = []
    for arg in [query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, deq_scale1_in__, quant_scale1_in__, deq_scale2_in__, quant_scale2_in__, quant_offset2_in__]:
        if arg != None:
...
@tbe_register.register_operator("PromptFlashAttention", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def prompt_flash_attention(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, actual_seq_lengths_kv_in__=None, deq_scale1_in__=None, quant_scale1_in__=None, deq_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, attention_out_out_=None, num_heads=0, scale_value=1, pre_tokens=214748647, next_tokens=0, input_layout="BSH", num_key_value_heads=0, sparse_mode=0, inner_precise=1, kernel_name="prompt_flash_attention", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, deq_scale1_in__, quant_scale1_in__, deq_scale2_in__, quant_scale2_in__, quant_offset2_in__, attention_out_out_, num_heads, scale_value, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise)
    ...
    custom_compile_options = {'__ALLSOC__': ['--cce-auto-sync=off', '-Wno-deprecated-declarations', '-Werror', '-mllvm', '-cce-aicore-hoist-movemask=false'], 'ascend310p': ['-mllvm', '-cce-aicore-jump-expand=true']},
    ...
    origin_func_name = "prompt_flash_attention"
    ascendc_src_dir_ex = "prompt_flash_attention"
    ascendc_src_dir = "prompt_flash_attention"
    ascendc_src_file = "prompt_flash_attention.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator PromptFlashAttention, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, deq_scale1_in__, quant_scale1_in__, deq_scale2_in__, quant_scale2_in__, quant_offset2_in__], origin_outputs = [attention_out_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required'], init_value_list = [None],\
...
def op_select_format(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, actual_seq_lengths_kv_in__=None, deq_scale1_in__=None, quant_scale1_in__=None, deq_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, attention_out_out_=None, num_heads=0, scale_value=1, pre_tokens=214748647, next_tokens=0, input_layout="BSH", num_key_value_heads=0, sparse_mode=0, inner_precise=1, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, deq_scale1_in__, quant_scale1_in__, deq_scale2_in__, quant_scale2_in__, quant_offset2_in__, attention_out_out_, num_heads, scale_value, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise)
    result = check_op_cap("op_select_format", "PromptFlashAttention", __inputs__, __outputs__, __attrs__)
...
def get_op_specific_info(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, actual_seq_lengths_kv_in__=None, deq_scale1_in__=None, quant_scale1_in__=None, deq_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, attention_out_out_=None, num_heads=0, scale_value=1, pre_tokens=214748647, next_tokens=0, input_layout="BSH", num_key_value_heads=0, sparse_mode=0, inner_precise=1, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, actual_seq_lengths_kv_in__, deq_scale1_in__, quant_scale1_in__, deq_scale2_in__, quant_scale2_in__, quant_offset2_in__, attention_out_out_, num_heads, scale_value, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise)
    result = check_op_cap("get_op_specific_info", "PromptFlashAttention", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
