...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['query', 'key', 'value', 'dy', 'pse_shift', 'drop_mask', 'padding_mask', 'atten_mask', 'softmax_in', 'attention_in']
...
def _build_args(query_in__, key_in__, value_in__, dy_in__, pse_shift_in__, drop_mask_in__, padding_mask_in__, atten_mask_in__, softmax_in_in__, attention_in_in__, dq_out_, dk_out_, dv_out_, dpse_out_, scale_value, keep_prob, pre_tockens, next_tockens, head_num, input_layout):
    __inputs__ = []
    for arg in [query_in__, key_in__, value_in__, dy_in__, pse_shift_in__, drop_mask_in__, padding_mask_in__, atten_mask_in__, softmax_in_in__, attention_in_in__]:
        if arg != None:
...
@tbe_register.register_operator("MultiHeadAttentionScoreGrad", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_STR, para_check.KERNEL_NAME)
def multi_head_attention_score_grad(query_in__, key_in__, value_in__, dy_in__, pse_shift_in__=None, drop_mask_in__=None, padding_mask_in__=None, atten_mask_in__=None, softmax_in_in__=None, attention_in_in__=None, dq_out_=None, dk_out_=None, dv_out_=None, dpse_out_=None, scale_value=1, keep_prob=1, pre_tockens=65536, next_tockens=65536, head_num=0, input_layout="", kernel_name="multi_head_attention_score_grad", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, dy_in__, pse_shift_in__, drop_mask_in__, padding_mask_in__, atten_mask_in__, softmax_in_in__, attention_in_in__, dq_out_, dk_out_, dv_out_, dpse_out_, scale_value, keep_prob, pre_tockens, next_tockens, head_num, input_layout)
    ...
    origin_func_name = "multi_head_attention_score_grad"
    ascendc_src_dir_ex = "multi_head_attention_score_grad"
    ascendc_src_dir = "multi_head_attention_score_grad"
    ascendc_src_file = "multi_head_attention_score_grad.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator MultiHeadAttentionScoreGrad, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "MultiHeadAttentionScoreGrad"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, value_in__, dy_in__, pse_shift_in__, drop_mask_in__, padding_mask_in__, atten_mask_in__, softmax_in_in__, attention_in_in__], origin_outputs = [dq_out_, dk_out_, dv_out_, dpse_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required', 'required', 'required', 'required'], init_value_list = [None, None, None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{"auto_sync": false}')

def op_select_format(query_in__, key_in__, value_in__, dy_in__, pse_shift_in__=None, drop_mask_in__=None, padding_mask_in__=None, atten_mask_in__=None, softmax_in_in__=None, attention_in_in__=None, dq_out_=None, dk_out_=None, dv_out_=None, dpse_out_=None, scale_value=1, keep_prob=1, pre_tockens=65536, next_tockens=65536, head_num=0, input_layout="", impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, dy_in__, pse_shift_in__, drop_mask_in__, padding_mask_in__, atten_mask_in__, softmax_in_in__, attention_in_in__, dq_out_, dk_out_, dv_out_, dpse_out_, scale_value, keep_prob, pre_tockens, next_tockens, head_num, input_layout)
    result = check_op_cap("op_select_format", "MultiHeadAttentionScoreGrad", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(query_in__, key_in__, value_in__, dy_in__, pse_shift_in__=None, drop_mask_in__=None, padding_mask_in__=None, atten_mask_in__=None, softmax_in_in__=None, attention_in_in__=None, dq_out_=None, dk_out_=None, dv_out_=None, dpse_out_=None, scale_value=1, keep_prob=1, pre_tockens=65536, next_tockens=65536, head_num=0, input_layout="", impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, dy_in__, pse_shift_in__, drop_mask_in__, padding_mask_in__, atten_mask_in__, softmax_in_in__, attention_in_in__, dq_out_, dk_out_, dv_out_, dpse_out_, scale_value, keep_prob, pre_tockens, next_tockens, head_num, input_layout)
    result = check_op_cap("get_op_specific_info", "MultiHeadAttentionScoreGrad", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
