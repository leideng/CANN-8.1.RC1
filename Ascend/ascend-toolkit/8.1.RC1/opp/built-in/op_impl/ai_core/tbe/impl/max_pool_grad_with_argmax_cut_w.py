                            ...
                            with self.tik_instance.else_scope():
                                ...
                                with self.tik_instance.if_scope(looph == h_cycle - 1):
                                    if self.padding == "SAME":
                                        ...
                                        effective_h = (dyh - 1) * strideh + windowh
                                        nburst.set_as(effective_h - looph * strideh)
                                ...
                                with self.tik_instance.else_scope():
                                    ...
                                    with self.tik_instance.if_scope(loopw == w_cycle - 1):
                                        if self.padding == "SAME":
                                            ...
                                            effective_w = (dyw - 1) * stridew + windoww
                                            burst_len.set_as(effective_w - col2img_w * loopw)
                            else:
                                with self.tik_instance.if_scope(loopw == 0):
                                ...
                                with self.tik_instance.else_scope():
                                    ...
                                    with self.tik_instance.if_scope(loopw == w_cycle - 1):
                                        if self.padding == "SAME":
                                            ...
                                            effective_w = (dyw - 1) * stridew + windoww
                                            burst_len.set_as(effective_w - stridew * wo_max - (w_cycle - 2) *
                                                             stridew * (wo_max - 1))
