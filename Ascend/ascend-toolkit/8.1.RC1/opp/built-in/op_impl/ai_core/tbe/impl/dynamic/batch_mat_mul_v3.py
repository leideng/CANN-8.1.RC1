...
def _build_args(x1_in__, x2_in__, bias_in__, offset_w_in__, y_out_, adj_x1, adj_x2, offset_x, enable_hf32):
    __inputs__ = []
...
@tbe_register.register_operator("BatchMatMulV3", trans_bool_to_s8=False)
...
def batch_mat_mul_v3(x1_in__, x2_in__, bias_in__=None, offset_w_in__=None, y_out_=None, adj_x1=False, adj_x2=False, offset_x=0, enable_hf32=False, kernel_name="batch_mat_mul_v3", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x1_in__, x2_in__, bias_in__, offset_w_in__, y_out_, adj_x1, adj_x2, offset_x, enable_hf32)
    ...
    origin_func_name = "batch_mat_mul_v3"
    ascendc_src_dir_ex = "batch_mat_mul_v3"
    ascendc_src_dir = "batch_mat_mul_v3"
    ascendc_src_file = "batch_mat_mul_v3.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator BatchMatMulV3, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "BatchMatMulV3"
