...
def triu(x, y, diagonal=0, kernel_name="triu"):
    ...
    kernel_name (str): cce kernel name, default value is "triu"
    """
    op = Trilu(x, y, diagonal, upper=True, kernel_name=kernel_name)
