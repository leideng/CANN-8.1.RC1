...
@register_operator_compute("BesselI0e", op_mode="dynamic", support_fusion=True, support_bfp16=True)
def bessel_i0e_compute(x, y, kernel_name="bessel_i0e"):
    ...
    sqrt_data = tbe.vsqrt(abs_data, impl_mode=OpTbeImplMode.TBE_HIGH_PRECISION)
