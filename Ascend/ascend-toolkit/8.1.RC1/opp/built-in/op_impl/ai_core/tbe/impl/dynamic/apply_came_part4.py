...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['param_in', 'm', 'r_in', 'c_in', 'weight_decay', 'lr', 'beta3', 'sum_r', 'sum_u_r', 'sum_u_c', 'sum_u_rc', 'global_shape']
    output_names = ['param_out', 'r_out', 'c_out']
...
def _build_args(param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__, sum_u_r_in__, sum_u_c_in__, sum_u_rc_in__, global_shape_in__, param_out_out_, r_out_out_, c_out_out_):
    __inputs__ = []
    for arg in [param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__, sum_u_r_in__, sum_u_c_in__, sum_u_rc_in__, global_shape_in__]:
        if arg != None:
            ...
            __inputs__.append(arg)
    __outputs__ = []
    for arg in [param_out_out_, r_out_out_, c_out_out_]:
        if arg != None:
            if isinstance(arg, (list, tuple)):
                if len(arg) == 0:
                    continue
...
@tbe_register.register_operator("ApplyCamePart4", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.KERNEL_NAME)
def apply_came_part4(param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__=None, sum_u_r_in__=None, sum_u_c_in__=None, sum_u_rc_in__=None, global_shape_in__=None, param_out_out_=None, r_out_out_=None, c_out_out_=None, kernel_name="apply_came_part4", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__, sum_u_r_in__, sum_u_c_in__, sum_u_rc_in__, global_shape_in__, param_out_out_, r_out_out_, c_out_out_)
    ...
    origin_func_name = "apply_came_part4"
    ascendc_src_dir_ex = "apply_came_part4"
    ascendc_src_dir = "apply_came_part4"
    ascendc_src_file = "apply_came_part4.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator ApplyCamePart4, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "ApplyCamePart4"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__, sum_u_r_in__, sum_u_c_in__, sum_u_rc_in__, global_shape_in__], origin_outputs = [param_out_out_, r_out_out_, c_out_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'required', 'required', 'required', 'required', 'optional', 'required', 'required', 'required', 'optional', 'required', 'required', 'required'], init_value_list = [None, None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{}')

def op_select_format(param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__=None, sum_u_r_in__=None, sum_u_c_in__=None, sum_u_rc_in__=None, global_shape_in__=None, param_out_out_=None, r_out_out_=None, c_out_out_=None, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__, sum_u_r_in__, sum_u_c_in__, sum_u_rc_in__, global_shape_in__, param_out_out_, r_out_out_, c_out_out_)
    result = check_op_cap("op_select_format", "ApplyCamePart4", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__=None, sum_u_r_in__=None, sum_u_c_in__=None, sum_u_rc_in__=None, global_shape_in__=None, param_out_out_=None, r_out_out_=None, c_out_out_=None, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(param_in_in__, m_in__, r_in_in__, c_in_in__, weight_decay_in__, lr_in__, beta3_in__, sum_r_in__, sum_u_r_in__, sum_u_c_in__, sum_u_rc_in__, global_shape_in__, param_out_out_, r_out_out_, c_out_out_)
    result = check_op_cap("get_op_specific_info", "ApplyCamePart4", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
