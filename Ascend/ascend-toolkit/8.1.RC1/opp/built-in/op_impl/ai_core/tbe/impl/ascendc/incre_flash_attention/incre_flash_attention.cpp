...
#define INVOKE_IFA_NO_KFC_MLA_OP_IMPL(templateClass, ...)                                                              \
    do {                                                                                                               \
        ...
        op.Init(query, key, value, pseShift, attenMask, actualSeqLengths, blocktable, kvPaddingSize, queryRope,        \
                keyRope, attentionOut, softmaxLse, user, tiling_data, tiling, &tPipe);                                 \
        op.InitQuant(deqScale1, quantScale1, deqScale2, quantScale2, quantOffset2, antiquantScale, antiquantOffset,    \
                     keyAntiquantScale, keyAntiquantOffset, valueAntiquantScale, valueAntiquantOffset, user);          \
        op.Process();                                                                                                  \
    } while (0)
    ...
    **/
    ...
    if (TILING_KEY_IS(11000000000000000)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000000000)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, half, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000000000)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, half, half, false, false,
                                   LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000200000)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, half, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000200000)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, half, half, true, false,
                                   LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, false, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000100000)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, true, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000300000)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000000001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, half, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000000001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, half, half, false, false,
                                   LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000200001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, half, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000200001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, half, half, true, false,
                                   LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, false, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000100001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, half, half, false, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000300001)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, true, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000300001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, half, half, true, true,
                                   LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL_PREFIX(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, half, half, false, true,
                                   LAYOUT::BSH, 0, true);
    } else if (TILING_KEY_IS(15000000000000000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, false,
                                      LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000200000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, false,
                                      LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000100000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, true,
                                      LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000300000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, true,
                                      LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000010000000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, false,
                                      LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010200000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, false,
                                      LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010100000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, true,
                                      LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010300000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, true,
                                      LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000020000000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, false,
                                      LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020200000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, false,
                                      LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020100000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, true,
                                      LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020300000)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, true,
                                      LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000000000001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, false,
                                      LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000200001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, false,
                                      LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000100001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, true,
                                      LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000300001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, true,
                                      LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000010000001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, false,
                                      LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010200001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, false,
                                      LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010100001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, true,
                                      LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010300001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, true,
                                      LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000020000001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, false,
                                      LAYOUT::BSH, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020200001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, false,
                                      LAYOUT::BSH, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020100001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, false, true,
                                      LAYOUT::BSH, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020300001)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, half, half, half, half, true, true,
                                      LAYOUT::BSH, false, false, LAYOUT::NZ);
#else
    ...
    if (TILING_KEY_IS(10000000000000300)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000000300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, false,
                                  LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000000300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000400300)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, false, false,
                                   LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000200300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000200300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000600300)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, true, false,
                                   LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000100300)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000300300)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000000301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000000301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000400301)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000200301)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000200301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000200301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000600301)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, half, half, true, false,
                                   LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000100301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, true,
                                  LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000300301)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000300301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, true, true,
                                  LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, false,
                                   LAYOUT::BNSD, 1);
    }else if (TILING_KEY_IS(13000000000400300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, false,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000600300)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, false,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000600300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, true, false,
                                   LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, true,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000500300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, true,
                                  LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000700300)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, true,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000700300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, true, true,
                                  LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000400301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000600301)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000600301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, true, false,
                                   LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, true,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000500301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, true,
                                  LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000700301)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, true, true,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000700301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, true, true,
                                   LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, true,
                                   LAYOUT::BNSD, 2);
    } else if (TILING_KEY_IS(13000000002100300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, true,
                                   LAYOUT::BNSD, 2);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, half, half, false, true,
                                   LAYOUT::BSH, 2);
    } else if (TILING_KEY_IS(13000000002100301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, half, half, false, true,
                                  LAYOUT::BSH, 2);
    ...
    if (TILING_KEY_IS(10000000000000400)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000000400)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000100400)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000000401)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000100401)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000100401)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, true,
                                  LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, false,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000400400)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, false,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000500400)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, true,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000500400)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, true,
                                  LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000400401)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000500401)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, true,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000500401)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, true,
                                  LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, true,
                                   LAYOUT::BNSD, 2);
    } else if (TILING_KEY_IS(13000000002100400)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, true,
                                  LAYOUT::BNSD, 2);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int4b_t, half, half, false, true,
                                   LAYOUT::BSH, 2);
    } else if (TILING_KEY_IS(13000000002100401)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int4b_t, half, half, false, true,
                                  LAYOUT::BSH, 2);
    ...
    if (TILING_KEY_IS(10000000000003000)) { // A16W16 fp16, out int8
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000003000)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, int8_t, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000003000)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, int8_t, half, false, false,
                                   LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000203000)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, int8_t, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000203000)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, int8_t, half, true, false,
                                   LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, false, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000103000)) { // A16W16 fp16, out int8, FD
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, true, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000303000)) { // A16W16 fp16, out int8, FD
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000003001)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, int8_t, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000003001)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, int8_t, half, false, false,
                                   LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000203001)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, int8_t, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000203001)) { // A16W16 fp16, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, half, int8_t, half, true, false,
                                   LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, false, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000103001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, int8_t, half, false, true,
                                  LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000303001)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, half, int8_t, half, true, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000303001)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, half, int8_t, half, true, true,
                                   LAYOUT::BSH);
    ...
    if (TILING_KEY_IS(10000000000003300)) { // A16W16 fp16, out int
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000003300)) { // A16W16 fp16, out int
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000003300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000403300)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000203300)) { // A16W8 fp16, out int
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000203300)) { // A16W8 fp16, out int
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000603300)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000103300)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, true,
                                   LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000303300)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000003301)) { // A16W8 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000003301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000403301)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000203301)) { // A16W8 out int8
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000203301)) { // A16W8 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000203301)) { // A16W8 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000603301)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000103301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, false, true,
                                  LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000303301)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, true,
                                   LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000303301)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, true,
                                   LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000403300)) { // A16W8 fp16, pertoken, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000603300)) { // A16W8 fp16, pertoken, out int8
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000603300)) { // A16W8 fp16, pertoken, out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, true,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000503300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, false, true,
                                  LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000703300)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, true,
                                   LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000703300)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, true, true,
                                   LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000403301)) { // A16W8 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, false, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000603301)) { // A16W8 out int8
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000603301)) { // A16W8 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, true, false,
                                   LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, false, true,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000503301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, false, true,
                                  LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000703301)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, half, int8_t, int8_t, half, true, true,
                                   LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000703301)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, half, int8_t, int8_t, half, true, true,
                                  LAYOUT::BSH, 1);
    ...
    if (TILING_KEY_IS(10000000000022220)) {
    ...
    } else if (TILING_KEY_IS(13000000000022220)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, bfloat16_t,
                                   bfloat16_t, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000022220)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, bfloat16_t, bfloat16_t, 
                                  bfloat16_t, false, false, LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, bfloat16_t,
                                   bfloat16_t, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000022221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, bfloat16_t, bfloat16_t, 
                                  bfloat16_t, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000222221)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, bfloat16_t,
                                   bfloat16_t, true, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000222221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, bfloat16_t,
                                   bfloat16_t, true, false, LAYOUT::BSH);
    ...
    } else if (TILING_KEY_IS(15000000000022220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, false, LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000222220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, false, LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000122220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, true, LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000322220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, true, LAYOUT::BNSD, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000010022220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, false, LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010222220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, false, LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010122220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, true, LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010322220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, true, LAYOUT::BNSD, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000020022220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, false, LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020222220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, false, LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020122220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, true, LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020322220)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, true, LAYOUT::BNSD, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000000022221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, false, LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000222221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, false, LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000122221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, true, LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000000322221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, true, LAYOUT::BSH, false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(15000000010022221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, false, LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010222221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, false, LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010122221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, true, LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000010322221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, true, LAYOUT::BSH, false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(15000000020022221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, false, LAYOUT::BSH, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020222221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, false, LAYOUT::BSH, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020122221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, false, true, LAYOUT::BSH, false, false, LAYOUT::NZ);
    } else if (TILING_KEY_IS(15000000020322221)) {
        INVOKE_IFA_NO_KFC_MLA_OP_IMPL(IncreFlashAttentionAttenPreloadMla, bfloat16_t, bfloat16_t, bfloat16_t,
                                      bfloat16_t, true, true, LAYOUT::BSH, false, false, LAYOUT::NZ);
    }
#endif
    ...
    if (TILING_KEY_IS(10000000000022320)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000022320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000022320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000422320)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000222320)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000222320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000222320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000622320)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
    ...
    } else if (TILING_KEY_IS(13000000000122320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(10000000000322320)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000322320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  true, true, LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000022321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000022321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000422321)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000222321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000222321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000222321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000622321)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
    ...
    } else if (TILING_KEY_IS(13000000000122321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000322321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000322321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  true, true, LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000422320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000622320)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000622320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD, 1);
    ...
    } else if (TILING_KEY_IS(13000000000522320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000722320)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, true, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000722320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  true, true, LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000422321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000622321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000622321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, false, LAYOUT::BSH, 1);
    ...
    } else if (TILING_KEY_IS(13000000000522321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000722321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                   true, true, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000722321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, bfloat16_t, bfloat16_t,
                                  true, true, LAYOUT::BSH, 1);
    ...
    if (TILING_KEY_IS(10000000000022420)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000022420)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000122420)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000022421)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000122421)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000122421)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000422420)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000522420)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, true, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000522420)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000422421)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000522421)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                   false, true, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000522421)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BSH, 1);
    ...
    } else if (TILING_KEY_IS(13000000002122420)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD, 2);
    ...
    } else if (TILING_KEY_IS(13000000002122421)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int4b_t, bfloat16_t, bfloat16_t,
                                  false, true, LAYOUT::BSH, 2);
    ...
    if (TILING_KEY_IS(10000000000023220)) { // A16W16 BF16 out int8
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000023220)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000023220)) {
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000223220)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000223220)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(10000000000123220)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000123220)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(10000000000323220)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000323220)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                  true, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(10000000000023221)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000023221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
     } else if (TILING_KEY_IS(14000000000023221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000223221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000223221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000123221)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000123221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   false, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000323221)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                   true, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000323221)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, bfloat16_t, int8_t, bfloat16_t,
                                  true, true, LAYOUT::BSH);
    ...
    if (TILING_KEY_IS(10000000000023320)) { // A16W8 BF16 out int8
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000023320)) { // A16W8 BF16 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000023320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000423320)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000223320)) { // A16W8 BF16 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000223320)) { // A16W8 BF16 out int8
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(14000000000623320)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000123320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(10000000000323320)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   true, LAYOUT::BNSD);
    } else if (TILING_KEY_IS(13000000000323320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                  true, LAYOUT::BNSD);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000023321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000023321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000423321)) { // perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000223321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000223321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000223321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BSH);
    } else if (TILING_KEY_IS(14000000000623321)) { // PA perToken
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenS2FullLoad, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000123321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                  false, true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(10000000000323321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   true, LAYOUT::BSH);
    } else if (TILING_KEY_IS(13000000000323321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                  true, LAYOUT::BSH);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000423320)) { // A16W8 BF16 out int8 per token
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000623320)) { // A16W8 BF16 out int8 per token
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000623320)) { // A16W8 BF16 out int8 per token
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, true, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000523320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                  false, true, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(10000000000723320)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   true, LAYOUT::BNSD, 1);
    } else if (TILING_KEY_IS(13000000000723320)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                  true, LAYOUT::BNSD, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    }else if (TILING_KEY_IS(13000000000423321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000623321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000623321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   false, LAYOUT::BSH, 1);
        ...
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                   false, true, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000523321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t,
                                  false, true, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(10000000000723321)) {
        INVOKE_IFA_GENERAL_OP_IMPL(IncreFlashAttentionAttenSplitBbn2s2Us2, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                   true, LAYOUT::BSH, 1);
    } else if (TILING_KEY_IS(13000000000723321)) {
        INVOKE_IFA_NO_KFC_OP_IMPL(IncreFlashAttentionAttenPreload, bfloat16_t, int8_t, int8_t, bfloat16_t, true,
                                  true, LAYOUT::BSH, 1);
