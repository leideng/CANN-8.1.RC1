...
#define INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_SAMEAB_L1_CUSTOM_IMPL(INPUT_TYPE, IS_ATTEN_MASK, IS_PSE, IS_DROP,             \
    ...
    do {                                                                                                               \
        ...
        GlobalTscmArray tscmArray[TOTAL_L1_BUF_NUMS];                                                                  \
        tscmGlobal = tscmArray;                                                                                        \
        InitTscmBuffer<INPUT_TYPE, S1TEMPLATETYPE, S2TEMPLATETYPE, DTEMPLATETYPE>(&pipeBase, tscmGlobal,tilingData);   \
        REGIST_MATMUL_OBJ(&pipeBase, GetSysWorkSpacePtr(), op.mm1, bmm1tiling, op.mm3, bmm2tiling, op.mm4,             \
                          bmm3tiling);                                                                                 \
        op.Init(key, value, dy, query, pse_shift, drop_mask, atten_mask, attention_in, softmax_max, softmax_sum,       \
...
#define INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(INPUT_TYPE, MM_CONFIG, CUBE_FORMAT, PSE_CFG,                \
    ...
    do {                                                                                                               \
        ...
        FlashAttentionScoreGradS1s2Bn2<INPUT_TYPE, float, MM_CONFIG, CUBE_FORMAT, PSE_CFG, ATTEN_MASK_CFG,             \
            ...
            op;                                                                                                        \
        GlobalTscmArray tscmArray[T12_TOTAL_L1_BUF_NUMS];                                                              \
        tscmGlobal = tscmArray;                                                                                        \
        InitSabTSCMBuffer<INPUT_TYPE>(&pipeIn, tscmGlobal, tilingData);                                                \
        REGIST_MATMUL_OBJ(&pipeIn, GetSysWorkSpacePtr(), op.mm1, bmm1tiling, op.mm4, bmm4tiling, op.mm3_1,             \
                          bmm31tiling);                                                                                \
        op.Init(query, key, value, dy, pse_shift, drop_mask, padding_mask, atten_mask, softmax_max, softmax_sum,       \
                prefix, softmax_in, actual_seq_qlen, actual_seq_kvlen, attention_in, dq, dk, dv, dpse, user,           \
...
// --------------------------------------------float16 tilingkey------------------------------------------------------
    ...
    // -----------------------1.1 start---------------------------------
    // 格式为TND
    } else if (TILING_KEY_IS(10000010000000033434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(half, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010010000033434UL)) {
        // mm2:1  mm1:0 drop:0  dtype:half  s1pingpong:1
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(half, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010001000033434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(half, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010011000033434UL)) {
        // mm2:1  mm1:1 drop:0  dtype:half  s1pingpong:1
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(half, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, TND,
                                              MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010000001033434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(half, INPUT_DISABLE, INPUT_DISABLE, INPUT_ENABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010010001033434UL)) {
        // mm2:1  mm1:0 drop:1  dtype:half  s1pingpong:1
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(half, INPUT_DISABLE, INPUT_DISABLE, INPUT_ENABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010001001033434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(half, INPUT_DISABLE, INPUT_DISABLE, INPUT_ENABLE, MM_NZ_OUT_FORMAT, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010011001033434UL)) {
...
// --------------------------------------------bfloat16 tilingkey------------------------------------------------------
    ...
    // L1 custom sameAB
    if (TILING_KEY_IS(10005111011000022434UL)) {
        // attention_mask:0, pse:0, drop:0, mm_out:nz
        ...
        return;
    } else if (TILING_KEY_IS(10005111011000002434UL)) {
        // attention_mask:0, pse:0, drop:0, mm_out:nz
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_SAMEAB_L1_CUSTOM_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, BSNGD,
            MM_NZ_OUT_FORMAT, INPUT_DISABLE, STemplateType::Aligned512, STemplateType::Aligned512, DTemplateType::Aligned128);
        return;
    } else if (TILING_KEY_IS(10005111011000012434UL)) {
        // attention_mask:0, pse:0, drop:0, mm_out:nz
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_SAMEAB_L1_CUSTOM_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, SBNGD,
            MM_NZ_OUT_FORMAT, INPUT_DISABLE, STemplateType::Aligned512, STemplateType::Aligned512, DTemplateType::Aligned128);
        return;
    } else if (TILING_KEY_IS(10005111011100022434UL)) {
        // attention_mask:1, pse:0, drop:0, mm_out:nz
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_SAMEAB_L1_CUSTOM_IMPL(bfloat16_t, INPUT_ENABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, BNGSD,
            MM_NZ_OUT_FORMAT, INPUT_DISABLE, STemplateType::Aligned512, STemplateType::Aligned512, DTemplateType::Aligned128);
        return;
    } else if (TILING_KEY_IS(10005111011100002434UL)) {
        // attention_mask:1, pse:0, drop:0, mm_out:nz
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_SAMEAB_L1_CUSTOM_IMPL(bfloat16_t, INPUT_ENABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, BSNGD,
            MM_NZ_OUT_FORMAT, INPUT_DISABLE, STemplateType::Aligned512, STemplateType::Aligned512, DTemplateType::Aligned128);
        return;
    } else if (TILING_KEY_IS(10005111011100012434UL)) {
        // attention_mask:1, pse:0, drop:0, mm_out:nz
        ...
        return;
    }else if (TILING_KEY_IS(10001111001000012434UL)) {
        // SBH attention_mask:0, pse:0, drop:0, mm_out:nz
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_SAMEAB_L1_CUSTOM_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, SBNGD,
            MM_ND_OUT_NOALIGN, INPUT_DISABLE, STemplateType::Aligned512, STemplateType::Aligned512, DTemplateType::Aligned64);
        return;
    }else if (TILING_KEY_IS(10001111001000022434UL)) {
    ...
    // -------------------SameAB----------------
    else if (TILING_KEY_IS(10000001000111002434UL)) {
        // attention_mask:1, pse:1, drop:1, mm_out:nd
    ...
    // -----------------------1.1 start---------------------------------
    // for TND layout
    } else if (TILING_KEY_IS(10000010000000032434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010010000032434UL)) {
        // mm2:1  mm1:0 drop:0  dtype:bf16  s1pingpong:1
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010001000032434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010011000032434UL)) {
        // mm2:1  mm1:1 drop:0  dtype:bf16  s1pingpong:1
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_DISABLE, MM_NZ_OUT_FORMAT, TND,
                                              MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010000001032434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_ENABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010010001032434UL)) {
        // mm2:1  mm1:0 drop:1  dtype:bf16  s1pingpong:1
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_ENABLE, MM_ND_OUT_NOALIGN, TND,
                                              MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010001001032434UL)) {
        ...
        INVOKE_FAG_GENERAL_S1S2_BN2GS1S2_IMPL(bfloat16_t, INPUT_DISABLE, INPUT_DISABLE, INPUT_ENABLE, MM_NZ_OUT_FORMAT, TND,
                                              MM_ND_OUT_NOALIGN, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000010011001032434UL)) {
       ...
       // for mm345 NZ out
        ...
        return;
        // pse dropout存在
    } else if (TILING_KEY_IS(10000001000010022134UL)) {
        ...
        return;    
    } else if (TILING_KEY_IS(10000001000010012134UL)) {
        // MM_CFG 7; layout 5; OUT_FORMAT 12
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_NORMAL, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, SBNGD, MM_ND_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001000010002134UL)) {
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_NORMAL, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, BSNGD, MM_ND_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001000011022134UL)) {
        // MM_CFG 7; layout 5;
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_EXCEED, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, BNGSD, MM_ND_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001000011012134UL)) {
        // MM_CFG 7; layout 5;
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_EXCEED, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, SBNGD, MM_ND_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001000011002134UL)) {
        // MM_CFG 7; layout 5;
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_EXCEED, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, BSNGD, MM_ND_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001100010022134UL)) {
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_NORMAL, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, BNGSD, MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001100010012134UL)) {
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_NORMAL, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, SBNGD, MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001100010002134UL)) {
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_NORMAL, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, BSNGD, MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001100011022134UL)) {
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_EXCEED, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, BNGSD, MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001100011012134UL)) {
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_EXCEED, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, SBNGD, MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
    } else if (TILING_KEY_IS(10000001100011002134UL)) {
        INVOKE_FAG_GENERAL_S1S2_BN2_NO_DROP_POSTIN_L1_IMPL(bfloat16_t, MM_CFG_EXCEED, MM_NZ_OUT_FORMAT, INPUT_NONE, INPUT_NONE,
                                                    INPUT_NONE, BSNGD, MM_NZ_OUT_FORMAT, INPUT_ENABLE);
        return;
...
// --------------------------------------------float32 tilingkey------------------------------------------------------
    ...
    // -----------------------1.1 start---------------------------------
        ...
        return;
        // pse dropout存在
    } else if (TILING_KEY_IS(10000001000010021134UL)) {
