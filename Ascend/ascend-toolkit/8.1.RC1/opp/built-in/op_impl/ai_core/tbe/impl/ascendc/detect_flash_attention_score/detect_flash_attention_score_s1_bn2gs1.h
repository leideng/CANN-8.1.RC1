...
/*!
 * \file detect_flash_attention_score_s1_bn2gs1.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_S1_BN2GS1_H
#define DETECT_FLASH_ATTENTION_SCORE_S1_BN2GS1_H
...
FlashAttentionScoreS1Bn2gs1<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock, bmm1Format,
                            ...
                            enableL1Reuse>::SetTiling(const DetectFlashAttentionScoreGeneralTilingData *__restrict tilingData)
{
    // copy base params
...
#endif // DETECT_FLASH_ATTENTION_SCORE_S1_BN2GS1_H
