...
template <typename T1, typename T2>
__aicore__ inline void MoeFinalizeRoutingV2GradWithScaleNotCutH<T1, T2>::Init(GM_ADDR gradY, GM_ADDR expandedRowIdx,
...
template <typename T1, typename T2> __aicore__ inline void MoeFinalizeRoutingV2GradWithScaleNotCutH<T1, T2>::Process()
{
