...
@tbe_register.register_operator("DiagV2", trans_bool_to_s8=False)
...
def diag_v2(x_in__, y_out_, diagonal=0, kernel_name="diag_v2", impl_mode=""):
    ...
    origin_func_name = "diag_v2"
    ascendc_src_dir_ex = "diag_v2"
    ascendc_src_dir = "diag_v2"
    ascendc_src_file = "diag_v2.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator DiagV2, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "DiagV2"
