...
def gru_v2_hidden_grad_cell(dh_pre_t, h, dy, dh, update, reset, new, hidden_new, seq_length,
    ...
    cell = GRUHiddenGradCell(tik_instance, h, dy, dnt_x, seq_length, t_state, gate_order, kernel_name)
    cell.compute()
    cell.build()
