...
@register_operator_compute("bessel_i1e", op_mode="static", support_fusion=True)
def bessel_i1e_compute(x, y, kernel_name="bessel_i1e"):
    ...
    if abs_data.dtype == before_res.dtype and tbe_platform.api_check_support("tbe.dsl.vcmpsel",
                                                                                      abs_data.dtype):
