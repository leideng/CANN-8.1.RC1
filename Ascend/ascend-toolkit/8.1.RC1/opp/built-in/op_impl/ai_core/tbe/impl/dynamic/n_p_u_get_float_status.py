...
@register_operator("NPUGetFloatStatus")
...
def n_p_u_get_float_status(addr, data, kernel_name="n_p_u_get_float_status"):
    ...
    tbe_context.get_context().add_compile_info("vars", { "core_num": aicore_num })
    tik_instance.BuildCCE(kernel_name, inputs=[input_addr], outputs=[output_data])
