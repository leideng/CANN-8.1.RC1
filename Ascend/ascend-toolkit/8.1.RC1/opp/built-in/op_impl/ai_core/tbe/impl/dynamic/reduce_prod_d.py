...
@register_operator_compute("ReduceProdD", op_mode="dynamic", support_fusion=True, support_bfp16=True)
...
def reduce_prod_d(x, y, axes=None, keep_dims=None, kernel_name="reduce_prod_d"):
    """
    ...
    for (x, axes) in ins:
        with tbe.compute():
            ...
            res = reduce_prod_d_compute(data_input, y, axes.get("value"), keep_dims, kernel_name)
