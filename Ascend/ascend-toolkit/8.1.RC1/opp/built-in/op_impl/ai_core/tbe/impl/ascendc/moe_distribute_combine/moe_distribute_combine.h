...
#define TemplateMC2TypeClass typename ExpandXType, typename ExpandIdxType, bool IsNeedReduceScatter
#define TemplateMC2TypeFunc ExpandXType, ExpandIdxType, IsNeedReduceScatter
    ...
    TPipe *pipe, const MoeDistributeCombineTilingData *tilingData)
{
    ...
    expertPerSizeOnWin_ = static_cast<uint64_t>(axisBS_) * static_cast<uint64_t>(axisH_) * static_cast<uint64_t>(sizeof(ExpandXType));
