...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['x1', 'x2', 'bias', 'x3', 'antiquant_scale', 'antiquant_offset', 'dequant_scale', 'pertoken_scale', 'comm_quant_scale_1', 'comm_quant_scale_2']
    output_names = ['y']
...
def _build_args(x1_in__, x2_in__, bias_in__, x3_in__, antiquant_scale_in__, antiquant_offset_in__, dequant_scale_in__, pertoken_scale_in__, comm_quant_scale_1_in__, comm_quant_scale_2_in__, y_out_, group, reduce_op, is_trans_a, is_trans_b, comm_turn, antiquant_group_size):
    __inputs__ = []
    for arg in [x1_in__, x2_in__, bias_in__, x3_in__, antiquant_scale_in__, antiquant_offset_in__, dequant_scale_in__, pertoken_scale_in__, comm_quant_scale_1_in__, comm_quant_scale_2_in__]:
        if arg != None:
    ...
    if reduce_op != None:
        ...
        attr["name"] = "reduce_op"
        attr["dtype"] = "str"
        attr["value"] = reduce_op
        __attrs__.append(attr)
    if is_trans_a != None:
        attr = {}
        attr["name"] = "is_trans_a"
        attr["dtype"] = "bool"
        attr["value"] = is_trans_a
        __attrs__.append(attr)
    if is_trans_b != None:
        attr = {}
    ...
    if comm_turn != None:
        ...
        attr["name"] = "comm_turn"
        attr["dtype"] = "int"
        attr["value"] = comm_turn
        __attrs__.append(attr)
    if antiquant_group_size != None:
        attr = {}
        attr["name"] = "antiquant_group_size"
        attr["dtype"] = "int"
        attr["value"] = antiquant_group_size
        __attrs__.append(attr)
    return __inputs__, __outputs__, __attrs__

@tbe_register.register_operator("MatmulAllReduce", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def matmul_all_reduce(x1_in__, x2_in__, bias_in__=None, x3_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, dequant_scale_in__=None, pertoken_scale_in__=None, comm_quant_scale_1_in__=None, comm_quant_scale_2_in__=None, y_out_=None, group="", reduce_op="sum", is_trans_a=False, is_trans_b=False, comm_turn=0, antiquant_group_size=0, kernel_name="matmul_all_reduce", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x1_in__, x2_in__, bias_in__, x3_in__, antiquant_scale_in__, antiquant_offset_in__, dequant_scale_in__, pertoken_scale_in__, comm_quant_scale_1_in__, comm_quant_scale_2_in__, y_out_, group, reduce_op, is_trans_a, is_trans_b, comm_turn, antiquant_group_size)
    ...
    origin_func_name = "matmul_all_reduce"
    ascendc_src_dir_ex = "matmul_all_reduce"
    ascendc_src_dir = "matmul_all_reduce"
    ascendc_src_file = "matmul_all_reduce.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator MatmulAllReduce, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "MatmulAllReduce"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[x1_in__, x2_in__, bias_in__, x3_in__, antiquant_scale_in__, antiquant_offset_in__, dequant_scale_in__, pertoken_scale_in__, comm_quant_scale_1_in__, comm_quant_scale_2_in__], origin_outputs = [y_out_],\
                param_type_dynamic = False, mc2_ctx = ["mc2_context_0"], param_type_list = ['required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required'], init_value_list = [None],\
...
def op_select_format(x1_in__, x2_in__, bias_in__=None, x3_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, dequant_scale_in__=None, pertoken_scale_in__=None, comm_quant_scale_1_in__=None, comm_quant_scale_2_in__=None, y_out_=None, group="", reduce_op="sum", is_trans_a=False, is_trans_b=False, comm_turn=0, antiquant_group_size=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x1_in__, x2_in__, bias_in__, x3_in__, antiquant_scale_in__, antiquant_offset_in__, dequant_scale_in__, pertoken_scale_in__, comm_quant_scale_1_in__, comm_quant_scale_2_in__, y_out_, group, reduce_op, is_trans_a, is_trans_b, comm_turn, antiquant_group_size)
    result = check_op_cap("op_select_format", "MatmulAllReduce", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x1_in__, x2_in__, bias_in__=None, x3_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, dequant_scale_in__=None, pertoken_scale_in__=None, comm_quant_scale_1_in__=None, comm_quant_scale_2_in__=None, y_out_=None, group="", reduce_op="sum", is_trans_a=False, is_trans_b=False, comm_turn=0, antiquant_group_size=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x1_in__, x2_in__, bias_in__, x3_in__, antiquant_scale_in__, antiquant_offset_in__, dequant_scale_in__, pertoken_scale_in__, comm_quant_scale_1_in__, comm_quant_scale_2_in__, y_out_, group, reduce_op, is_trans_a, is_trans_b, comm_turn, antiquant_group_size)
    result = check_op_cap("get_op_specific_info", "MatmulAllReduce", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
