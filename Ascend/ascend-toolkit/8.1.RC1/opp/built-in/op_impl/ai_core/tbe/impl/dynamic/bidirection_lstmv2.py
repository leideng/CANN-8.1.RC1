...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['x', 'init_h', 'init_c', 'w_ih', 'w_hh', 'b_ih', 'b_hh', 'w_ih_reverse', 'w_hh_reverse', 'b_ih_reverse', 'b_hh_reverse', 'batch_size']
    output_names = ['y', 'output_h', 'output_c']
...
def _build_args(x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__, b_hh_in__, w_ih_reverse_in__, w_hh_reverse_in__, b_ih_reverse_in__, b_hh_reverse_in__, batch_size_in__, y_out_, output_h_out_, output_c_out_, num_layers, isbias, batch_first, bidirection, packed):
    __inputs__ = []
    for arg in [x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__, b_hh_in__, w_ih_reverse_in__, w_hh_reverse_in__, b_ih_reverse_in__, b_hh_reverse_in__, batch_size_in__]:
        if arg != None:
            ...
            __inputs__.append(arg)
    __outputs__ = []
    for arg in [y_out_, output_h_out_, output_c_out_]:
        if arg != None:
            if isinstance(arg, (list, tuple)):
                if len(arg) == 0:
                    continue
    ...
    if num_layers != None:
        attr = {}
        attr["name"] = "num_layers"
        attr["dtype"] = "int"
        attr["value"] = num_layers
    ...
    if batch_first != None:
        attr = {}
        attr["name"] = "batch_first"
        attr["dtype"] = "bool"
        attr["value"] = batch_first
        __attrs__.append(attr)
    if bidirection != None:
        attr = {}
        attr["name"] = "bidirection"
        attr["dtype"] = "bool"
        attr["value"] = bidirection
        __attrs__.append(attr)
    if packed != None:
        attr = {}
        attr["name"] = "packed"
...
@tbe_register.register_operator("BidirectionLSTMV2", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.KERNEL_NAME)
def bidirection_lstmv2(x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__=None, b_hh_in__=None, w_ih_reverse_in__=None, w_hh_reverse_in__=None, b_ih_reverse_in__=None, b_hh_reverse_in__=None, batch_size_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, num_layers=1, isbias=False, batch_first=False, bidirection=False, packed=False, kernel_name="bidirection_lstmv2", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__, b_hh_in__, w_ih_reverse_in__, w_hh_reverse_in__, b_ih_reverse_in__, b_hh_reverse_in__, batch_size_in__, y_out_, output_h_out_, output_c_out_, num_layers, isbias, batch_first, bidirection, packed)
    ...
    origin_func_name = "bidirection_lstmv2"
    ascendc_src_dir_ex = "bidirection_lstmv2"
    ascendc_src_dir = "bidirection_l_s_t_m_v2"
    ascendc_src_file = "bidirection_lstmv2.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator BidirectionLSTMV2, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "BidirectionLSTMV2"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__, b_hh_in__, w_ih_reverse_in__, w_hh_reverse_in__, b_ih_reverse_in__, b_hh_reverse_in__, batch_size_in__], origin_outputs = [y_out_, output_h_out_, output_c_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required', 'required', 'required'], init_value_list = [None, None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{"auto_sync": false, "compile_options": {"ascend310p": ["-mllvm -cce-aicore-jump-expand=true"]}}')

def op_select_format(x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__=None, b_hh_in__=None, w_ih_reverse_in__=None, w_hh_reverse_in__=None, b_ih_reverse_in__=None, b_hh_reverse_in__=None, batch_size_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, num_layers=1, isbias=False, batch_first=False, bidirection=False, packed=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__, b_hh_in__, w_ih_reverse_in__, w_hh_reverse_in__, b_ih_reverse_in__, b_hh_reverse_in__, batch_size_in__, y_out_, output_h_out_, output_c_out_, num_layers, isbias, batch_first, bidirection, packed)
    result = check_op_cap("op_select_format", "BidirectionLSTMV2", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__=None, b_hh_in__=None, w_ih_reverse_in__=None, w_hh_reverse_in__=None, b_ih_reverse_in__=None, b_hh_reverse_in__=None, batch_size_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, num_layers=1, isbias=False, batch_first=False, bidirection=False, packed=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, init_h_in__, init_c_in__, w_ih_in__, w_hh_in__, b_ih_in__, b_hh_in__, w_ih_reverse_in__, w_hh_reverse_in__, b_ih_reverse_in__, b_hh_reverse_in__, batch_size_in__, y_out_, output_h_out_, output_c_out_, num_layers, isbias, batch_first, bidirection, packed)
    result = check_op_cap("get_op_specific_info", "BidirectionLSTMV2", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
