...
@register_operator_compute("basic_lstm_cell_v2", op_mode="static", support_fusion=True)
def basic_lstm_cell_v2_compute(x, cont, w_xc_x_static, w_xh, bias, h_t, c_t,
    ...
    it_ub = tvm.compute(gate_shape,
                        lambda *i: tensor_list.get("tensor_matmul_result_l0c_it")(*i),
                        name="it_ub")
    ft_ub = tvm.compute(gate_shape,
                        lambda *i: tensor_list.get("tensor_matmul_result_l0c_ft")(*i),
                        name="ft_ub")
    ot_ub = tvm.compute(gate_shape,
                        lambda *i: tensor_list.get("tensor_matmul_result_l0c_ot")(*i),
                        name="ot_ub")
    ...
    if w_xc_x_static is not None:
        ...
        it_ub_true = tensor_list.get("it_ub_true")
        ft_ub_true = tensor_list.get("ft_ub_true")
        ot_ub_true = tensor_list.get("ot_ub_true")
        gt_ub_true = tensor_list.get("gt_ub_true")
