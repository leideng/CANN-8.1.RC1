...
/*!
 * \file LstmMmMergeFP32.h
 * \brief
 */
#ifndef _ASCENDC_LSTM_MM_MERGEFP32_H_
#define _ASCENDC_LSTM_MM_MERGEFP32_H_
...
template <typename T>
class LstmMmMergeFP32 {
 public:
  __aicore__ inline LstmMmMergeFP32() = default;
 ...
 protected:
  ...
  __aicore__ inline void CopyInInitC(AscendC::LocalTensor<float>& dstUb);
 ...
 protected:
  ...
  // LocalTensor
  AscendC::LocalTensor<float> ubLocal2, ubLocal3, ubLocal4, ubLocal5;
