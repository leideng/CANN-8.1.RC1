...
@register_operator_compute("AdamApplyOne", op_mode="dynamic", support_fusion=True, support_bfp16=True)
def adam_apply_one_compute(data_input0, data_input1, data_input2, data_input3,
    ...
    # truediv
    add_2_result, output1_brd = shape_broadcast(add_2_result, output1)
    truediv_result = tbe.vdiv(output1_brd, add_2_result)
...
def adam_apply_one(input0, input1, input2, input3, input4,
    ...
    input0: dict
         ...
         and dtype supports 'float16', 'float32', 'bfloat16'
    input1: dict
         the dict of input of mul_2, and dtype supports 'float16', 'float32', 'bfloat16'
    input2: dict
         the dict of input of mul, and dtype supports 'float16', 'float32', 'bfloat16'
    input3: dict
         the dict of input of sub, and dtype supports 'float16', 'float32', 'bfloat16'
    input4: dict
         the dict of input of mul_4, and dtype supports 'float16', 'float32', 'bfloat16'
    mul0_x: dict
         the dict of input of mul_0, and dtype supports 'float16', 'float32', 'bfloat16'
    mul1_x: dict
         the dict of input of mul_1, and dtype supports 'float16', 'float32', 'bfloat16'
    mul2_x: dict
         the dict of input of mul_2, and dtype supports 'float16', 'float32', 'bfloat16'
    mul3_x: dict
         the dict of input of mul_3, and dtype supports 'float16', 'float32', 'bfloat16'
    add2_y: dict
         the dict of input of add_2, and dtype supports 'float16', 'float32', 'bfloat16'
    output0: dict
         the dict of output of add_1, and dtype supports 'float16', 'float32', 'bfloat16'
    output1: dict
         the dict of output of add_0, and dtype supports 'float16', 'float32', 'bfloat16'
    output2: dict
         the dict of output of sub, and dtype supports 'float16', 'float32', 'bfloat16'
    kernel_name: str
