...
def sqrt_compute(x, kernel_name="sqrt"):
    ...
    if input_dtype == "float16" and tbe_platform.api_check_support("tbe.dsl.vsqrt", "float32"):
...
@register_operator_compute("adam_apply_one_with_decay_assign", op_mode="static", support_fusion=True)
