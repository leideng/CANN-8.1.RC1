...
@tbe_register.register_operator("Conv2DTransposeV2", trans_bool_to_s8=False)
...
def conv2d_transpose_v2(input_size_in__, x_in__, filter_in__, bias_in__=None, offset_w_in__=None, y_out_=None, strides=[], pads=[], dilations=[1,1,1,1], groups=1, data_format="NHWC", output_padding=[0,0,0,0], offset_x=0, kernel_name="conv2d_transpose_v2", impl_mode=""):
    ...
    origin_func_name = "conv2d_transpose_v2"
    ascendc_src_dir_ex = "conv2_d_transpose_v2"
    ascendc_src_dir = "conv2_d_transpose_v2"
    ascendc_src_file = "conv2d_transpose_v2.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator Conv2DTransposeV2, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "Conv2DTransposeV2"
...
def op_select_format(input_size_in__, x_in__, filter_in__, bias_in__=None, offset_w_in__=None, y_out_=None, strides=[], pads=[], dilations=[1,1,1,1], groups=1, data_format="NHWC", output_padding=[0,0,0,0], offset_x=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(input_size_in__, x_in__, filter_in__, bias_in__, offset_w_in__, y_out_, strides, pads, dilations, groups, data_format, output_padding, offset_x)
    result = check_op_cap("op_select_format", "Conv2DTransposeV2", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(input_size_in__, x_in__, filter_in__, bias_in__=None, offset_w_in__=None, y_out_=None, strides=[], pads=[], dilations=[1,1,1,1], groups=1, data_format="NHWC", output_padding=[0,0,0,0], offset_x=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(input_size_in__, x_in__, filter_in__, bias_in__, offset_w_in__, y_out_, strides, pads, dilations, groups, data_format, output_padding, offset_x)
    result = check_op_cap("get_op_specific_info", "Conv2DTransposeV2", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
