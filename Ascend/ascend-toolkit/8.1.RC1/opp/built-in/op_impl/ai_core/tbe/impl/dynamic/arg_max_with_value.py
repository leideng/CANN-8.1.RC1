...
class ArgMaxWithValue(ArgCommonWithValue):
...
def arg_max_with_value(x, index, value, dimension, kernel_name="arg_max_with_value"):
    ...
    max_with_value = ArgMaxWithValue(dtype_x, dtype_y, is_dynamic, kernel_name)

    tik_instance = max_with_value.get_tik_instance()
    return tik_instance
