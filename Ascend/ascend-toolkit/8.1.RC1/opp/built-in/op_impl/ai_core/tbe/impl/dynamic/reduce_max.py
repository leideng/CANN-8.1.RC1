...
@register_operator_compute("ReduceMax", op_mode="dynamic", support_fusion=True, support_bfp16=True)
...
def reduce_max(x, axes, y, keep_dims=False, kernel_name="reduce_max"):
    """
