...
public:
                                                        ...
                                                        int32_t baseBlockSize)
    {
        ...
        if (posL1 < totalBlockNum - 1) {
            this->offsetA[posL1 + 1] = this->offsetA[posL1] + ((tileHeight + 15) / 16 * 16) *
                                                                ((tileWidth + 15) / 16 * 16);
        }
                                                        ...
                                                        int32_t baseBlockSize)
    {
        ...
        if (posL1 < totalBlockNum - 1) {
            this->offsetB[posL1 + 1] = this->offsetB[posL1] + ((tileHeight + 15) / 16 * 16) * ((tileWidth + 15) / 16 * 16);
        }
        ...
        MATMUL_MODULE(DataCopyUtils)
            ->CopyTileToCube(MATMUL_MODULE(Context)->CurrentTensorB, curRow, curCol,
