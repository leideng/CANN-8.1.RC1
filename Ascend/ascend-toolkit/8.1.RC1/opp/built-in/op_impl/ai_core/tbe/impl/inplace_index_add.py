...
class Scatter:
    ...
    def get_some_basic_info(self):
        ...
        self.ub_size_bytes = (
                tbe_platform.get_soc_spec(
                    tbe_platform.UB_SIZE) - Constant.UB_RESERVE_SIZE)
    ...
    def create_gm_tensors(self):
        ...
        self.var_gm = self.tik_instance.Tensor(
            self.var_dtype, self.var_shape, name="var_gm", scope=tbe_platform.scope_gm)
        ...
        self.out_gm = self.tik_instance.Tensor(
            self.var_dtype, self.var_shape, name="out_gm", scope=tbe_platform.scope_gm)
