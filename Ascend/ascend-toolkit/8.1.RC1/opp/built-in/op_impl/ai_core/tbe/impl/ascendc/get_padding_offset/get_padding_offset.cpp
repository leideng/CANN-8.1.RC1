...
public:
    ...
    __aicore__ inline void Init(GM_ADDR input_ids,
                                GM_ADDR cum_offsets_now, 
                                GM_ADDR token_num,
                                GM_ADDR seq_len, 
                                GM_ADDR x_remove_padding,
                                GM_ADDR cum_offsets_out, 
                                GM_ADDR padding_offset,
                                uint32_t padLength_, 
                                uint32_t batch)
    {
...
inline __aicore__ void InitTilingData(const __gm__ uint8_t *p_tilingdata, GetPaddingOffsetTilingData *tilingdata)
{
    ...
    CopyGmTilingToUb(tilingdata_in_ub, p_tilingdata, sizeof(GetPaddingOffsetTilingData), &pipe);
    AscendC::PipeBarrier<PIPE_ALL>();
...
#define GET_TILING_DATA(tiling_data, tiling_arg) \
    GetPaddingOffsetTilingData tiling_data;         \
