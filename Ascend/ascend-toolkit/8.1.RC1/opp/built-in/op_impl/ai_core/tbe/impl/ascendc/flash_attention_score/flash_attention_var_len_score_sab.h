...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T, typename T,
          CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::UnpackInit(
    ...
    const FlashAttentionScoreGeneralTilingData *__restrict tiling, TPipe *tPipe)
{
    ...
    for (int64_t i = 0; i < this->tilingData->inputParams.bSize; ++i) {
        ...
        if (actualS2Len <= 0 && actualS1Len != 0) {
            ...
            AscendC::InitOutput<INPUT_T>(this->attentionOutGm[accumSize * this->n2GD],
                                         actualS1Len * this->n2GD, static_cast<INPUT_T>(0.0));
...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::ComputeConstexpr()
{
...
FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                bmm1Format, mmPolicyType, implMode>::GetSeqQlenKvlenByBoidx(int64_t boIdx,
...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::CalS1OuterSize(int64_t offset)
{
...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::ComputeAxisIdx(int64_t multiCoreInnerIdx)
{
    int64_t actualS1Len;
    int64_t actualS2Len;
...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::GetS2LoopRange()
{
    int64_t actualS1Len;
    int64_t actualS2Len;
    GetSeqQlenKvlenByBoidx(this->boIdx, actualS1Len, actualS2Len);
...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::Process()
{
    // 确定核内切分起点
...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::SetExtraInfo(
...
template <LayOutTypeEnum layOutType, bool hasPse, bool hasAtten, bool hasDrop, typename INPUT_T,
          typename T, CubeFormat bmm1Format, MmPolicyType mmPolicyType, ImplModeEnum implMode>
__aicore__ inline void FlashAttentionVarLenScoreSameAB<layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T,
                                                       bmm1Format, mmPolicyType, implMode>::ComputeBmm1Tail(SplitSameABExtraInfo &extraInfo)
{
