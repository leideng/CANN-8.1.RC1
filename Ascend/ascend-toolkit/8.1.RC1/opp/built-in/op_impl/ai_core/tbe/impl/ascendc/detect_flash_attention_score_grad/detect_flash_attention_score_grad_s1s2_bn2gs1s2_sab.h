...
/*!
 * \file detect_flash_attention_score_grad_s1s2_bn2gs1s2_sab.h
 * \brief
 */

#ifndef _DETECT_FLASH_ATTENTION_SCORE_GRAD_S1S2_BN2GS1S2_SAMEAB_H_
#define _DETECT_FLASH_ATTENTION_SCORE_GRAD_S1S2_BN2GS1S2_SAMEAB_H_
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *dx, __gm__ uint8_t *query,
                                ...
                                const DetectFlashAttentionScoreGradTilingDataS1s2Bn2gs1s2SameAb *__restrict ordTilingData);
...
protected:
    ...
    const DetectFlashAttentionScoreGradTilingDataS1s2Bn2gs1s2SameAb *__restrict TilingData;
...
#endif // _DETECT_FLASH_ATTENTION_SCORE_GRAD_S1S2_BN2GS1S2_SAMEAB_H_
