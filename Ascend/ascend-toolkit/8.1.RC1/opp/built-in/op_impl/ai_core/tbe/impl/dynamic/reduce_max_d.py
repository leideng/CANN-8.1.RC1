...
@register_operator_compute("ReduceMaxD", op_mode="dynamic", support_fusion=True, support_bfp16=True)
...
def reduce_max_d(x, y, axes=None, keep_dims=None, kernel_name="reduce_max_d"):
    """
    ...
    for (x, axes) in ins:
        with tbe.compute():
            ...
            res = reduce_max_d_compute(data_input, y, axes.get("value"), keep_dims, kernel_name)
