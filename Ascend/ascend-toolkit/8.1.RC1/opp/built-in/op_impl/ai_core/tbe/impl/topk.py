...
def tik_topk_filter_by_score_threshold(tik_inst, filter_input, top_output):
    ...
    required_score_ub = tik_inst.Tensor(
        ...
        name="required_score_ub", scope=tbe_platform.scope_ubuf)
    ...
    if tbe_platform.get_soc_spec("SHORT_SOC_VERSION") in ("Ascend310", "Ascend910", "Hi3796CV300ES",
        ...
        init_mask_ub = tik_inst.Tensor("uint16", (16,), name="init_mask_ub", scope=tbe_platform.scope_ubuf)
