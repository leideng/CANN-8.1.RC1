...
/*!
 * \file detect_flash_attention_score_grad_sfmg.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_GRAD_SFMG_KERNEL_H_
#define DETECT_FLASH_ATTENTION_SCORE_GRAD_SFMG_KERNEL_H_
...
#endif // DETECT_FLASH_ATTENTION_SCORE_GRAD_SFMG_KERNEL_H_
