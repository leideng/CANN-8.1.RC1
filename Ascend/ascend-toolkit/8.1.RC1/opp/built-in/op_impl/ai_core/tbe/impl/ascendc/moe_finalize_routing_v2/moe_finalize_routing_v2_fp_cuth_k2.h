...
public:
    __aicore__ inline MoeFinalizeRoutingV2FpCuthK2(
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2FpCuthK2<T, ISBIASEXIST>::Init(GM_ADDR expandedPermutedRows,
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2FpCuthK2<T, ISBIASEXIST>::CopyIn(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
    bool isPadH, int64_t rightPaddingH)
{
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2FpCuthK2<T, ISBIASEXIST>::Compute(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
    bool isPadH, int64_t rightPaddingH)
{
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2FpCuthK2<T, ISBIASEXIST>::CopyOut(int64_t nLoopIdx, int64_t bias, int64_t dataLen)
{
