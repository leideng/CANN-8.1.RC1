...
def _build_args(x_in__, grad_in__, argmax_in__, y_out_):
    __inputs__ = []
...
@tbe_register.register_operator("AdaptiveMaxPool3DGrad", trans_bool_to_s8=False)
...
def adaptive_max_pool3d_grad(x_in__, grad_in__, argmax_in__, y_out_, kernel_name="adaptive_max_pool3d_grad", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, grad_in__, argmax_in__, y_out_)
    ...
    origin_func_name = "adaptive_max_pool3d_grad"
    ascendc_src_dir_ex = "adaptive_max_pool3_d_grad"
    ascendc_src_dir = "adaptive_max_pool3_d_grad"
    ascendc_src_file = "adaptive_max_pool3d_grad.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator AdaptiveMaxPool3DGrad, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "AdaptiveMaxPool3DGrad"
