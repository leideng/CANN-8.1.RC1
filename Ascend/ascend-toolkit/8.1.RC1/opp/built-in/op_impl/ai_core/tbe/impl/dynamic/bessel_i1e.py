...
def _after_res_compute(abs_data, const_limit):
    ...
    tensor_sqrt = tbe.vsqrt(abs_data, impl_mode=OpTbeImplMode.TBE_HIGH_PRECISION)
...
@register_operator_compute("BesselI1e", op_mode="dynamic", support_fusion=True, support_bfp16=True)
