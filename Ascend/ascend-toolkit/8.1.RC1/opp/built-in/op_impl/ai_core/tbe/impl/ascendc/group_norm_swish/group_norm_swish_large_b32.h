...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishLargeB32<T1, T2>::Init(GM_ADDR x, GM_ADDR gamma, GM_ADDR beta, GM_ADDR y,
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishLargeB32<T1, T2>::CalcMeanAndRstdInner(const int64_t groupId,
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishLargeB32<T1, T2>::CalcGroupNormSwish(const int64_t groupBegin,
...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishLargeB32<T1, T2>::CalcGroupNormSwishInner(const float scale, const float bias,
                                                                               const int64_t num)
{
    LocalTensor<T1> xUb = this->inQueueX.template DeQue<T1>();
