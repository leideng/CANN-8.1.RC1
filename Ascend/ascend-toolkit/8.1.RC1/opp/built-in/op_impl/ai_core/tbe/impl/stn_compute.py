...
class SpatialTransformer:
    ...
    def __init__(self, input_x, auxiliary_coefficients, auxiliary_offset, kernel_name='stn_compute'):
        ...
        self.d_type_bytes_size = get_bit_len(self.d_type_x) // 8
        self.theta_type_bytes_size = get_bit_len(auxiliary_coefficients.get('dtype')) // 8
        self.offset_type_bytes_size = get_bit_len(auxiliary_offset.get('dtype')) // 8
