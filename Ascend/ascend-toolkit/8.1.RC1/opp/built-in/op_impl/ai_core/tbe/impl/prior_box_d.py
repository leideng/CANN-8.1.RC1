...
def _prior_box_check(feature, img, data_h, data_w, min_size, max_size, img_h, img_w, step_h, step_w, variance,
    ...
    para_check.check_shape(shape_feature, min_rank=4, param_name="feature")
    para_check.check_shape(shape_img, min_rank=4, param_name="img")
...
def _multicore_factor_calculate(shape, element):
    ...
    if device_core_num <= 0:
        error_manager_vector.raise_err_specific_reson("prior_box_d", "The value of the CORE_NUM is illegal!")
...
def prior_box_d(feature,
    ...
    if ub_size_limit <= 0:
        error_manager_vector.raise_err_specific_reson("prior_box_d", "The value of the UB_SIZE is illegal!")
