...
@tbe_register.register_operator("UpsampleBicubic2d", trans_bool_to_s8=False)
...
def upsample_bicubic2d(input_in__, output_out_, output_size, align_corners=False, scales_h=0, scales_w=0, kernel_name="upsample_bicubic2d", impl_mode=""):
    ...
    origin_func_name = "upsample_bicubic2d"
    ascendc_src_dir_ex = "upsample_bicubic2d"
    ascendc_src_dir = "upsample_bicubic2d"
    ascendc_src_file = "upsample_bicubic2d.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator UpsampleBicubic2d, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "UpsampleBicubic2d"
...
def op_select_format(input_in__, output_out_, output_size, align_corners=False, scales_h=0, scales_w=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(input_in__, output_out_, output_size, align_corners, scales_h, scales_w)
    result = check_op_cap("op_select_format", "UpsampleBicubic2d", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(input_in__, output_out_, output_size, align_corners=False, scales_h=0, scales_w=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(input_in__, output_out_, output_size, align_corners, scales_h, scales_w)
    result = check_op_cap("get_op_specific_info", "UpsampleBicubic2d", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
