...
def _func_transform_201(tensor_args, tp_args):
    ...
    (tiling_mode, ub_offset, mc_pos, used_core_cnt, srcr2nd_dstr2nd_same, c0_len, core_step_in, core_step_out,
     ...
     dst_r2nd_in_1_src_asize, dst_r2nd_dims, vnc_col_size, all_r2nd_in, core_num_var) = tp_args
    ...
    def _inner_func(args):
        ...
        if dmp_flag is False:
            backend_args = (tik_inst, block_idx, mc_pos, used_core_cnt, lc_src_c1_lp_cnt,
                            lc_src_c1_left, c1_backend_idx, src_c1_lp_cnt, lc_dst_r2nd_lp_cnt,
                            lc_dst_r2nd_left, dst_r2nd_step_out, r2nd_backend_idx,
