...
/*!
 * \file detect_flash_attention_score_grad_post.h
 * \brief common post process
 */

#ifndef _DETECT_FLASH_ATTENTION_SCORE_GRAD_POST_H_
#define _DETECT_FLASH_ATTENTION_SCORE_GRAD_POST_H_
...
#endif // _DETECT_FLASH_ATTENTION_SCORE_GRAD_POST_H_
