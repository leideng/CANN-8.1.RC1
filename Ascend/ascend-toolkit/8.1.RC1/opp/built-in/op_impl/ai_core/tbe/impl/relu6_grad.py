...
@register_operator_compute("relu6_grad", op_mode="static", support_fusion=True)
...
def relu6_grad(input_grad, input_x, output_y, kernel_name="relu6_grad"):
    ...
    if input_dtype == "float32" and not tbe_platform.api_check_support("tbe.dsl.vmuls", "float32"):
