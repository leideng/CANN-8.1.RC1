 ...
 * \brief
 */
#ifndef _ASCENDC_LSTMFP32SEQ_H_
#define _ASCENDC_LSTMFP32SEQ_H_

#include "dynamic_rnn_common.h"

template <typename T>
class LstmMmSplitNDNDFP32Seq {
 public:
  __aicore__ inline LstmMmSplitNDNDFP32Seq() = default;
