...
@tbe_register.register_operator("MatMulV3", trans_bool_to_s8=False)
...
def mat_mul_v3(x1_in__, x2_in__, bias_in__=None, offset_w_in__=None, y_out_=None, transpose_x1=False, transpose_x2=False, offset_x=0, enable_hf32=False, kernel_name="mat_mul_v3", impl_mode=""):
    ...
    origin_func_name = "mat_mul_v3"
    ascendc_src_dir_ex = "mat_mul_v3"
    ascendc_src_dir = "mat_mul_v3"
    ascendc_src_file = "mat_mul_v3.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator MatMulV3, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "MatMulV3"
