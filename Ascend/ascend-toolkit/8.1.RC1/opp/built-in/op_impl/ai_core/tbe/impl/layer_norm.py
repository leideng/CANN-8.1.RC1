...
def check_supported(input_x,
    ...
    check_supported
    """
    return True, "go to static operator"
...
# 'pylint: disable=too-many-statements,too-many-branches
@register_operator_compute("layer_norm", op_mode="static", support_fusion=True)
...
def layer_norm(input_x, input_gamma, input_beta,
    ...
    if tik_support:
        ...
        with tvm.target.cce():
            sch = auto_schedule([res, mean, variance])
