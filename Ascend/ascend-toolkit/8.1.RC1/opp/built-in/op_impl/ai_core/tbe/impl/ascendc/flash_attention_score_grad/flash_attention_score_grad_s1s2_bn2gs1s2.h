...
__aicore__ inline void FlashAttentionScoreGradS1s2Bn2gs1s2<
    ...
    MM2_OUT_FORMAT, TND_S1_PP>::Init(__gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *dx, __gm__ uint8_t *query,
                          __gm__ uint8_t *pse_shift, __gm__ uint8_t *drop_mask, __gm__ uint8_t *atten_mask,
                          __gm__ uint8_t *forward_res, __gm__ uint8_t *softmax_max, __gm__ uint8_t *softmax_sum,
                          __gm__ uint8_t *prefixN, __gm__ uint8_t *actual_seq_qlen, __gm__ uint8_t *actual_seq_kvlen,
                          __gm__ uint8_t *dq, __gm__ uint8_t *dk, __gm__ uint8_t *dv, __gm__ uint8_t *dpse,
...
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::GetSeqQlenKvlenByBidx(int64_t bIdx,
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
    MM2_OUT_FORMAT, TND_S1_PP>::CalcSoftMaxGradPingPong(int64_t outerPingPong, int64_t aTensorOffset,
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::CopyInAttenMaskBool(LocalTensor<uint8_t> &dstTensor,
...
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::CheckIsValidBlock(int64_t baseIdx, int64_t s1oDimIdx,
...
template <typename T1, typename T2, const uint32_t IS_ATTEN_MASK, const uint32_t IS_PSE, const uint32_t IS_DROP,
          const CubeFormat MM_OUT_FORMAT, const uint32_t INPUT_LAYOUT, const CubeFormat MM2_OUT_FORMAT, const uint32_t TND_S1_PP>
__aicore__ inline void FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT,
                                                           INPUT_LAYOUT, MM2_OUT_FORMAT, TND_S1_PP>::UpdateToken(int64_t bIdx)
{
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::CalcAttenMaskOffset(int64_t &attenMaskOffset, const int64_t delta,
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::CalcAttenMaskOffsetForPrefixCompressMode(int64_t &attenMaskOffset,
...
__aicore__ inline void FlashAttentionScoreGradS1s2Bn2gs1s2<
    T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
    MM2_OUT_FORMAT, TND_S1_PP>::CalcAttenMaskOffsetWithSparseModeForUnpad(int64_t &attenMaskOffset, int64_t &attenMaskOffset2,
                                                               uint32_t s1VSize, uint32_t s2VSize, int64_t curS1Idx,
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::CalcAttenMaskOffsetWithSparseMode(int64_t &attenMaskOffset,
                                                                                       int64_t &attenMaskOffset2,
                                                                                       uint32_t s1VSize,
                                                                                       uint32_t s2VSize,
                                                                                       int64_t curS1Idx,
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::CalcAttenBandMode(int64_t compressMode, int64_t causal_delta)
{
    int64_t actualS1Len;
    int64_t actualS2Len;
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::DropOutCopy(LocalTensor<uint8_t> &vecInDropBuffer,
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::SubGrapA(int64_t curIdx, int64_t curS1Idx, int64_t curS2Idx,
                                    EvenvIdList &eventIdList)
{
    int64_t actualS1Len;
    int64_t actualS2Len;
...
__aicore__ inline void
FlashAttentionScoreGradS1s2Bn2gs1s2<T1, T2, IS_ATTEN_MASK, IS_PSE, IS_DROP, MM_OUT_FORMAT, INPUT_LAYOUT,
                                    MM2_OUT_FORMAT, TND_S1_PP>::SubGrapB(int64_t curIdx, int64_t curS1Idx, int64_t curS2Idx,
                                    EvenvIdList &eventIdList)
{
    bool isPing = ((curIdx % 2) == 0);
    ...
    if constexpr (TND_S1_PP == ENABLE) {
        ...
        for (uint32_t curS2Idx = 0; curS2Idx < s2VecLoop; curS2Idx++) {
            ...
            for (uint32_t curS1Idx = 0; curS1Idx < s1VecLoop; curS1Idx = curS1Idx + 2) {
                ...
                sfmgOffset += (((static_cast<int64_t>(s1oDimIdxTmp) * s1CvInner + curS1IdxPing * s1VecSize) * n2 +
                    n2DimIdxTmp) * g + gDimIdxTmp) * d;
