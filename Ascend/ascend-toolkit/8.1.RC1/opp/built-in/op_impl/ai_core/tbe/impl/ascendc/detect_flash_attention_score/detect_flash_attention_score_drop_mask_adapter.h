...
/*!
 * \file detect_flash_attention_score_drop_mask_adapter.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_DROP_MASK_ADAPTER_H
#define DETECT_FLASH_ATTENTION_SCORE_DROP_MASK_ADAPTER_H
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *dropMask, __gm__ uint8_t *workspace,
                                const DetectFlashAttentionScoreGeneralTilingData *__restrict tiling, AscendC::TPipe *tPipe);
...
#endif // DETECT_FLASH_ATTENTION_SCORE_DROP_MASK_ADAPTER_H
