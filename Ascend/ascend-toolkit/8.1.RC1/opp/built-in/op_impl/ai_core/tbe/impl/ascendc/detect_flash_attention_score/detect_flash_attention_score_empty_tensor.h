...
/*!
 * \file detect_flash_attention_score_empty_tensor.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_EMPTY_TENSOR_H
#define DETECT_FLASH_ATTENTION_SCORE_EMPTY_TENSOR_H
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *softmaxMax, __gm__ uint8_t *softmaxSum, __gm__ uint8_t *attentionOut,
                                const DetectFlashAttentionScoreTilingData *__restrict tiling);
...
protected:
    ...
    const DetectFlashAttentionScoreTilingData *__restrict tilingData;
...
#endif // DETECT_FLASH_ATTENTION_SCORE_EMPTY_TENSOR_H
