...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['x', 'weight_input', 'weight_hidden', 'b', 'seq_length', 'init_h', 'init_c', 'wci', 'wcf', 'wco', 'mask']
    output_names = ['y', 'output_h', 'output_c', 'i', 'j', 'f', 'o', 'tanhc']
...
def _build_args(x_in__, weight_input_in__, weight_hidden_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__, y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_, cell_type, direction, cell_depth, use_peephole, keep_prob, cell_clip, num_proj, time_major, activation, recurrent_activation, forget_bias, gate_order, stateful, merge_mode, is_training):
    __inputs__ = []
    for arg in [x_in__, weight_input_in__, weight_hidden_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__]:
        if arg != None:
            ...
            __inputs__.append(arg)
    __outputs__ = []
    for arg in [y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_]:
        if arg != None:
            if isinstance(arg, (list, tuple)):
                if len(arg) == 0:
                    continue
    ...
    if cell_depth != None:
        attr = {}
        attr["name"] = "cell_depth"
        attr["dtype"] = "int"
        attr["value"] = cell_depth
        __attrs__.append(attr)
    if use_peephole != None:
        attr = {}
        attr["name"] = "use_peephole"
        attr["dtype"] = "bool"
        attr["value"] = use_peephole
        __attrs__.append(attr)
    if keep_prob != None:
        attr = {}
        attr["name"] = "keep_prob"
        attr["dtype"] = "float"
        attr["value"] = keep_prob
        __attrs__.append(attr)
    if cell_clip != None:
        attr = {}
        attr["name"] = "cell_clip"
        attr["dtype"] = "float"
        attr["value"] = cell_clip
        __attrs__.append(attr)
    if num_proj != None:
        attr = {}
        attr["name"] = "num_proj"
    ...
    if time_major != None:
        attr = {}
        attr["name"] = "time_major"
        attr["dtype"] = "bool"
        attr["value"] = time_major
        __attrs__.append(attr)
    if activation != None:
        attr = {}
        attr["name"] = "activation"
        attr["dtype"] = "str"
        attr["value"] = activation
        __attrs__.append(attr)
    if recurrent_activation != None:
        attr = {}
        attr["name"] = "recurrent_activation"
        attr["dtype"] = "str"
        attr["value"] = recurrent_activation
        __attrs__.append(attr)
    if forget_bias != None:
        attr = {}
        attr["name"] = "forget_bias"
        attr["dtype"] = "float"
        attr["value"] = forget_bias
        __attrs__.append(attr)
    if gate_order != None:
        attr = {}
        attr["name"] = "gate_order"
        attr["dtype"] = "str"
        attr["value"] = gate_order
        __attrs__.append(attr)
    if stateful != None:
        attr = {}
        attr["name"] = "stateful"
    ...
    if merge_mode != None:
        attr = {}
        attr["name"] = "merge_mode"
        attr["dtype"] = "str"
        attr["value"] = merge_mode
        __attrs__.append(attr)
    if is_training != None:
        attr = {}
        attr["name"] = "is_training"
        attr["dtype"] = "bool"
        attr["value"] = is_training
        __attrs__.append(attr)
    return __inputs__, __outputs__, __attrs__

@tbe_register.register_operator("DynamicRNNV2", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_BOOL, para_check.KERNEL_NAME)
def dynamic_rnn_v2(x_in__, weight_input_in__, weight_hidden_in__, b_in__=None, seq_length_in__=None, init_h_in__=None, init_c_in__=None, wci_in__=None, wcf_in__=None, wco_in__=None, mask_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, i_out_=None, j_out_=None, f_out_=None, o_out_=None, tanhc_out_=None, cell_type="LSTM", direction="UNIDIRECTIONAL", cell_depth=1, use_peephole=False, keep_prob=1, cell_clip=-1, num_proj=0, time_major=True, activation="tanh", recurrent_activation="sigmoid", forget_bias=0, gate_order="ijfo", stateful=False, merge_mode="concat", is_training=True, kernel_name="dynamic_rnn_v2", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_input_in__, weight_hidden_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__, y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_, cell_type, direction, cell_depth, use_peephole, keep_prob, cell_clip, num_proj, time_major, activation, recurrent_activation, forget_bias, gate_order, stateful, merge_mode, is_training)
    ...
    origin_func_name = "dynamic_rnn_v2"
    ascendc_src_dir_ex = "dynamic_rnnv2"
    ascendc_src_dir = "dynamic_r_n_n_v2"
    ascendc_src_file = "dynamic_rnn_v2_910b.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator DynamicRNNV2, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "DynamicRNNV2"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[x_in__, weight_input_in__, weight_hidden_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__], origin_outputs = [y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required', 'required', 'required', 'required', 'required', 'required', 'required', 'required'], init_value_list = [None, None, None, None, None, None, None, None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{"auto_sync": false}')

def op_select_format(x_in__, weight_input_in__, weight_hidden_in__, b_in__=None, seq_length_in__=None, init_h_in__=None, init_c_in__=None, wci_in__=None, wcf_in__=None, wco_in__=None, mask_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, i_out_=None, j_out_=None, f_out_=None, o_out_=None, tanhc_out_=None, cell_type="LSTM", direction="UNIDIRECTIONAL", cell_depth=1, use_peephole=False, keep_prob=1, cell_clip=-1, num_proj=0, time_major=True, activation="tanh", recurrent_activation="sigmoid", forget_bias=0, gate_order="ijfo", stateful=False, merge_mode="concat", is_training=True, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_input_in__, weight_hidden_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__, y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_, cell_type, direction, cell_depth, use_peephole, keep_prob, cell_clip, num_proj, time_major, activation, recurrent_activation, forget_bias, gate_order, stateful, merge_mode, is_training)
    result = check_op_cap("op_select_format", "DynamicRNNV2", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, weight_input_in__, weight_hidden_in__, b_in__=None, seq_length_in__=None, init_h_in__=None, init_c_in__=None, wci_in__=None, wcf_in__=None, wco_in__=None, mask_in__=None, y_out_=None, output_h_out_=None, output_c_out_=None, i_out_=None, j_out_=None, f_out_=None, o_out_=None, tanhc_out_=None, cell_type="LSTM", direction="UNIDIRECTIONAL", cell_depth=1, use_peephole=False, keep_prob=1, cell_clip=-1, num_proj=0, time_major=True, activation="tanh", recurrent_activation="sigmoid", forget_bias=0, gate_order="ijfo", stateful=False, merge_mode="concat", is_training=True, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight_input_in__, weight_hidden_in__, b_in__, seq_length_in__, init_h_in__, init_c_in__, wci_in__, wcf_in__, wco_in__, mask_in__, y_out_, output_h_out_, output_c_out_, i_out_, j_out_, f_out_, o_out_, tanhc_out_, cell_type, direction, cell_depth, use_peephole, keep_prob, cell_clip, num_proj, time_major, activation, recurrent_activation, forget_bias, gate_order, stateful, merge_mode, is_training)
    result = check_op_cap("get_op_specific_info", "DynamicRNNV2", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
