...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['x', 'weight1', 'weight2', 'expert_tokens', 'bias1', 'bias2', 'scale', 'offset', 'deq_scale1', 'deq_scale2', 'antiquant_scale1', 'antiquant_scale2', 'antiquant_offset1', 'antiquant_offset2']
    output_names = ['y']
...
def _build_args(x_in__, weight1_in__, weight2_in__, expert_tokens_in__, bias1_in__, bias2_in__, scale_in__, offset_in__, deq_scale1_in__, deq_scale2_in__, antiquant_scale1_in__, antiquant_scale2_in__, antiquant_offset1_in__, antiquant_offset2_in__, y_out_, activation, inner_precise, output_dtype, tokens_index_flag):
    __inputs__ = []
    for arg in [x_in__, weight1_in__, weight2_in__, expert_tokens_in__, bias1_in__, bias2_in__, scale_in__, offset_in__, deq_scale1_in__, deq_scale2_in__, antiquant_scale1_in__, antiquant_scale2_in__, antiquant_offset1_in__, antiquant_offset2_in__]:
        if arg != None:
    ...
    if output_dtype != None:
        attr = {}
        attr["name"] = "output_dtype"
        attr["dtype"] = "int"
        attr["value"] = output_dtype
        __attrs__.append(attr)
    if tokens_index_flag != None:
        attr = {}
        attr["name"] = "tokens_index_flag"
        attr["dtype"] = "bool"
        attr["value"] = tokens_index_flag
        __attrs__.append(attr)
    return __inputs__, __outputs__, __attrs__

@tbe_register.register_operator("FFN", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.KERNEL_NAME)
def ffn(x_in__, weight1_in__, weight2_in__, expert_tokens_in__=None, bias1_in__=None, bias2_in__=None, scale_in__=None, offset_in__=None, deq_scale1_in__=None, deq_scale2_in__=None, antiquant_scale1_in__=None, antiquant_scale2_in__=None, antiquant_offset1_in__=None, antiquant_offset2_in__=None, y_out_=None, activation="", inner_precise=0, output_dtype=-1, tokens_index_flag=False, kernel_name="ffn", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight1_in__, weight2_in__, expert_tokens_in__, bias1_in__, bias2_in__, scale_in__, offset_in__, deq_scale1_in__, deq_scale2_in__, antiquant_scale1_in__, antiquant_scale2_in__, antiquant_offset1_in__, antiquant_offset2_in__, y_out_, activation, inner_precise, output_dtype, tokens_index_flag)
    ...
    origin_func_name = "ffn"
    ascendc_src_dir_ex = "ffn"
    ascendc_src_dir = "f_f_n"
    ascendc_src_file = "ffn.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator FFN, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "FFN"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[x_in__, weight1_in__, weight2_in__, expert_tokens_in__, bias1_in__, bias2_in__, scale_in__, offset_in__, deq_scale1_in__, deq_scale2_in__, antiquant_scale1_in__, antiquant_scale2_in__, antiquant_offset1_in__, antiquant_offset2_in__], origin_outputs = [y_out_],\
                param_type_dynamic = False, mc2_ctx = [], param_type_list = ['required', 'required', 'required', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required'], init_value_list = [None],\
                output_shape_depend_on_compute = [])
    compile_op(src, origin_func_name, op_info, options, code_channel, '{}')

def op_select_format(x_in__, weight1_in__, weight2_in__, expert_tokens_in__=None, bias1_in__=None, bias2_in__=None, scale_in__=None, offset_in__=None, deq_scale1_in__=None, deq_scale2_in__=None, antiquant_scale1_in__=None, antiquant_scale2_in__=None, antiquant_offset1_in__=None, antiquant_offset2_in__=None, y_out_=None, activation="", inner_precise=0, output_dtype=-1, tokens_index_flag=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight1_in__, weight2_in__, expert_tokens_in__, bias1_in__, bias2_in__, scale_in__, offset_in__, deq_scale1_in__, deq_scale2_in__, antiquant_scale1_in__, antiquant_scale2_in__, antiquant_offset1_in__, antiquant_offset2_in__, y_out_, activation, inner_precise, output_dtype, tokens_index_flag)
    result = check_op_cap("op_select_format", "FFN", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, weight1_in__, weight2_in__, expert_tokens_in__=None, bias1_in__=None, bias2_in__=None, scale_in__=None, offset_in__=None, deq_scale1_in__=None, deq_scale2_in__=None, antiquant_scale1_in__=None, antiquant_scale2_in__=None, antiquant_offset1_in__=None, antiquant_offset2_in__=None, y_out_=None, activation="", inner_precise=0, output_dtype=-1, tokens_index_flag=False, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, weight1_in__, weight2_in__, expert_tokens_in__, bias1_in__, bias2_in__, scale_in__, offset_in__, deq_scale1_in__, deq_scale2_in__, antiquant_scale1_in__, antiquant_scale2_in__, antiquant_offset1_in__, antiquant_offset2_in__, y_out_, activation, inner_precise, output_dtype, tokens_index_flag)
    result = check_op_cap("get_op_specific_info", "FFN", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
