...
@register_operator_compute("apply_adam_d", op_mode="static", support_fusion=True)
...
def apply_adam_d(var, m, v, beta1_power, beta2_power, lr, beta1, beta2, epsilon,
    ...
    shape_m = m.get("shape")
    shape_v = v.get("shape")
    shape_beta1_power = beta1_power.get("shape")
    shape_beta2_power = beta2_power.get("shape")
    shape_lr = lr.get("shape")
    shape_beta1 = beta1.get("shape")
    shape_beta2 = beta2.get("shape")
    shape_epsilon = epsilon.get("shape")
    shape_grad = grad.get("shape")

    para_check.check_shape(shape_var, param_name="var")
    para_check.check_shape(shape_m, param_name="m")
    para_check.check_shape(shape_v, param_name="v")
    para_check.check_shape(shape_beta1_power, param_name="beta1_power")
    para_check.check_shape(shape_beta2_power, param_name="beta2_power")
    para_check.check_shape(shape_lr, param_name="lr")
    para_check.check_shape(shape_beta1, param_name="beta1")
    para_check.check_shape(shape_beta2, param_name="beta2")
    para_check.check_shape(shape_epsilon, param_name="epsilon")
