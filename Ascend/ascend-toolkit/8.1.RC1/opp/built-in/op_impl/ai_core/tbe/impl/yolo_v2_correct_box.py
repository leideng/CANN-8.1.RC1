...
class CorrectBoxComputer(CommonInstruct):
    ...
    def get_new_h_w(self, img_info, param):
        """
          ...
          """
        tmp_scalar_0 = self.instance.Scalar(self.dtype)
        tmp_scalar_1 = self.instance.Scalar(self.dtype)
        tmp_scalar_2 = self.instance.Scalar(self.dtype)
        tmp_scalar_3 = self.instance.Scalar(self.dtype)
        tmp_scalar_4 = self.instance.Scalar(self.dtype)
        tmp_scalar_5 = self.instance.Scalar(self.dtype)
        tmp_scalar_6 = self.instance.Scalar(self.dtype)
        tmp_scalar_7 = self.instance.Scalar(self.dtype)
        new_h = self.instance.Scalar(self.dtype)
        new_w = self.instance.Scalar(self.dtype)
        # if netw/w < neth/h
        # vdup neth/h
        tmp_scalar_0.set_as(img_info[0])
        self.t_vector_dup(param['ub_d'], tmp_scalar_0)
        tmp_scalar_1.set_as(img_info[2])
        self.t_vector_dup(param['ub_g'], tmp_scalar_1)

        self.newton_div(param['ub_d'], param['ub_d'], param['ub_g'], REPEAT_ONE)

        # vdup netw/w
        tmp_scalar_2.set_as(img_info[1])
        self.t_vector_dup(param['ub_e'], tmp_scalar_2)
        tmp_scalar_3.set_as(img_info[3])
        self.t_vector_dup(param['ub_g'], tmp_scalar_3)
        ...
        # get new w
        tmp_scalar_4.set_as(img_info[1])
        param['lgt_tensor'][0].set_as(tmp_scalar_4)
        tmp_scalar_5.set_as(img_info[3])
        self.t_vmuls(param['ub_d'], param['ub_d'], tmp_scalar_5, REPEAT_ONE)
        ...
        # get new h
        tmp_scalar_6.set_as(img_info[2])
        self.t_vmuls(param['ub_e'], param['ub_e'], tmp_scalar_6, REPEAT_ONE)

        tmp_scalar_7.set_as(img_info[0])
        param['lgt_tensor'][0].set_as(tmp_scalar_7)
    ...
    def get_x_y_params(self, img_info):
        ...
        with self.instance.new_stmt_scope():
            ...
            tmp_scalar_8 = self.instance.Scalar(self.dtype)
            tmp_scalar_9 = self.instance.Scalar(self.dtype)

            # x vmuls param --> netw / new_w
            tmp_scalar_8.set_as(img_info[1])
            # ub_d netw
            self.t_vector_dup(param.get('ub_d'), tmp_scalar_8, REPEAT_ONE)
            ...
            self.t_vadds(param.get('ub_d'), param.get('ub_d'), VALUE_ONE, REPEAT_ONE)
            self.t_vmuls(param['ub_d'], param['ub_d'], VALUE_HALF, REPEAT_ONE)

            x_vadds_val.set_as(param['ub_d'][0])

            # y vmuls param --> neth / new_h
            tmp_scalar_9.set_as(img_info[0])
            # ub_d neth
            self.t_vector_dup(param.get('ub_d'), tmp_scalar_9, REPEAT_ONE)
