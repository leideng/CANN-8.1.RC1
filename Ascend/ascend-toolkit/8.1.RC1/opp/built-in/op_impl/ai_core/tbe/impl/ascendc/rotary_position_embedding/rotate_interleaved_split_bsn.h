...
template <typename T>
__aicore__ inline void InterleavedSplitBSN<T>::Compute(uint32_t batchIdx, uint32_t seqIdx,
...
template <typename T>
__aicore__ inline void InterleavedSplitBSN<T>::ComputeCastFp32(uint32_t batchIdx, uint32_t seqIdx,
