...
template <typename T1, typename T2>
__aicore__ inline void GroupNormSwishNormB32<T1, T2>::Init(GM_ADDR x, GM_ADDR gamma, GM_ADDR beta, GM_ADDR y, GM_ADDR mean,
                                                      ...
                                                      TPipe* pipeIn)
{
    ...
    GroupNormSwishBase<T1, T2>::InitLocalB32(this->tiling->shapeCAlign, this->tiling->groupPerCoreAlign, this->tiling->loopTimesAlign * 2);
}
