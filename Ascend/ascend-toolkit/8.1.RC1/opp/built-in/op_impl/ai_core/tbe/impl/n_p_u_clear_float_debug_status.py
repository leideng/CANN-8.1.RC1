...
# ============================================================================
"""
n_p_u_clear_float_debug_status
"""
...
def n_p_u_clear_float_debug_status(kernel_name="n_p_u_clear_float_debug_status"):
    """
    the main function of npu_clear_float_debug_status

    Parameters
    ----------
    kernel_name: cce kernel name, default value is "n_p_u_clear_float_debug_status"
    ...
    mask_tensor[0].set_as(0xfffffffd)
    for i in range(1, 8):
        mask_tensor[i].set_as(0xffffffff)
