...
/* !
 * \file mat_mul_asw_kernel_stress_detect.h
 * \brief
 */
#ifndef MM_STRESS_DETECT_ASW_KERNEL_H
#define MM_STRESS_DETECT_ASW_KERNEL_H

#include "mat_mul_asw_block_stress_detect.h"
...
#endif // MM_STRESS_DETECT_ASW_KERNEL_H