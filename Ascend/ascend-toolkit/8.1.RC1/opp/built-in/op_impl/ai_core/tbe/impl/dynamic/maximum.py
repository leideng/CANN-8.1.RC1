...
@register_operator_compute("Maximum", op_mode="dynamic", support_fusion=True, support_bfp16=True)
...
def maximum(x1, x2, y, kernel_name="maximum"):
    ...
    ----------
    x1 : dict
        first input dict, only support bfloat16, float16, float32, int32, int64
    x2 : dict
        second input dict, only support bfloat16, float16, float32, int32, int64
    y: dict
