...
class SplitWith5HD:
    ...
    def init_gm_tensor(self):
        ...
        self.gm_in = self.tik_instance.Tensor(
            ...
            scope=tbe_platform.scope_gm, name="data_gm_in")
    ...
    def do_5hd_split_scedule(self, input_offset, output_offset,
        ...
        ub_half_size = \
            int(CceProductParams().getParams("Unified_Buffer")
                // 2 // 2 - 16) * 2
        ...
        input_ub_ping = \
            self.tik_instance.Tensor("float16", (input_size*inner_sigment,),
                                     tbe_platform.scope_ubuf, "input_ub_ping")
        input_ub_pang = \
            self.tik_instance.Tensor("float16", (input_size*inner_sigment,),
                                     tbe_platform.scope_ubuf, "input_ub_pang")
        vnchw_ub_0 = \
            self.tik_instance.Tensor("float16",
                                     (input_size*inner_sigment,),
                                     tbe_platform.scope_ubuf, "vnchw_ub_0")
