...
@register_operator_compute("reduce_any_d", op_mode="static", support_fusion=True)
...
def reduce_any_d(x, y, axes, keep_dims=None, kernel_name="reduce_any_d"):
    """
    ...
    res = reduce_any_d_compute(data_input, y, axes, keep_dims, kernel_name)
