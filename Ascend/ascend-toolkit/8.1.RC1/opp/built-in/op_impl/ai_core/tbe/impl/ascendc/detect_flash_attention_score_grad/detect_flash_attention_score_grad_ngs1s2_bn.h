...
/*!
 * \file detect_flash_attention_score_grad_ngs1s2_bn.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_GRAD_NGS1S2_BN_H_
#define DETECT_FLASH_ATTENTION_SCORE_GRAD_NGS1S2_BN_H_
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *dx, __gm__ uint8_t *query,
                                ...
                                const DetectFlashAttentionScoreGradTilingDataUngs1s2Bbn *__restrict ordTilingData,
                                TPipe *pipe_in);
...
protected:
    ...
    const DetectFlashAttentionScoreGradTilingDataUngs1s2Bbn *__restrict ordTilingData_;
...
__aicore__ inline void FlashAttentionScoreGradUngs1s2Bbn<
    ...
    const DetectFlashAttentionScoreGradTilingDataUngs1s2Bbn *__restrict ordTilingData, TPipe *pipe_in)
{
...
#endif // DETECT_FLASH_ATTENTION_SCORE_GRAD_NGS1S2_BN_H_
