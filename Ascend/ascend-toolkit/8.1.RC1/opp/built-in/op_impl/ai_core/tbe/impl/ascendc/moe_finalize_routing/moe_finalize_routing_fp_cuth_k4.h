    ...
    bool isPadH, int64_t rightPaddingH)
{
    ...
    DataCopyPad(expandedPermutedTmpUbDb2, gmExpandedPermutedRows_[expandedPermutedRowsIndexDb2 * H_ + bias],
                copyParams, padParams);
    DataCopyPad(expandedPermutedTmpUbDb3, gmExpandedPermutedRows_[expandedPermutedRowsIndexDb3 * H_ + bias],
                copyParams, padParams);
