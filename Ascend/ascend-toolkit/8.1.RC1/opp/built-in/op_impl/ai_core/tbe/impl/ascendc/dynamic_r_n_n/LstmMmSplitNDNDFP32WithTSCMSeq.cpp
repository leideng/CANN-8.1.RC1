...
/*!
 * \file LstmMmSplitNDNDFP32WithTSCMSeq.cpp
 * \brief
 */
#include "LstmMmSplitNDNDFP32WithTSCMSeq.h"

using namespace AscendC;

template <typename T>
__aicore__ inline int64_t LstmMmSplitNDNDFP32WithTSCMSeq<T>::Ceil(int64_t x, int64_t y) {
  if (y == 0) {
    return 1;
  }
  return (x + y - 1) / y;
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::Init(GM_ADDR inputX, GM_ADDR weight, GM_ADDR bias,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::InitQue() {
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::GetCoreIndex(TCubeTiling& param, int32_t& subKIndx,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CalcGMOffset(TCubeTiling& param, TRnnOffsets& offset,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::InitBuffers(
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::InitVars() {
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::ProcessInputMM() {
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::ProcessHiddenMM(int64_t tIdx) {
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CopyGate(LocalTensor<T>& ub, GlobalTensor<T>& gm,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CopyWithSigmoid(LocalTensor<T>& dstUb, GlobalTensor<T>& mixGm,
                                                                          int64_t mIdx, int64_t gateOffset) {
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CopyWithTanh(LocalTensor<T>& dstUb, GlobalTensor<T>& mixGm,
                                                                       int64_t mIdx, int64_t gateOffset) {
  LocalTensor<T> ubLocalIn = qidVecIn.AllocTensor<T>();
  CopyGate(ubLocalIn, mixGm, mIdx, gateOffset);
  ubLocalIn = qidVecIn.DeQue<T>();
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CopyWithMul(LocalTensor<T>& dstUb, LocalTensor<T>& other,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CopyOutput(GlobalTensor<T>& gm, LocalTensor<T>& ub,
                                                                     int64_t tIdx, int64_t mIdx) {
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CalOutYWithSeq(LocalTensor<float>& ubLocal,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CalOutHWithSeq(LocalTensor<float>& yLocal,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CalcNormalOutCWithSeq(LocalTensor<float>& cLocal,
                                                                                LocalTensor<float>& cPrevLocal,
                                                                                LocalTensor<float>& seqLocal,
                                                                                int64_t size) {
  pipe_barrier(PIPE_V);
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CopyInLastHC(LocalTensor<float>& dstUb,
                                                                       GlobalTensor<T>& outGlobal, int64_t mIdx) {
  LocalTensor<T> ubLocalIn = qidVecIn.AllocTensor<T>();
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::CopyInSeqLength(LocalTensor<float>& dstUb, int64_t mIdx,
                                                                          int64_t tIdx) {
  int64_t offset;
  if (tiling->direction == 1) {
    offset = (tiling->timeStep - 1 - tIdx) * tiling->batch * tiling->hiddenSize +
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::ProcessVectorOnce(int64_t tIdx, int64_t mIdx,
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::ProcessVector(int64_t tIdx) {
...
template <typename T>
__aicore__ inline void LstmMmSplitNDNDFP32WithTSCMSeq<T>::Process() {
  ProcessInputMM();
