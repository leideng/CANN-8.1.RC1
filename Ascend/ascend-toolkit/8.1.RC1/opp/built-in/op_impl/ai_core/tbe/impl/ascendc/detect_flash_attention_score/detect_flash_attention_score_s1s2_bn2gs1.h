...
/*!
 * \file detect_flash_attention_score_s1s2_bn2gs1.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_S1S2_BN2GS1_H
#define DETECT_FLASH_ATTENTION_SCORE_S1S2_BN2GS1_H

#include "detect_flash_attention_util.h"
#include "detect_flash_attention_dropmask.h"
#include "detect_flash_attention_score_common.h"
#include "kernel_operator.h"
#include "kernel_tiling/kernel_tiling.h"
#include "lib/matmul_intf.h"
#include "detect_flash_attention_pse.h"
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *pse,
                                ...
                                const DetectFlashAttentionScoreGeneralTilingData *__restrict tiling, TPipe *tPipe);
...
protected:
    ...
    __aicore__ inline void SetTiling(const DetectFlashAttentionScoreGeneralTilingData *__restrict tilingData);
    ...
    int32_t blockIdx;
    const DetectFlashAttentionScoreGeneralTilingData *__restrict tilingData;
...
FlashAttentionScoreS1s2Bn2gs1<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock, bmm1Format,
                              enableL1Reuse>::Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                                   ...
                                                   __gm__ uint8_t *softmaxSum, __gm__ uint8_t *softmaxOut,
                                                   __gm__ uint8_t *attentionOut, __gm__ uint8_t *workspace,
                                                   const DetectFlashAttentionScoreGeneralTilingData *__restrict tiling,
                                                   TPipe *tPipe)
{
...
__aicore__ inline void
FlashAttentionScoreS1s2Bn2gs1<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock, bmm1Format,
                              enableL1Reuse>::SetTiling(const DetectFlashAttentionScoreGeneralTilingData
...
#endif // DETECT_FLASH_ATTENTION_SCORE_S1S2_BN2GS1_H
