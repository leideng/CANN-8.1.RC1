...
/*!
 * \file reshape_and_cache_nd_siso.cpp
 * \brief
 */
#include "reshape_and_cache_nd_siso.h"
using namespace ReshapeAndCache;

extern "C" __global__ __aicore__ void reshape_and_cache_nd_siso(
    GM_ADDR keyIn, GM_ADDR keyCacheIn, GM_ADDR slotMapping, GM_ADDR keyCacheOut, GM_ADDR workspace, GM_ADDR tiling)
{
    AscendC::TPipe pipe;
