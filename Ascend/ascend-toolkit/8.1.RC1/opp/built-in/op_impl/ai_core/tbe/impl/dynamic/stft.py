...
def _build_args(x_in__, plan_in__, window_in__, y_out_, hop_length, win_length, normalized, onesided, return_complex, n_fft):
    __inputs__ = []
    for arg in [x_in__, plan_in__, window_in__]:
        if arg != None:
    ...
    if hop_length != None:
        attr = {}
        attr["name"] = "hop_length"
        attr["dtype"] = "int"
        attr["value"] = hop_length
        __attrs__.append(attr)
    if win_length != None:
        attr = {}
        attr["name"] = "win_length"
        attr["dtype"] = "int"
        attr["value"] = win_length
        __attrs__.append(attr)
    if normalized != None:
        attr = {}
    ...
    if onesided != None:
        ...
        attr["value"] = onesided
        __attrs__.append(attr)
    if return_complex != None:
        attr = {}
        attr["name"] = "return_complex"
        attr["dtype"] = "bool"
        attr["value"] = return_complex
        __attrs__.append(attr)
    if n_fft != None:
        attr = {}
        attr["name"] = "n_fft"
...
@tbe_register.register_operator("STFT", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.REQUIRED_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_BOOL, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def stft(x_in__, plan_in__, window_in__=None, y_out_=None, hop_length=0, win_length=0, normalized=False, onesided=True, return_complex=True, n_fft=0, kernel_name="stft", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, plan_in__, window_in__, y_out_, hop_length, win_length, normalized, onesided, return_complex, n_fft)
    ...
    origin_func_name = "stft"
    ascendc_src_dir_ex = "stft"
    ascendc_src_dir = "s_t_f_t"
    ascendc_src_file = "stft.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator STFT, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    op_type = "STFT"
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[x_in__, plan_in__, window_in__], origin_outputs = [y_out_],\
...
def check_supported(x_in__, plan_in__, window_in__=None, y_out_=None, hop_length=0, win_length=0, normalized=False, onesided=True, return_complex=True, n_fft=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, plan_in__, window_in__, y_out_, hop_length, win_length, normalized, onesided, return_complex, n_fft)
    ret_str = check_op_cap("check_supported", "STFT", __inputs__, __outputs__, __attrs__)
...
def get_op_support_info(x_in__, plan_in__, window_in__=None, y_out_=None, hop_length=0, win_length=0, normalized=False, onesided=True, return_complex=True, n_fft=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, plan_in__, window_in__, y_out_, hop_length, win_length, normalized, onesided, return_complex, n_fft)
    result = check_op_cap("get_op_support_info", "STFT", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def op_select_format(x_in__, plan_in__, window_in__=None, y_out_=None, hop_length=0, win_length=0, normalized=False, onesided=True, return_complex=True, n_fft=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, plan_in__, window_in__, y_out_, hop_length, win_length, normalized, onesided, return_complex, n_fft)
    result = check_op_cap("op_select_format", "STFT", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")

def get_op_specific_info(x_in__, plan_in__, window_in__=None, y_out_=None, hop_length=0, win_length=0, normalized=False, onesided=True, return_complex=True, n_fft=0, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(x_in__, plan_in__, window_in__, y_out_, hop_length, win_length, normalized, onesided, return_complex, n_fft)
    result = check_op_cap("get_op_specific_info", "STFT", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
