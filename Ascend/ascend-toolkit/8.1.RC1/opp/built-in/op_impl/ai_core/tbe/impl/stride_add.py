...
@register_operator_compute("stride_add", op_mode="static", support_fusion=True)
class StrideAdd():
    """
    ...
    def __init__(self, input_dict):
        ...
        available_ub_size = (tbe_platform.get_soc_spec(tbe_platform.UB_SIZE) - RESERVE_SIZE)
    ...
    def split_aicore(self):
        ...
        """
        available_aicore_num = tbe_platform.get_soc_spec(tbe_platform.CORE_NUM)
