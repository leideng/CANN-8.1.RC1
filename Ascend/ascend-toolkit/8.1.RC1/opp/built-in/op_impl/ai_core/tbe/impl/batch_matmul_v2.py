...
def batch_matmul_compute(input_x, input_y, bias=None, offset_w=None, output_z=None, adj_x1=False,
                         adj_x2=False, offset_x=0, kernel_name="matmul"):
    """
...
def batch_matmul_v2(input_x, input_y, bias=None, offset_w=None, output_z=None, adj_x1=False,
                    adj_x2=False, offset_x=0, kernel_name="matmul"):
    """ algorithm: batch_matmul
    calculating  matrix multiplication with bias, C = A*B + bias, support input
    data with fractal format.
