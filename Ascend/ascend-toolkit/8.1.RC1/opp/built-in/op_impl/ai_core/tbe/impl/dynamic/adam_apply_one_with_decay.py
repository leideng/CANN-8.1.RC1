...
@register_operator_compute("AdamApplyOneWithDecay", op_mode="dynamic", support_fusion=True, support_bfp16=True)
def adam_apply_one_with_decay_compute(input0, input1, input2, input3, input4,
                                      const_mul_x, const_mul1_x, const_mul2_x,
                                      const_mul3_x, const_mul4_x, add2_y, output0, output1,
                                      output2, kernel_name="adam_apply_one_with_decay"):
    """
    calculating data
...
def adam_apply_one_with_decay(input0,
    ...
    for _dinputs in ins:
        with tbe.compute():
            ...
            res = adam_apply_one_with_decay_compute(data_inputs[data_dict.get("data_grad")],
                                                    ...
                                                    output0, output1, output2, kernel_name="adam_apply_one_with_decay")
