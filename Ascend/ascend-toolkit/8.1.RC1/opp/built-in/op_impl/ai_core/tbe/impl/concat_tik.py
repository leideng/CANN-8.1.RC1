...
class ConcatSchedule:
    ...
    def __init__(self,
        ...
        self.ele_each_block = int(tbe_platform.get_soc_spec("ubblock_size")) // dtype_bytes_size
    ...
    def gen_vector_mask_scalar(self):
        """
        gen vector mask scalar for vector vadd
    ...
    def concat_last_dim_vector_branch(self):
        ...
        if not int(tbe_platform.get_soc_spec("ubblock_size")) == 16:
