...
def get_dtype_fmt_options(__inputs__, __outputs__):
    options = []
    input_names = ['query', 'key', 'value', 'pse_shift', 'atten_mask', 'actual_seq_lengths', 'dequant_scale1', 'quant_scale1', 'dequant_scale2', 'quant_scale2', 'quant_offset2', 'antiquant_scale', 'antiquant_offset', 'block_table', 'kv_padding_size']
...
def _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, kv_padding_size_in__, attention_out_out_, num_heads, scale_value, input_layout, num_key_value_heads, block_size, inner_precise):
    __inputs__ = []
    for arg in [query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, kv_padding_size_in__]:
        if arg != None:
...
@tbe_register.register_operator("IncreFlashAttention", trans_bool_to_s8=False)
@para_check.check_op_params(para_check.REQUIRED_INPUT, para_check.DYNAMIC_INPUT, para_check.DYNAMIC_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.OPTION_INPUT, para_check.REQUIRED_OUTPUT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_FLOAT, para_check.OPTION_ATTR_STR, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.OPTION_ATTR_INT, para_check.KERNEL_NAME)
def incre_flash_attention(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, dequant_scale1_in__=None, quant_scale1_in__=None, dequant_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, block_table_in__=None, kv_padding_size_in__=None, attention_out_out_=None, num_heads=0, scale_value=1, input_layout="BSH", num_key_value_heads=0, block_size=0, inner_precise=1, kernel_name="incre_flash_attention", impl_mode=""):
    # do ascendc build step
    if get_current_build_config("enable_op_prebuild"):
        return
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, kv_padding_size_in__, attention_out_out_, num_heads, scale_value, input_layout, num_key_value_heads, block_size, inner_precise)
    ...
    origin_func_name = "incre_flash_attention"
    ascendc_src_dir_ex = "incre_flash_attention"
    ascendc_src_dir = "incre_flash_attention"
    ascendc_src_file = "incre_flash_attention.cpp"
    src = get_kernel_source(ascendc_src_file, ascendc_src_dir, ascendc_src_dir_ex)

    msg = "start compile Acend C Operator IncreFlashAttention, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
    ...
    op_info = OpInfo(kernel_name = kernel_name, op_type = op_type, inputs = __inputs__, outputs = __outputs__,\
        attrs = __attrs__, impl_mode = impl_mode, origin_inputs=[query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, kv_padding_size_in__], origin_outputs = [attention_out_out_],\
                param_type_dynamic = True, mc2_ctx = [], param_type_list = ['required', 'dynamic', 'dynamic', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'optional', 'required'], init_value_list = [None],\
...
def op_select_format(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, dequant_scale1_in__=None, quant_scale1_in__=None, dequant_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, block_table_in__=None, kv_padding_size_in__=None, attention_out_out_=None, num_heads=0, scale_value=1, input_layout="BSH", num_key_value_heads=0, block_size=0, inner_precise=1, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, kv_padding_size_in__, attention_out_out_, num_heads, scale_value, input_layout, num_key_value_heads, block_size, inner_precise)
    result = check_op_cap("op_select_format", "IncreFlashAttention", __inputs__, __outputs__, __attrs__)
...
def get_op_specific_info(query_in__, key_in__, value_in__, pse_shift_in__=None, atten_mask_in__=None, actual_seq_lengths_in__=None, dequant_scale1_in__=None, quant_scale1_in__=None, dequant_scale2_in__=None, quant_scale2_in__=None, quant_offset2_in__=None, antiquant_scale_in__=None, antiquant_offset_in__=None, block_table_in__=None, kv_padding_size_in__=None, attention_out_out_=None, num_heads=0, scale_value=1, input_layout="BSH", num_key_value_heads=0, block_size=0, inner_precise=1, impl_mode=""):
    __inputs__, __outputs__, __attrs__ = _build_args(query_in__, key_in__, value_in__, pse_shift_in__, atten_mask_in__, actual_seq_lengths_in__, dequant_scale1_in__, quant_scale1_in__, dequant_scale2_in__, quant_scale2_in__, quant_offset2_in__, antiquant_scale_in__, antiquant_offset_in__, block_table_in__, kv_padding_size_in__, attention_out_out_, num_heads, scale_value, input_layout, num_key_value_heads, block_size, inner_precise)
    result = check_op_cap("get_op_specific_info", "IncreFlashAttention", __inputs__, __outputs__, __attrs__)
    return result.decode("utf-8")
