...
class PsroiClass():
    ...
    def __init__(self, x_dict, rois_dict, y_dict, params, kernel_name):
        ...
        if self.ub_size <= 0:
            error_manager_vector.raise_err_specific_reson("psroipooling", "The value of the UB_SIZE is illegal!")
        ...
        if self.aicore_num <= 0:
            error_manager_vector.raise_err_specific_reson("psroipooling", "The value of the CORE_NUM is illegal!")
