...
from impl.dynamic.diou_grad import DIoUGrad
...
class CIoUGrad(DIoUGrad):
    ...
    def __init__(self, dy, bboxes, trans, kernel_name):
        ...
        self.atan_sub = self.tik_instance.Tensor(self.dtype, [Constant.MAX_INT32], name="atan_sub", scope=tik.scope_gm)
    ...
    def update_ciou_forward(self, task_idx):
        ...
        self.tik_instance.h_div(self.tmp_b, self.inter, self.unionarea)
