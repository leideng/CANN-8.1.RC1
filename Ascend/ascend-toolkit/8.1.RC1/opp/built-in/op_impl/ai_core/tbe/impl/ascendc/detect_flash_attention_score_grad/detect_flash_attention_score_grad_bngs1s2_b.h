...
/*!
 * \file detect_flash_attention_score_grad_bngs1s2_b.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_GRAD_BNGS1S2_B_H_
#define DETECT_FLASH_ATTENTION_SCORE_GRAD_BNGS1S2_B_H_
...
public:
    ...
    __aicore__ inline void Init(__gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *dx, __gm__ uint8_t *query,
                                ...
                                const DetectFlashAttentionScoreGradUbngs1s2BbTilingData *__restrict ordTilingData,
                                TPipe *pipe_in);
...
protected:
    ...
    const DetectFlashAttentionScoreGradUbngs1s2BbTilingData *__restrict ordTilingData_;
...
__aicore__ inline void
    ...
    const DetectFlashAttentionScoreGradUbngs1s2BbTilingData *__restrict ordTilingData, TPipe *pipe_in)
{
...
#endif // DETECT_FLASH_ATTENTION_SCORE_GRAD_BNGS1S2_B_H_
