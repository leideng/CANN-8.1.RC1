...
public:
    __aicore__ inline MoeFinalizeRoutingV2Bf16CuthK2(
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline int64_t MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::AlignmentProcess(int64_t param)
{
    return (param + onceAlgnNum_ - 1) / onceAlgnNum_ * onceAlgnNum_;
}

template <typename T, const bool ISBIASEXIST>
__aicore__ inline int64_t MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::PadProcessT(int64_t param)
{
    return  onceAlgnNum_ - param % onceAlgnNum_;
}

template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::CkechColAlignment()
{
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::Init(GM_ADDR expandedPermutedRows, 
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::CopyIn(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
    bool isPadH, int64_t rightPaddingH)
{
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::Compute(int64_t nLoopIdx, int64_t bias, int64_t dataLen,
    bool isPadH, int64_t rightPaddingH)
{
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::CopyOut(int64_t nLoopIdx, int64_t bias, int64_t dataLen)
{
...
template <typename T, const bool ISBIASEXIST>
__aicore__ inline void MoeFinalizeRoutingV2Bf16CuthK2<T, ISBIASEXIST>::Process()
{
