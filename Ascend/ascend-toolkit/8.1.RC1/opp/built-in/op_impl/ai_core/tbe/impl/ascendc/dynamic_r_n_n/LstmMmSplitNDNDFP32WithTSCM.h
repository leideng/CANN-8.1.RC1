...
/*!
 * \file LstmMmSplitNDNDFP32WithTSCM.h
 * \brief
 */
#ifndef _ASCENDC_LSTMMMSPLITNDNDFP32WITHTSCM_H_
#define _ASCENDC_LSTMMMSPLITNDNDFP32WITHTSCM_H_

#include "dynamic_rnn_common.h"

template <typename T>
class LstmMmSplitNDNDFP32WithTSCM {
 public:
  __aicore__ inline LstmMmSplitNDNDFP32WithTSCM() = default;
