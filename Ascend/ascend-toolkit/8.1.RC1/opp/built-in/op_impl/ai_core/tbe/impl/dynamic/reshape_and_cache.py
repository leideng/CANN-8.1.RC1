...
def reshape_and_cache(keyIn_in__, valueIn_in__, keyCacheIn_in__, valueCacheIn_in__, slotMapping_in__, keyCacheOut_out_, valueCacheOut_out_, kernel_name="reshape_and_cache", impl_mode=""):
    ...
    msg = "start compile Acend C Operator ReshapeAndCache, kernel name is " + kernel_name
    CommonUtility.print_compile_log("", msg, AscendCLogLevel.LOG_INFO)
