...
/*!
 * \file detect_flash_attention_var_len_score.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_VAR_LEN_SCORE_H
#define DETECT_FLASH_ATTENTION_VAR_LEN_SCORE_H
...
public:
    ...
    UnpackInit(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value, __gm__ uint8_t *pse,
               ...
               __gm__ uint8_t *workspace, const DetectFlashAttentionScoreGeneralTilingData *__restrict tiling, TPipe *tPipe);
...
#endif // DETECT_FLASH_ATTENTION_VAR_LEN_SCORE_H
