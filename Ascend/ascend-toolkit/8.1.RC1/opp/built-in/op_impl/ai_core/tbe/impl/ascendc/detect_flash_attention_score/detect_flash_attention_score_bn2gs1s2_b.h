...
/*!
 * \file detect_flash_attention_score_bn2gs1s2_b.h
 * \brief
 */

#ifndef DETECT_FLASH_ATTENTION_SCORE_BN2GS1S2_B_H
#define DETECT_FLASH_ATTENTION_SCORE_BN2GS1S2_B_H
...
protected:
    ...
    DetectFlashAttentionCopyTransposeTiling dataCopyTiling;
...
FlashAttentionScoreBn2gs1s2B<implMode, layOutType, hasPse, hasAtten, hasDrop, INPUT_T, T, isBasicBlock,
                             layout>::SetTiling(const DetectFlashAttentionScoreGeneralTilingData *__restrict tilingData)
{
    // copy base params
...
#endif // DETECT_FLASH_ATTENTION_SCORE_BN2GS1S2_B_H
