...
/*
 * We use user_fpsimd_state.__reserved[0] as a param saveop to save the op_codes
 * in hivector if define CONFIG_RTOS_HAL_ARM64_HIVECTOR.
 * Therefore, if CONFIG_RTOS_HAL_ARM64_HIVECTOR is defined, do not use __reserved[0]
 * elsewhere, otherwise some problems may occur.
 */
