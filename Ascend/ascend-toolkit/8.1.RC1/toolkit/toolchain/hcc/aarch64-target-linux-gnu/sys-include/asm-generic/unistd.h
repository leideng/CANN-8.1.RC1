...
/* #ifdef CONFIG_RTOS_HAL_FAST_SYSCALL
 * we can't not use #ifdef CONFIG_RTOS_HAL_FAST_SYSCALL here,because userspcace
 * will use __NR_dpefastcall,or this macro can not be found.
 * we add this CONFIG just for the convenience of following upgrade.
 */
#define __NR_dpefastcall 999
/* #endif */

/*
 *#ifdef CONFIG_RTOS_ISOLATION_VM
 * we can't not use #ifdef CONFIG_RTOS_ISOLATION_VM here, because userspcace
 * will use __NR_isovm_xxx, or this macro can not be found.
 * we add this CONFIG just for the convenience of following upgrade.
 */
#define __NR_isovm_open  1000
#define __NR_isovm_close 1001
#define __NR_isovm_state 1002
/* #endif */

/* #ifdef CONFIG_RTOS_HAL_FAST_SVC
 * we can't not use #ifdef CONFIG_RTOS_HAL_FAST_SVC here, because userspcace
 * will use FAST_SVC_NO, or this macro can not be found.
 * we add this CONFIG just for the convenience of following upgrade.
 */
#define RTOS_FAST_SVC_NO 254
#define FAST_SVC_NO 255
/* #endif */
