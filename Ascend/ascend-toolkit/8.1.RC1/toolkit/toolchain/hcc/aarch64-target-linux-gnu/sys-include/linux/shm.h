 ...
 * will use SHM_RTOS_ISOLATION_VM, or this macro can not be found.
 * we add this CONFIG just for the convenience of following upgrade.
 */
#define RTOS_SHM_ISOLATION_VM	0x200000 /* virtual memory domain isolation */
/* CONFIG_RTOS_ISOLATION_VM end */
