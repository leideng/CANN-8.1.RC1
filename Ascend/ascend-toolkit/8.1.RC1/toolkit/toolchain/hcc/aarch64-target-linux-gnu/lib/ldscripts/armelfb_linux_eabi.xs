...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/usr1/Tuscany/asl/devtools/hcc/build/hcc_arm64le/../../../../../out/hcc_compile/arm64le_build_dir/hcc_arm64le/aarch64-target-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
