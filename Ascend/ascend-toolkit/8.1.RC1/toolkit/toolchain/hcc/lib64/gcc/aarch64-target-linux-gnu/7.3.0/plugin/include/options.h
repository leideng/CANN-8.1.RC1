...
#endif
#ifdef GENERATOR_FILE
extern int flag_float_load_perfect;
#else
  int x_flag_float_load_perfect;
#define flag_float_load_perfect global_options.x_flag_float_load_perfect
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_optimization
{
  ...
  signed char x_flag_float_load_perfect;
...
enum opt_code
{
  ...
  OPT_mfloat_load_perfect = 1158,            /* -mfloat-load-perfect */
  ...
  OPT_time = 1271,                           /* -time */
  OPT_time_ = 1272,                          /* -time= */
  OPT_traditional = 1273,                    /* -traditional */
  OPT_traditional_cpp = 1274,                /* -traditional-cpp */
  OPT_trigraphs = 1275,                      /* -trigraphs */
  OPT_u = 1276,                              /* -u */
  OPT_undef = 1277,                          /* -undef */
  OPT_v = 1278,                              /* -v */
  OPT_version = 1279,                        /* -version */
  OPT_w = 1280,                              /* -w */
  OPT_wrapper = 1281,                        /* -wrapper */
  OPT_x = 1282,                              /* -x */
  OPT_z = 1283,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
