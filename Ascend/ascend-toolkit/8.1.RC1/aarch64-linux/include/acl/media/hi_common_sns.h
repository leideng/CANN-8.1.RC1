 ...
 * Description: Head of sensor
 * Author: Hisilicon multimedia software group
 * Create: 2023-01-05
 */

#ifndef HI_COMMON_SNS_H
#define HI_COMMON_SNS_H
...
#define HI_ISP_WDR_MAX_FRAME          2
#define HI_ISP_BAYER_CALIBRATION_PARA_NUM 3

#define HI_ISP_GAMMA_NODE_NUMBER      257   /* Update NODE NUMBER */
#define HI_ISP_GAMMA_EXT_NODE_NUMBER  1025  /* Update NODE NUMBER */
#define HI_ISP_GAMMA_OUTSEG_NUMBER    8     /* Update NODE NUMBER */
...
typedef struct {
    hi_u8  luma_wgt[HI_ISP_SHARPEN_LUMA_NUM];       /*  Range: [0, 127] */
    hi_u16 texture_strength[HI_ISP_SHARPEN_GAIN_NUM];    /*  Range: [0, 4095]; Format:7.5 */
    hi_u16 edge_strength[HI_ISP_SHARPEN_GAIN_NUM];       /*  Range: [0, 4095]; Format:7.5 */
    ...
    hi_u8  shoot_sup_strength;         /*  Range: [0, 255] */
...
typedef struct {
    hi_u8  luma_wgt[HI_ISP_SHARPEN_LUMA_NUM][HI_ISP_AUTO_ISO_NUM];     /*  Range: [0, 127] */
    hi_u16 texture_strength[HI_ISP_SHARPEN_GAIN_NUM][HI_ISP_AUTO_ISO_NUM];  /*  Range: [0, 4095]; Format:7.5 */
    hi_u16 edge_strength[HI_ISP_SHARPEN_GAIN_NUM][HI_ISP_AUTO_ISO_NUM];     /*  Range: [0, 4095]; Format:7.5 */
    hi_u16 texture_freq[HI_ISP_AUTO_ISO_NUM];         /*  Range: [0, 4095]; Format:6.6 */
    hi_u16 edge_freq[HI_ISP_AUTO_ISO_NUM];            /*  Range: [0, 4095]; Format:6.6 */
    hi_u8  over_shoot[HI_ISP_AUTO_ISO_NUM];           /*  Range: [0, 127] */
    hi_u8  under_shoot[HI_ISP_AUTO_ISO_NUM];          /*  Range: [0, 127] */
    hi_u8  shoot_sup_strength[HI_ISP_AUTO_ISO_NUM];        /*  Range: [0, 255] */
    hi_u8  shoot_sup_adj[HI_ISP_AUTO_ISO_NUM];        /*  Range: [0, 15] */
    hi_u8  detail_ctrl[HI_ISP_AUTO_ISO_NUM];          /*  Range: [0, 255] */
    hi_u8  detail_ctrl_thr[HI_ISP_AUTO_ISO_NUM];      /*  Range: [0, 255] */
    hi_u8  edge_filt_str[HI_ISP_AUTO_ISO_NUM];        /*  Range: [0, 63] */
    hi_u8  edge_filt_max_cap[HI_ISP_AUTO_ISO_NUM];    /*  Range: [0, 47] */
    hi_u8  r_gain[HI_ISP_AUTO_ISO_NUM];               /*  Range: [0, 31] */
    hi_u8  g_gain[HI_ISP_AUTO_ISO_NUM];               /*  Range: [0, 255] */
    hi_u8  b_gain[HI_ISP_AUTO_ISO_NUM];               /*  Range: [0, 31] */
    hi_u8  skin_gain[HI_ISP_AUTO_ISO_NUM];            /*  Range: [0, 31] */
    hi_u16 max_sharp_gain[HI_ISP_AUTO_ISO_NUM];       /*  Range: [0, 0x7FF]; Format:8.3 */
...
typedef struct {
    ...
    hi_s16    iso_ratio[HI_ISP_AUTO_ISO_NUM];     /* 1.10bit  ISO Ratio  For UV,Max = 2047 FW Limi */
} hi_isp_cmos_ca;
...
typedef struct {
    ...
    hi_u16  threshold[HI_ISP_AUTO_ISO_NUM]; /* RW,Range: [   0, 0x3FFF] */
    hi_u16  strength[HI_ISP_AUTO_ISO_NUM];  /* RW,Range: [   0, 0x100]  */
    hi_u16  np_offset[HI_ISP_AUTO_ISO_NUM];  /* RW,Range: [0x200, 0x3FFF] */
} hi_isp_cmos_ge;
...
typedef struct {
    ...
    /* sensor event notify ,only for resume at present */
