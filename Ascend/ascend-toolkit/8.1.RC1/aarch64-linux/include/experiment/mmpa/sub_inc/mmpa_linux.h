...
#define MM_SYS_GET_ENV(IdName, value)                                           \
    do {                                                                        \
        ...
        {                                                                       \
            ...
            if (strncmp(env_name, "MM_ENV_", sizeof("MM_ENV_") - 1) == 0) {    \
                value = getenv(env_name + sizeof("MM_ENV_") - 1);               \
            }else {                                                             \
                value = NULL;                                                   \
            }                                                                   \
        }                                                                       \
...
#define MM_SYS_SET_ENV(IdName, value, overwrite, ret)                               \
    do {                                                                            \
        ...
        {                                                                           \
            ...
            const char* env_name = #IdName;                                         \
            if (strncmp(env_name, "MM_ENV_", sizeof("MM_ENV_") - 1) == 0) {         \
                ret = setenv(env_name + sizeof("MM_ENV_") - 1, value, overwrite);   \
            }else {                                                                 \
...
#define MM_SYS_UNSET_ENV(IdName, ret)                                           \
    do {                                                                        \
        ...
        {                                                                       \
            ...
            const char* env_name = #IdName;                                     \
            if (strncmp(env_name, "MM_ENV_", sizeof("MM_ENV_") - 1) == 0) {     \
                ret = unsetenv(env_name + sizeof("MM_ENV_") - 1);               \
            }else {                                                             \
                ret = EN_INVALID_PARAM;                                         \
            }                                                                   \
        }                                                                       \
