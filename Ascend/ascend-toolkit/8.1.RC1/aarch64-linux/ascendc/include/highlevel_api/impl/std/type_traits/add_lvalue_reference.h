 ...
 * \brief
 */
#ifndef IMPL_STD_ASCENDC_STD_ADD_LVALUE_REFERENCE_IMPL__H
#define IMPL_STD_ASCENDC_STD_ADD_LVALUE_REFERENCE_IMPL__H
...
#endif // IMPL_STD_ASCENDC_STD_ADD_LVALUE_REFERENCE_IMPL__H
