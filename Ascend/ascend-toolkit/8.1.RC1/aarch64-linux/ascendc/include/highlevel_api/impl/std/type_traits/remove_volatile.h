 ...
 * \brief
 */
#ifndef IMPL_STD_ASCENDC_STD_REMOVE_VOLATILE_IMPL__H
#define IMPL_STD_ASCENDC_STD_REMOVE_VOLATILE_IMPL__H
...
#endif // IMPL_STD_ASCENDC_STD_REMOVE_VOLATILE_IMPL__H
