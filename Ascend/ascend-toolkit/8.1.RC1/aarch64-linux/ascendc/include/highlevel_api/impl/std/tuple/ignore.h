...
struct ignore_t
{
    __aicore__ inline ignore_t() = default;

    template <typename Tp, typename...Ts>
    __aicore__ inline constexpr ignore_t(const Tp&, const Ts&...) noexcept {}

    template <typename Tp>
    __aicore__ inline constexpr const ignore_t& operator=(const Tp&) const noexcept
    {
        return *this;
    }
};
