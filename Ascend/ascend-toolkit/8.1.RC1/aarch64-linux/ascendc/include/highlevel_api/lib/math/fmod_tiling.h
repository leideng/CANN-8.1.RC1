...
#ifndef LIB_MATH_FMOD_TILING_H
#define LIB_MATH_FMOD_TILING_H
...
/*!
 * \brief The calculation of the Fmod interface requires the developer to reserve or apply for temporary space.
 ...
 */
void GetFmodTmpBufferFactorSize(const uint32_t typeSize, uint32_t &maxLiveNodeCnt, uint32_t &extraBuf);
} // namespace AscendC
#endif // LIB_MATH_FMOD_TILING_H