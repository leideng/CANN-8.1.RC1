 ...
 * \brief
 */
#ifndef LIB_MATH_TRUNC_TILING_H
#define LIB_MATH_TRUNC_TILING_H
...
/*!
 * \brief The calculation of the Trunc interface requires the developer to reserve or apply for temporary space.
