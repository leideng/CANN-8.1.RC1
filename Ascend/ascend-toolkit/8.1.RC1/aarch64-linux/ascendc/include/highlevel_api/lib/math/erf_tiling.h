 ...
 * \brief
 */
#ifndef LIB_MATH_ERF_TILING_H
#define LIB_MATH_ERF_TILING_H
#include <cstdint>

#include "graph/tensor.h"
namespace AscendC {
/*!
 * \brief The calculation of the Erf interface requires the developer to reserve or apply for temporary space.
