 ...
 * \brief
 */
#ifndef LIB_MATH_CEIL_TILING_H
#define LIB_MATH_CEIL_TILING_H
...
/*!
 * \brief The calculation of the Ceil interface requires the developer to reserve or apply for temporary space.
