 ...
 * \brief
 */
#ifndef LIB_REDUCE_MEAN_TILING
#define LIB_REDUCE_MEAN_TILING
#include <cstdint>
 ...
 *
 * \param [in] n, actual number of calculations in each row of the input data
 * \param [in] srcTypeSize, size of the input data type, in bytes
 * \param [in] accTypeSize, size of the accType data type, in bytes.
...
/*!
 * \brief The calculation of the Mean interface requires the developer to reserve or apply for temporary space. The
