 ...
 * \brief
 */
#ifndef LIB_MATH_ACOS_TILING_H
#define LIB_MATH_ACOS_TILING_H
#include <cstdint>

#include "graph/tensor.h"
namespace AscendC {
/*!
 * \brief The calculation of the Acos interface requires the developer to reserve or apply for temporary space.
