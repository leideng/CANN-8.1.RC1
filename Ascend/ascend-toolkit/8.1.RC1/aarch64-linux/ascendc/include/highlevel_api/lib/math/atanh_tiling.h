 ...
 */
#ifndef LIB_MATH_ATANH_TILING_H
#define LIB_MATH_ATANH_TILING_H
#include <cstdint>
...
/*!
 * \brief The calculation of the Atanh interface requires the developer to reserve or apply for temporary space. The
