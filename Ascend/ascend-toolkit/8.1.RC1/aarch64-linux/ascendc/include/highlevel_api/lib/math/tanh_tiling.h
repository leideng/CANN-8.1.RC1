 ...
 * \brief
 */
#ifndef LIB_MATH_TANH_TILING_H
#define LIB_MATH_TANH_TILING_H
#include <cstdint>
...
/*!
 * \brief The calculation of the Tanh interface requires the developer to reserve or apply for temporary space. The
