...
/*!
 * \file inner_kernel_operator_vec_brcb_intf.cppm
 * \brief
 */
#ifndef ASCENDC_MODULE_INNER_OPERATOR_VEC_BRCB_INTERFACE_H
#define ASCENDC_MODULE_INNER_OPERATOR_VEC_BRCB_INTERFACE_H
    ...
    const BrcbRepeatParams& repeatParams)
{
    ...
    if (!CheckFunBcB(dstLocal, src0Local, repeatTimes, repeatParams, "Brcb")) {
        ASCENDC_REPORT_CHECK_ERROR("Brcb", KernelFuncType::NONE_MODE);
    }
#endif
    BrcbImpl((__ubuf__ T*)dstLocal.GetPhyAddr(), (__ubuf__ T*)src0Local.GetPhyAddr(), repeatTimes, repeatParams);
}
} // namespace AscendC
#pragma end_pipe
#endif // ASCENDC_MODULE_INNER_OPERATOR_VEC_BRCB_INTERFACE_H