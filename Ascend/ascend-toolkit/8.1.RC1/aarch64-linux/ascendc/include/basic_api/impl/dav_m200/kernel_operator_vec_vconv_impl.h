...
{
    if (roundMode == RoundMode::CAST_NONE) {
        vcbd_s322s16(dst, src, repeat, repeatParams.dstBlkStride, repeatParams.srcBlkStride,
                repeatParams.dstRepStride, repeatParams.srcRepStride, repeatParams.repeatStrideMode,
                repeatParams.strideSizeMode);
    } else {
        ASCENDC_ASSERT(false, {
...
{
    vconv_deqs162b8(dst, src, repeat, repeatParams.dstBlkStride, repeatParams.srcBlkStride,
        repeatParams.dstRepStride, repeatParams.srcRepStride, repeatParams.repeatStrideMode,
...
__aicore__ inline void CastVDeqIntrinsicsImpl(__ubuf__ T* dst, __ubuf__ int16_t* src, uint8_t repeat,
    const UnaryRepeatParams& repeatParams)
{
    vconv_vdeqs162b8(dst, src, repeat, repeatParams.dstBlkStride, repeatParams.srcBlkStride,
        repeatParams.dstRepStride, repeatParams.srcRepStride, repeatParams.repeatStrideMode,
        repeatParams.strideSizeMode, halfBlock);
}
