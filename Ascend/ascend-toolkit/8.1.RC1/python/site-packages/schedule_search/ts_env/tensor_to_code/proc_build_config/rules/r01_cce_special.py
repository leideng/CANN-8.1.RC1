...
from schedule_search.ts_env.cheque_generator import get_ccespec_cheque


def proc(t2c_params):  # pylint: disable=R0914,R0912
    """
    sch.cce_special，对sch.cce_special的操作也放在T2C里面做，
    T2C结束生成完整信息的cheque_list
    """
    ...
    # 生成sch.cce_special对应的cheque
    get_ccespec_cheque(t2c_params, workspace_list_str, orign_out_tensor_str,
                       real_out_tensor_str)
    ...
    code_str = cce_special_code.format(
        ...
        real_out_tensor=op_schedule_info.real_out_tensor_str)
