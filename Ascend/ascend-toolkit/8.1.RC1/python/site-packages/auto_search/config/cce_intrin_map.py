...
OP_INTRIN_INFO_LIST = [
    ...
    OpIntrinInfo(46, "broadcast", "vector_broadcast"),
    ...
    OpIntrinInfo(100, "unknown_broadcast", "unknown_broadcast"),
    OpIntrinInfo(102, "unified_broadcast", "vector_broadcast"),
    OpIntrinInfo(103, "elewise_binary_cmpsel_le", "vector_select_le"),
    OpIntrinInfo(104, "set_value", "vector_dup"),
    OpIntrinInfo(105, "one_shape_broadcast", "vector_broadcast"),
    OpIntrinInfo(106, "one_rank_broadcast", "unknown_broadcast"),
    OpIntrinInfo(107, "elewise_binary_cmpsel_lt", "vector_select_lt"),
    OpIntrinInfo(108, "pad_window", "dma_copy"),
    OpIntrinInfo(109, "reduce_window_max_nist", "vector_reduce_max", "reduce_window_max"),
]
