...
"""
mask rule: in_ub_size_greater_than_32B
"""
...
@mask_rule_register([ComputePattern.ELEMENTWISE, ComputePattern.BROADCAST, ComputePattern.NORM,
                     ComputePattern.POOLING], SearchActionType.SPLIT)
def mask(progress, action_mask):
    ...
    for i in range(SEARCH_N):
        ...
        if next_factor * ub_right_multi_size < elemt_in_block:
            action_mask[i] = 0

    logger.debug("ub_size_bigger_than_32B action_mask:%s", action_mask)
    return
