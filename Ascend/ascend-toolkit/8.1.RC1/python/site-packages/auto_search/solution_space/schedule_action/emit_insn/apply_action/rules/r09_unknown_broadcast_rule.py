...
def proc(progress: Progress) -> NoReturn:
    ...
    if intrinsic_func_name != 'unknown_broadcast':
        return True
    ...
    attrs = {"dynamic_fuse": False, "dynamic_split": False}
    stage.emit_insn(emit_insn_axis_obj, intrinsic_func_name, attrs=attrs)

    op_schedule_info.code_lines.append(
        "sch[{}].emit_insn({}, 'unknown_broadcast', attrs={})".format(stage_name, emit_insn_axis, str(attrs)))
