...
def rfactor_proc(op_schedule_info,
    ...
    rfactor_codes = f'sch.rfactor({reduce_stage_name}, {rfactor_axis_name}, mode=sch.RfactorModeNormal)'
    ...
    rfactor_tensor = op_schedule_info.schedule_obj.rfactor(reduce_tensors[0],
                                                 rfactor_axis_obj,
                                                 mode=op_schedule_info.schedule_obj.RfactorModeNormal)
...
def do_rfactor(op_schedule_info,
    ...
    rfactor_proc(op_schedule_info, code_lines, reduce_stage_index,
                 reduce_tensors, rfactor_axis_info)
    ...
    # gen rfactor cheque
    cheque = get_rfactor_cheque(reduce_stage_index, rfactor_axis_info[2], -1,
                                rfactor_mode.get(op_schedule_info.schedule_obj.RfactorModeNormal))
