...
@director_register([ComputePattern.NORM, ComputePattern.TRANSPOSE, ComputePattern.BROADCAST],
                   ScheduleActionType.STORAGE_ALIGN)
def direct(progress):
    """
    :param progress:
    :return:
...
@director_register([ComputePattern.TUPLE_REDUCE, ComputePattern.REDUCE], ScheduleActionType.STORAGE_ALIGN)
