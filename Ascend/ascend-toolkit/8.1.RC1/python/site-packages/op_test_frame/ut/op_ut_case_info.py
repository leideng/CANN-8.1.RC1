...
class OpUTBaseCase:
    ...
    def __init__(self, support_soc=None, op_type=None, case_name=None,  # 'pylint: disable=too-many-arguments
                 ...
                 ori_case_name: str = None, support_core: tuple = None):
        ...
        self.ori_case_name = ori_case_name
        self.support_core: Optional[tuple] = support_core
    ...
    def check_support_soc(self, soc_version: str):
        ...
        True or False
        """
        return soc_util.check_support_soc(self.support_soc, soc_version)
    ...
    def to_json_obj(self):
        ...
        return {
            ...
            "ori_case_name": self.ori_case_name,
            "support_core": self.support_core
        }
...
class OpUTCase(OpUTBaseCase):  # 'pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, support_soc=None, op_type=None, case_name=None,  # 'pylint: disable=too-many-arguments
                 ...
                 op_imply_type=None, addition_params=None, ori_case_name: str = None,
                 gen_tiling_ut: bool = False, support_core: tuple = None):
        super().__init__(support_soc=support_soc, op_type=op_type, case_name=case_name, case_usage=case_usage,
                         case_file=case_file, case_line_num=case_line_num, ori_case_name=ori_case_name,
        ...
        self.gen_tiling_ut = gen_tiling_ut
    ...
    def parser_json_obj(json_obj):
        ...
        return OpUTCase(support_soc=json_obj["support_soc"],
                        ...
                        ori_case_name=json_obj.get("ori_case_name"),
                        gen_tiling_ut=json_obj.get("gen_tiling_ut"),
                        support_core=json_obj.get("support_core"))
    ...
    def to_json_obj(self):
        ...
        return {
            ...
            "ori_case_name": self.ori_case_name,
            "gen_tiling_ut": self.gen_tiling_ut
        }
...
class OpUTCustomCase(OpUTBaseCase):
    ...
    def __init__(self, support_soc=None, op_type=None, case_name=None,  # 'pylint: disable=too-many-arguments
                 ...
                 test_func_name=None, test_func=None, support_core: tuple = None):
        super().__init__(support_soc=support_soc, op_type=op_type, case_name=case_name, case_usage=case_usage,
                         case_file=case_file, case_line_num=case_line_num, ori_case_name=test_func_name,
                         support_core=support_core)
...
class AscendcParams:
    def __init__(self, ascendc_op_path, block_dim):
        self.ascendc_op_path = ascendc_op_path
