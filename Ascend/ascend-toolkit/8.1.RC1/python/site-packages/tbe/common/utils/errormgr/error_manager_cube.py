...
def raise_err_param_should_be_equal(param1_name, param2_name, param1_value, param2_value):
    """
    ...
    args_dict = {
        ...
        "param1": param1_name,
        "param2": param2_name,
        "actual_value": "{}, {}".format(param1_value, param2_value)
    }
    msg = get_error_message(args_dict)
    raise_runtime_error_cube(args_dict, msg)


def raise_err_dilation_invalid(param1_value, param2_value):
    """
    ...
    args_dict = {
        "errCode": "E60023",
        "dilation_n": param1_value,
        "dilation_c": param2_value
    }
    msg = get_error_message(args_dict)
    raise_runtime_error_cube(args_dict, msg)


def raise_err_format_not_in_list(param_name, op_name, format_white_list, format):
    '''
...
def raise_err_exceed_l1_buffer(op_name):
    '''
