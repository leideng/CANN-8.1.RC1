...
def get_msg_file_dir() -> str:
    ...
    try:
        LOG_INSTANCE.debug("Get ASCEND_WORK_PATH [%s]." % home_path)
    except (TypeError, ValueError) as e:
        LOG_INSTANCE.error("The ASCEND_WORK_PATH environment variable is invalid.")
        raise RuntimeError({"errCode": "EC0012", "value": home_path, "env": "ASCEND_WORK_PATH"}) from e
    if not home_path:
