...
def mk_tmpdir():
    """Create temp dir while you want do delete it you shoud call rm_tmpdir

    Returns
    -------
    temp_dir_path: the path of tmp dir
        str
    """
    temp_dir = TempDirectory()
    tmp_dir_dict[temp_dir.relpath('')] = temp_dir
    return temp_dir.relpath('')


def rm_tmpdir(dirpath):
    """
    Parameters
    ----------
    dirpath : str
    """
    if dirpath in tmp_dir_dict.keys():
        tmp_dir_dict.pop(dirpath)
