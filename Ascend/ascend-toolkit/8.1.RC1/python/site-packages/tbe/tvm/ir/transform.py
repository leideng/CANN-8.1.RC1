...
class PassContext(tvm.runtime.Object):
    ...
    def override_config(self, config):
        """Override config within this PassContext.

        config : Dict[PassConfig]
            The dict of pass config.
        """
        _ffi_transform_api.OverrideConfig(self, config)
    ...
    @staticmethod
    def get_scope_size():
        return _ffi_transform_api.GetScopeSize()
