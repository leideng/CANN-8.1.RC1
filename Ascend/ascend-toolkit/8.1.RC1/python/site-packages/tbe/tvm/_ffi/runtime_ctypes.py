...
class DataType(ctypes.Structure):
    ...
    CODE2STR = {
        ...
        DataTypeCode.HIFLOAT: "hifloat",
        DataTypeCode.COMPLEX: "complex",
        DataTypeCode.E4M3Float: "float8_e4m3fn",
        DataTypeCode.E5M2Float: "float8_e5m2",
        DataTypeCode.E1M2Float: "float4_e1m2",
        DataTypeCode.E2M1Float: "float4_e2m1",
    }
    NUMPY2STR = {
    ...
    STR2DTYPE = {
        ...
        "uint1": {"type_code": DataTypeCode.UINT, "bits": 1, "lanes": 1},
        ...
        "float8_e4m3fn": {"type_code": DataTypeCode.E4M3Float, "bits": 8, "lanes": 1},
        "float8_e5m2": {"type_code": DataTypeCode.E5M2Float, "bits": 8, "lanes": 1},
        "float4_e1m2": {"type_code": DataTypeCode.E1M2Float, "bits": 4, "lanes": 1},
        "float8_e2m1": {"type_code": DataTypeCode.E2M1Float, "bits": 4, "lanes": 1},
        ...
        "hifloat8": {"type_code": DataTypeCode.HIFLOAT, "bits": 8, "lanes": 1},
        "complex32": {"type_code": DataTypeCode.COMPLEX, "bits": 32, "lanes": 1},
        "complex64": {"type_code": DataTypeCode.COMPLEX, "bits": 64, "lanes": 1},
    }
    ...
    def __init__(self, type_str):
        ...
        if type_str in str_dtype_map:
            ...
            self.storage_bits = dtype_map["bits"]
            if type_str == "bool":
                self.storage_bits = 8
            return
        ...
        if head.startswith("int"):
            ...
            head = head[6:]
        elif head.startswith("hifloat"):
            self.type_code = DataTypeCode.HIFLOAT
            head = head[7:]
        elif head.startswith("complex"):
            self.type_code = DataTypeCode.COMPLEX
            head = head[7:]
        elif head.startswith("float8_e4m3"):
            ...
            self.bits = 8
            return
        elif head.startswith("float4_e1m2"):
            self.type_code = DataTypeCode.E1M2Float
            self.bits = 4
            return
        elif head.startswith("float4_e2m1"):
    ...
    def __repr__(self):
        # pylint: disable=import-outside-toplevel
        if self.bits == 1 and self.lanes == 1 and self.storage_bits == 8:
            return "bool"
        ...
        if (type_name == "float8_e4m3fn" or type_name == "float8_e5m2" or
            type_name == "float4_e1m2" or type_name == "float4_e2m1"):
            x = "%s" % (type_name)
        else:
