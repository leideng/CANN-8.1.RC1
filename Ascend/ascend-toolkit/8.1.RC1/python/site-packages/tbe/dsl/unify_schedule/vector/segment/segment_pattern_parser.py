...
class SegmentPatternParser(PatternParser):
    ...
    def match(self):
        ...
        segment_size = self.compute_type_size_map.get(ComputeType.SEGMENT, 0)
        total = self.compute_type_size_map.get(ComputeType.ANY, 0)
        result = ph_size + segment_size == total and segment_size == 1
        return result
