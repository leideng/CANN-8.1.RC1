...
class UbAtBlockA(nlast_tiling_core.NlastTilingCore):
    def get_strategy():
        return (PoolGradPattern.NLAST_WINDOW_AXIS, pool_grad_tilingcase.Strategy.UB_AT_BLOCK_A)
    ...
    def _do_split(self):
        ...
        self._block_split.axis = self._fn.fuse(*self._fn_ah_axes, self._ub_split.outer)
