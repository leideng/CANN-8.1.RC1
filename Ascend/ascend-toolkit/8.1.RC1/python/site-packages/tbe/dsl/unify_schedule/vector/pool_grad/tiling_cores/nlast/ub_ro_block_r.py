...
class UbRoBlockR(nlast_tiling_core.NlastTilingCore):
    def get_strategy():
        return (PoolGradPattern.NLAST_WINDOW_AXIS, pool_grad_tilingcase.Strategy.UB_RO_BLOCK_R)
    ...
    def _do_compute_at(self):
        ...
        self._dp.compute_at(self._fn, self._fn_ah_axes[-1])
