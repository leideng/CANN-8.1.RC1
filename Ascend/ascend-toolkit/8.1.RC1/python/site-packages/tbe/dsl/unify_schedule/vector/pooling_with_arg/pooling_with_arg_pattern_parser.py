...
# ============================================================================
"""
pooling with arg pattern parser
"""
...
class PoolingWithArgPatternParser(PatternParser):
    ...
    def match(self):
        ...
        pooling_with_arg = self.compute_type_size_map.get(ComputeType.POOLING_WITH_ARG, 0)
        total = self.compute_type_size_map.get(ComputeType.ANY, 0)

        return (total == ph_size + pooling_with_arg) and (pooling_with_arg > 0)
