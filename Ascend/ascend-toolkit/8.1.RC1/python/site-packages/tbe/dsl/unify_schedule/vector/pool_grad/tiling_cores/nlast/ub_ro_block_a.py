...
class UbRoBlockA(nlast_tiling_core.NlastTilingCore):
    def get_strategy():
        return (PoolGradPattern.NLAST_WINDOW_AXIS, pool_grad_tilingcase.Strategy.UB_RO_BLOCK_A)
