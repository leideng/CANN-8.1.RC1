...
class NetworkUsageAnalysis(MsMultiProcess):
    ...
    def ms_run(self: any) -> None:
        ...
        host_network_usage_patterns = get_host_network_usage_compiles()
        for file_name in file_list:
            host_network_usage_result = \
                get_file_name_pattern_match(file_name, *host_network_usage_patterns)
            if host_network_usage_result and is_valid_original_data(file_name, self.result_dir):
                logging.info(
