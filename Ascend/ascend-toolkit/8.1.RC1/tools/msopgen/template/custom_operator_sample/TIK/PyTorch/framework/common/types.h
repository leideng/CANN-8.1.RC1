...
REGISTER_OPTYPE_DECLARE(HCOMCOLLREMOTELOOKUPUNIQUEDANDPAIRED, "HcomCollRemoteLookupUniquedAndPaired");
...
REGISTER_OPTYPE_DECLARE(EMBEDDING_APPLY_SGD, "EmbeddingApplySgd");
REGISTER_OPTYPE_DECLARE(EMBEDDING_APPLY_RMSPROP, "EmbeddingApplyRmsprop");
REGISTER_OPTYPE_DECLARE(EMBEDDING_APPLY_FTRL, "EmbeddingApplyFtrl");
...
REGISTER_OPTYPE_DECLARE(EMBEDDING_FEATURE_MAPPING_V2, "EmbeddingFeatureMappingV2");
REGISTER_OPTYPE_DECLARE(EMBEDDING_FEATURE_MAPPING_IMPORT, "EmbeddingFeatureMappingImport");
REGISTER_OPTYPE_DECLARE(EMBEDDING_FEATURE_MAPPING_INSERT, "EmbeddingFeatureMappingInsert");
REGISTER_OPTYPE_DECLARE(EMBEDDING_FEATURE_MAPPING_FILE_SIZE, "EmbeddingFeatureMappingFileSize");
REGISTER_OPTYPE_DECLARE(EMBEDDING_TABLE_EVICT, "EmbeddingTableEvict");

// Data flow
REGISTER_OPTYPE_DECLARE(FLOWNODE, "FlowNode");
REGISTER_OPTYPE_DECLARE(FLOWFUNC, "FlowFunc");
REGISTER_OPTYPE_DECLARE(FLOWSEND, "FlowSend");
REGISTER_OPTYPE_DECLARE(FLOWRECV, "FlowRecv");
