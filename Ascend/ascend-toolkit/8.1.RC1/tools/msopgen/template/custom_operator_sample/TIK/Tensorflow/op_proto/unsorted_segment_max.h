...
*@par Inputs:
*x: A 4D tensor with format "NHWC". Type is float16, float32, int8, uint8, int16, uint16, int32, uint32, int64, uint64. \n
...
*@par Inputs:
* One input:
*input_x: A Tensor with any format. Must be one of the following types: bfloat16, float16, float32, int8, int16, int32, int64, uint8, uint16, uint32, uint64 . \n
...
*@par Outputs:
*output_y: A Tensor of any format. Must be one of the following types: bfloat16, float16, float32, int8, int16, int32, int64, uint8, uint16, uint32, uint64 . \n
