 ...
 * @return status whether this operation success
 */
graphStatus SubShape(const GeShape& s, int64_t start, int64_t end, int64_t stride, GeShape& out, const ge::Operator& op);
...
/**
 * check shape first dim defined or not
 * @param shape Shape is checked
 * @return whether shape first dim is defined
 */
...
/**
 * @brief get transformed output range from input range
 * @param input_range input range
 * @param rank_size the rank size of the operator
 * @return output range
 */
