...
if [[ "$tbe_impl_files_num" -gt 0 ]];then
    cp -r ${project_path}/tbe/impl/* ${build_path}/makepkg/packages/vendors/$vendor_name/op_impl/ai_core/tbe/${vendor_name}_impl
    cp -r ${project_path}/tbe/impl/* ${build_path}/makepkg/packages/vendors/$vendor_name/op_impl/vector_core/tbe/${vendor_name}_impl
fi
