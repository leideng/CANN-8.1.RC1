...
* Format support ND, the max dim is 400 (128 on ihisi).
* @li data_seq: One dimensional tensor of type int32, 
* Format support ND, specifying the mapped table is queried.
* @li level_index: One dimensional tensor of type int32, 
* Format support ND, specifying secondary index. \n

* @par Outputs:
* y: A Tensor with shape [8], of type int32, specifying index of shape in the map.
* @par Third-party framework compatibility
