...
*@par Attributes:
*@li RAGGED_RANK: An optional int that the dynamic of input rt_nested_splits with type int. Default value is 1.
...
*@par Attributes:
*@li num_row_partition_tensors: An optional int that indicates the numbers of row partition tensors.
