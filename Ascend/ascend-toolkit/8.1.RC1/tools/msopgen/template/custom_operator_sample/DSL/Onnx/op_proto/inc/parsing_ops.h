...
*@par Attributes:
*@li num_sparse: An optional int that indicates the num of inputs sparse_indices, sparse_values, sparse_shapes. Default is 0.
*@li sparse_keys: An optional string list.
*@li sparse_types: An optional attribute, types of sparse_values.
*@li dense_keys: An optional string list.
*@li Tdense: An optional attribute, output of dense_defaults type.
*@li dense_shapes: An optional attribute, output of dense_defaults shape.  \n
...
*@par Attributes:
*@li little_endian: An optional bool, default is ture.
*@li out_type: An optional attribute, that indicates the output type. Defaults to float. \n
...
*@par Attributes:
*@li OUT_TYPE: An optional attribute. The numeric type to interpret each string in string_tensor as. \n
*@li field_delim: An optional string. Defaults to ",". The char delimiter to separate fields in a record. \n
*@li use_quote_delim: An optional bool. Defaults to true. If false, treats double quotation marks as regular characters
*inside of the string fields (ignoring RFC 4180, Section 2, Bullet 5). \n
*@li na_value: An optional string. Defaults to ",". Additional string to recognize as NA/NaN. \n
*@li select_cols: An optional attribute that is a sorted list of column indices to select. If specified,
...
*@par Attributes:
*@li Nsparse: An optional int. Defaults to 0. Number of sparse_keys, sparse_indices and sparse_shapes. \n
*@li Ndense: An optional int. Defaults to 0. Number of dense_keys. \n
*@li sparse_types: An optional attribute, types of sparse_values. \n
*@li Tdense: An optional attribute. Type of dense_defaults dense_defaults and dense_values. \n
*@li dense_shapes: An optional attribute that indicates output of dense_defaults shape.  \n
...
*@par Attributes:
*@li Ncontext_sparse: An optional int, default is 0. Number of context_sparse_keys, context_sparse_indices and context_sparse_shapes. \n
*@li Ncontext_dense: An optional int, default is 0. Number of context_dense_keys. \n
*@li Nfeature_list_sparse: An optional int, default is 0. Number of feature_list_sparse_keys. \n
*@li Nfeature_list_dense: An optional int, default is 0. Number of feature_list_dense_keys. \n
*@li context_sparse_types: An optional attribute. Types of context_sparse_values. \n
*@li Tcontext_dense: An optional attribute. Number of dense_keys. \n
*@li feature_list_dense_types: An optional attribute. Types of feature_list_dense_values. \n
*@li context_dense_shapes: An optional attribute. Shape of context_dense. \n
*@li feature_list_sparse_types: An optional attribute. Type of feature_list_sparse_values. \n
*@li feature_list_dense_shapes: An optional attribute. Shape of feature_list_dense. \n
