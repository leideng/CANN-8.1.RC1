...
* The format must be ND.
* @li seq_length:A optional 3D Tensor. Must be one of the following types: float16, int32.
* The format must be ND.
...
* and Atlas A3 Training Series Product/Atlas A3 Inference Series Product. Support "sigmoid" and "hard_sigmoid"
...
* @par Inputs:
* eight inputs:
* @li x: A input 3D Tensor. Must be one of the following types: float16. The format must be FRACTAL_ZN_RNN.
* @li weight_input: A input 2D Tensor. Must be one of the following types: float16. The format must be FRACTAL_ZN_RNN.
* @li weight_hidden: A input 2D Tensor. Must be one of the following types: float16, float32. The format must be FRACTAL_ZN_RNN.
* @li weight_att: A input 2D Tensor. Must be one of the following types: float16. The format must be ND.
* @li bias_input: A input 1D Tensor. Must be one of the following types: float16, float32. The format must be ND.
* @li bias_hidden: A input 1D Tensor. Must be one of the following types: float16, float32. The format must be ND.
* @li seq_length: A input Tensor. Dimension is batch_size. Must be one of the following types: int32, float16.
* The format must in ND.
* @li init_h: The initial hidden state. A optional input 3D Tensor. Must be one of the following types: float16, float32.
...
* @par Outputs:
* seven outputs:
* @li y: A 3D Tensor. Must be one of the following types: float16, float32.
* @li output_h:A 3D Tensor. Must be one of the following types: float16, float32.
* @li update:Must A 3D Tensor. Must be one of the following types: float16, float32.
* @li update_att: A 3D Tensor. Must be one of the following types: float16, float32.
* @li reset:Must  A 3D Tensor. Must be one of the following types: float16, float32.
* @li new: A 3D Tensor. Must be one of the following types: float16, float32.
* @li hidden_new: A 3D Tensor. Must be one of the following types: float16, float32.
*/
REG_OP(DynamicAUGRU)
    .INPUT(x, TensorType({DT_FLOAT16}))
    .INPUT(weight_input, TensorType({DT_FLOAT16}))
...
* @li per_sample_weights: A optional Tensor. to indicate all weights should be taken to be 1. Must be one of the following types: float16, float32, bfloat16.
...
* @par Attributes:
* @li mode: An string attr which use "sum"``, ``"mean"`` or ``"max"``. Specifies the way to reduce the bag. Defaults to "mean".\n
* @li padding_idx: An int attr judge which word to fill zeros. Defaults to "-1". \n
...
* @li include_last_offset: An optional bool. Defaults to "False". if True, attr offsets has one additional element, where the last element
