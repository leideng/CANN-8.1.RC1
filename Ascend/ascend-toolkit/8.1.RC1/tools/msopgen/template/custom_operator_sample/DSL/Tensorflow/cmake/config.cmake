...
if("x${OPP_CUSTOM_VENDOR}" STREQUAL "x")
    set(OPP_CUSTOM_VENDOR "customize")
endif()
...
set(OP_REPLAY_TARGET_OUT_DIR ${OUT_DIR}/packages/${PROJECT_DIR}/op_impl/ai_core/tbe/op_replay)

set(OP_IMPL_TARGET "op_impl")
...
set(AIC_OP_IMPL_CFG_OUT_DIR ${OUT_DIR}/packages/${PROJECT_DIR}/op_impl/ai_core/tbe/${OPP_CUSTOM_VENDOR}_impl)
set(ASCENDC_IMPL_BUILD_PY "${CMAKE_SOURCE_DIR}/cmake/util/ascendc_impl_build.py")
set(ASCENDC_REPLAY_BUILD_PY "${CMAKE_SOURCE_DIR}/cmake/util/ascendc_replay_build.py")
set(TILING_DATA_DEF_BUILD_PY "${CMAKE_SOURCE_DIR}/cmake/util/tiling_data_def_build.py")
