...
*@par Attributes:
*@li adaptive: An optional bool that indicates whether to use adaptive algorithm. Defaults to false.
*@li num_sparse_features: An optional int that indicates the num of sparse. Defaults to 0.
*@li num_sparse_features_with_values: An optional int that indicates the num of sparse_feature_values. Defaults to 0.
*@li num_dense_features: An optional int that indicates the num of dense. Defaults to 0.
*@li loss_type: An optional string that indicates the type of the primal loss. Currently SdcaSolver supports logistic, squared and hinge losses. Defaults to "logistic_loss".
*@li l1: An optional float that indicates the symmetric l1 regularization strength. Defaults to 0.5.
*@li l2: An optional float that indicates the symmetric l2 regularization strength. Defaults to 0.5.
*@li num_loss_partitions: An optional int that indicates the number of partitions of the global loss function.  Defaults to 1.
*@li num_inner_iterations: An optional int that indicates the number of iterations per mini-batch.  Defaults to 1. \n
