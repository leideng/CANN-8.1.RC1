...
*@par Attributes:
*@li num_batch_threads: An optional int. The number of threads enqueuing "x_tensors".
The batching will be nondeterministic if "num_batch_threads" > 1.
*@li max_batch_size: An optional int. The maximum batch size pulled from the queue.
*@li max_enqueued_batches: An optional int. Defaults to 10. The maximum number of batches pulled from the queue.
*@li batch_timeout_micros: The batch processing timeout, in microseconds.
*@li allowed_batch_sizes: An optional int list. The allowed batch size pulled from the queue.
*@li grad_timeout_micros: The gradient batch processing timeout,
in microseconds.
*@li container: An optional string. Defaults to "". If non-empty, this queue is placed in the given container.
Otherwise, a default container is used.
*@li shared_name: An optional string. Defaults to "". If set, this queue will be shared under the given name
across multiple sessions.
*@li batching_queue: An optional string. Defaults to "". The queue resource container.   \n
...
*@li container: An optional string. If non-empty, this queue is placed in the given container.
Otherwise, a default container is used. Defaults to "".
*@li shared_name: An optional string. If set, this queue will be shared under the given name
