...
*@li alpha: A scalar. Has the same data type as "var".
*@li l1: A scalar. Has the same data type as "var".
*@li l2: A scalar. Has the same data type as "var".
*@li delta: A tensor. Has the same data type, shape, and format as "var".
*
*@par Attributes:
* use_locking: An optional bool. Defaults to "False".
*     If "True", updating of the "var", "ms", and "mom" tensors is protected
...
*
*@par Inputs:
*@li var: A mutable tensor. Should be from a Variable(). Support float16 and float32.
*@li accum: A mutable tensor. Has the same type as "var".
*     Should be from a Variable().
*@li lr: A scalar. Has the same type as "var".
*@li grad: A tensor for the gradient. Has the same type as "var".
...
*@par Inputs:
* Seven inputs, including:
* @li var: A mutable Tensor. Support dtype: float32, support format: [NCHW,NC1HWC0,NHWC,ND,FRACTAL_Z].
...
* @par Outputs:
* @li var: A mutable Tensor. Has the same type and format as "var" .
* @li accum: A mutable Tensor. Has the same type and format as "accum" . \n
...
* @par Inputs:
*   Seven inputs, including:
*  @li var: A mutable Tensor of type float32. Should be a Variable Tensor. 
*  Supported format: NC1HWC0,C1HWNCoC0,ND,FRACTAL_Z,NC1HWC0,C1HWNCoC0,ND,FRACTAL_Z
*  @li accum: A mutable Tensor has the same shape and format as "var". 
*     Should be a Variable Tensor. Supported data type: float32, float16
*  @li lr: A scalar has the same data type as "accum", for the scaling factor.
*  @li x1: A Tensor has the same data type, shape, and format as "accum".
*  @li momentum: A scalar has the same data type as "accum".
*  @li x2: A scalar has the same data type as "accum".
*  @li var_copy: A Tensor has data type of float16 and same format as "accum".
*
* @par Attributes:
*   Two Attributes, including:
*  @li use_nesterov: An optional bool. Defaults to "False".
...
*  @li var: A Tensor has the same data type, shape, and format as input "var".
*  @li var_copy: A Tensor has the same data type, shape, and format as input "var_copy".
*  @li accum: A Tensor has the same data type, shape, and format as input "accum".
...
*@par Inputs:
*Four inputs, including:
* @li w: A Tensor. Must be of type TensorType::DT_FLOAT. Support format: [FRACTAL_Z,C1HWNCoC0,NC1HWC0,ND]. 
* @li g: A Tensor of the same type and shape as "w". Support format: [FRACTAL_Z,C1HWNCoC0,NC1HWC0,ND].
* @li weight_decay: A Tensor of the same type as "w",  Must be a scalar. Support format: [ND].
* @li learning_rate: A Tensor of the same type as "w", Must be a scalar . Support format: [ND]. \n
...
* @par Inputs:
* Nine inputs, including:
* @li var: A mutable tensor. Support dtype: float32, support format: [NC1HWC0,ND].
* @li ms: A mutable tensor. Support dtype: float32, support format: [NC1HWC0,ND].
* @li mom: A mutable tensor. Support dtype: float32, support format: [NC1HWC0,ND].
* @li lr: A scalar. Must have the same type as "var", support format: [ND].
* @li rho: A scalar. Must have the same type as "var", support format: [ND].
* @li momentum: A scalar. Must have the same type as "var", support format: [ND].
* @li epsilon: A scalar. Must have the same type as "var", support format: [ND].
* @li grad: A tensor, specifying the gradient. Support dtype: float32, support format: [NC1HWC0,ND].
* @li indices: A vector of indices into the first dimension of "var", "mom" and "ms". Support dtype: int32, 
...
*
* @par Outputs:
* @li var: A mutable tensor. Has the same type and format as input "var".
* @li ms:  A mutable tensor. Must have the same type and format as input "ms".
* @li mom: A mutable tensor. Must have the same type and format as input "mom".
*
* @attention Constraints:
...
* Eight inputs, including:
* @li var: A mutable tensor. Support dtype: float32, support format: [NC1HWC0,ND].
* @li accum: A mutable tensor. Support dtype: float32, support format: [NC1HWC0,ND].
* @li accum_update: A mutable tensor. Support dtype: float32, support format: [NC1HWC0,ND].
* @li lr: A scalar. Must have the same type as "var". Support format: [ND].
* @li rho: A scalar. Must have the same type as "var". Support format: [ND].
* @li epsilon: A scalar. Must have the same type as "var". Support format: [ND].
* @li grad: A tensor, specifying the gradient. Has the same type and format as var.
* @li indices: A vector of indices into the first dimension of "var", "accum" and "accum_update". Support dtype: int32, 
* int64, support format: [ND].
* The value of indices must be unique. Otherwise, the result is unpredictable . \n
*
* @par Attributes:
...
* @par Outputs:
* @li var: A mutable tensor. Has the same type and format as input "var".
* @li accum:  A mutable tensor. Must have the same type and format as input "accum".
* @li accum_update: A mutable tensor. Must have the same type and format as input "accum_update".
*
* @attention Constraints:
