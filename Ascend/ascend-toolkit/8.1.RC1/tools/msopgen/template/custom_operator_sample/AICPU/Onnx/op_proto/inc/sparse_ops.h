...
* @li x2: A matrix Tensor. Has the same type and same shape as the x1_values. \n
...
* @li indices: A matrix Tensor of type int64. 2D. The indices of the SparseTensor.
* @li values: The values of the SparseTensor. A vector Tensor. 1D.
* @li shape: A 1D Tensor of type int64. The requested new dense shape. \n
...
*@par Inputs:
* @li backprop_val_grad: A Tensor. Must be one of the following types: int8, uint8, int16, uint16,
...
*@par Attributes:
*@li concat_dim: An optional int. Dimension to concatenate along. Default is 0.
*@li N: An optional int. Number of sparse. Default is 1. \n
...
* @li x1_values:A `Tensor`. Must be one of the following types:float,int8,int16,int32,int64, float64, complex64, complex128.
...
* @li x2_values:A `Tensor`. Must have the same type as `x1_values`.1-D.
...
*@par Outputs:
* @li y_indices:A `Tensor` of type `int64`.
* @li y_values:A `Tensor`. Has the same type as `x_values`.
* @li y_shape:A `Tensor` of type `int64`. \n
