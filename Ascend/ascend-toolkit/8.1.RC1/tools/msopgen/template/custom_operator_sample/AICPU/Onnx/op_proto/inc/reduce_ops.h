...
* @par Outputs:
* @li sum: A 1D Tensor of type float32 for SUM reduced "x". shape must be C channel.
* @li square_sum: A 1D Tensor of type float32 for SUMSQ reduced "x" . shape must be C channel. \n
...
* @li x: A 4D tensor of type float16 or float32 or bfloat16, with format NHWC or NCHW, the shape is same as input grads.
* @li diff_scale: A 1D tensor of type float32, the shape is same as dim C of input grads, for the mean of "x".
* @li diff_offset: A 1D tensor of type float32, the shape is same as dim C of input grads, for the variance of "x".
...
* BNTrainingReduce.
* @li scale: A 1D Tensor of type float32, the shape is same as dim C of input x, for the scaling factor.
* @li offset: A 1D Tensor of type float32, the shape is same as dim C of input x, for the scaling offset.
* @li mean: A 1D Tensor of type float32, the shape is same as dim C of input x, for the updated mean.
* @li variance: A 1D Tensor of type float32, the shape is same as dim C of input x, for the updated variance . \n
...
* @li square_sum: A 1D tensor of type float32 for the output of operator BN3DTrainingUpdate. shape must be C channel.
...
* BNTrainingReduce. shape must be C channel.
* @li scale: A 1D tensor of type float32, for the scaling factor. shape must be C channel.
* @li offset: A 1D tensor of type float32, for the scaling offset . shape must be C channel. \n
...
* @li batch_variance: A 1D tensor of type float32. It is an output of BatchNorm . shape must be C channel. \n
...
* @li x: A multi-dimensional Tensor of Must be the type of NumberType. (NumberType
  ...
  bfloat16, complex32).Supported format list ["ND"]
...
*@li axes: A Tensor of type int32 or int64. Specifies the dimensions to reduce. Defaults to "None" . \n
...
*@li square_sum: A 4D tensor of type float32 for the output of operator INTrainingReduceV2, format [NCHW, NHWC], and HW=1.
...
*@li square_sum: A Tensor of type float32 for SUMSQ reduced "x".shape is [N, G, 1, 1, 1] for NCHW, [N, 1, 1, G, 1] for NHWC.
...
* This operator is used in conjunction with GNTrainingUpdate.
*@li For Atlas 200/300/500 Inference Product, the result accuracy fails to reach 1/1000 due to the square root instruction.
*/
...
*@par Attributes:
*@li keep_dims: An optional bool. Defaults to False. If True, retain reduced dimensions with length 1.
*@li separator: An optional string. Defaults to "". \n
...
* @li dim: An optional listint, Defaults to "[]". \n
