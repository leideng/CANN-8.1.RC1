...
* @par Inputs:
* Five inputs, including:
* @li net_deriv: A 2D Tensor with shape [nframes, nloc * nnei * 4]. Must be one of the following types: float16, 
* float32, float64.
* @li in_deriv: A 2D Tensor with shape [nframes, nloc * nnei * 4 * 3]. Must be one of the following types: float16, 
* float32, float64.
* @li rij: A 2D Tensor with shape [nframes, nloc * nnei * 3]. Must be one of the following types: float16, float32, 
* float64.
* @li nlist: A 2D Tensor with shape [nframes, nloc * nnei]. dtype is int32.
* @li natoms: A 1D Tensor with shape [2 + ntypes,]. dtype is int32. \n
*
* @par Outputs:
* Two outputs, including:
* @li virial: A 2D Tensor with shape [nframes, 9]. Must be one of the following types: float16, float32, 
* float64.
* @li atom_virial: A 2D Tensor with shape [nframes, nall * 9]. Must be one of the following types: float16, 
* float32, float64. \n
*
* @par Attributes:
* Two attributes, including:
* @li n_a_sel: A required int32. The value must be greater than or equal to 0.
* @li n_r_sel: A required int32. The value must be greater than or equal to 0. Additionally,
