...
* @li x: A tensor with the same type as "grad" . \n
...
* @par Attributes:
* scale: A optional scalar, the multiplier of x. The data type is float, default value = 1.0. \n
*@par Outputs:
...
* @li x: A Tensor of the same type and shape as "dy" . \n
* @par Outputs:
* dx: A Tensor. Has the same type and shape as "dy".
* @par Third-party framework compatibility
...
* @li y: A Tensor of the same type and format as "dy" . \n
...
* @par Attributes:
* scale: A optional float32 attr. Default to 1.0 . \n
...
* @par Inputs:
* @li gradients: A ND Tensor of type TensorType::RealNumberType. The backpropagated
      gradients to the corresponding Relu6 operation.
* @li features: A ND Tensor with the same type as gradients.The features passed
...
/**
* @brief Computes rectified linear gradients for a ReLU operationx.

* @par Inputs:
* Two inputs, including:
* @li gradients: A ND tensor. Indicates the gradient of backpropagation. Must be one of the following types: float32, double,
 * int32, int8, int16, int64, uint16, float16, uint32, uint64, bfloat16.
* @li features: A ND tensor. Indicates the input of forward. Must be one of the following types: float32, double,
 * int32, int8, int16, int64, uint16, float16, uint32, uint64, bfloat16.

* @par Outputs:
* backprops: A ND tensor. Indicates the backpropagation result. Must have the same type and shape as "gradients". \n
...
*@par Inputs:
* Two inputs, including:
*@li gradients: A tensor of input gradient. Indicates the gradient of backpropagation. 
*    Supported type: TensorType::RealNumberType(). The format must be NC1HWC0.
*    Shape support 5D.
*@li mask: A tensor of input mask. Indicates the positive output. Must be the following types: uint8, uint1. The format must be ND.
*    Shape support 5D, must be the same as gradients in NC1HWC0 format.
...
*@par Inputs:
* x: A tensor. Support 4D. Must be one of the following types: float32, float16, double, int8, int32
*    int16, int64, uint8, uint16, qint8.
*    Format must be one of [NHWC, NCHW, HWCN].

*@par Outputs:
*@li y: A Tensor with the same dtype and shape as the "x".
*@li mask: A tensor of value "1" (for x > 0) or "0" ( for x <= 0).
*    Type is uint8 or uint1. 

*@par Third-party framework compatibility
* Incompatible with TensorFlow or Caffe.

*@attention Constraints:
*@li The last dimension of "x" must be divisible by 8.
*@li The int32 data type of input "x" is not supported on Atlas A2 Training Series Product/Atlas 800I A2
...
*@li features: A ND Tensor of type float16 or float32. The same shape and dtype with grads.
...
*Has the same shape and type with "features".
...
* @par Inputs:
* One input:
* x: An ND or 5HD tensor. Support 1D~8D. Must be one of the following types: bfloat16, float32, float16.
*
* @par Attributes:
 ...
 * @li x: A Tensor. Must be one of the following types: float16, float32, bfloat16, format:ND
...
* @par Outputs:
* y: A tensor with the same dtype and shape as 'input_x'. \n
...
*@par Outputs:
*One output, including:
* y: A tensor with the same type and shape as 'input_x'. \n
