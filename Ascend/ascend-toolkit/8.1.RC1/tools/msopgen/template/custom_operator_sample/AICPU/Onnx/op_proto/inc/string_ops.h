...
*@par Attributes:
*@li pattern:An optional string. The regular expression to match the input.
*@li rewrite:An optional string. The rewrite to be applied to the matched expression.
