...
* @li roi_actual_num: An optional tensor of type int32, specifying
...
* than 0.
* @li spatial_scale_h: A required float32, scaling factor for mapping the input
* coordinates of height to the ROI coordinates.
* @li spatial_scale_w: A required float32, scaling factor for mapping the input
...
* @li "pool_channel" only support equal to the channel of "x".
* @li "roi_actual_num" only support equal to the number of "rois". 
* @li NPU not support Channel of "x" being unaligned to 16. \n
