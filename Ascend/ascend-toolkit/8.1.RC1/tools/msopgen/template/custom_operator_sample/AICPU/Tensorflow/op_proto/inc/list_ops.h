...
*@par Attributes:
*@li element_dtype: An optional attribute. The type of elements in the list. Defaults to DT_INT32. \n
*@li shape_type: An optional attribute. The type of shape in the list. Defaults to DT_INT32.  \n
...
*@par Attributes:
*@li element_dtype: An optional attribute. The type of elements in the list. Defaults to DT_INT32.
*@li num_elements: An optional int. The number of elements in the list. Default is -1. \n
