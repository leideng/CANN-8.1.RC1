...
*     quint8, qint32, qint16, quint16, uint16, complex128, uint32, uint64. Supported format list ["ND"].
...
*     bfloat16, float16, float32, int32 . \n
...
REG_OP(DiagD)
    ...
    .INPUT(assist, TensorType({DT_FLOAT16, DT_FLOAT, DT_INT32, DT_BF16}))
...
*     following types:
*     float16, float32, double, int32, int64, complex64, complex128. Supported format list ["ND"]. \n
...
* @par Attributes:
* @li row_memory: An optional int, the size of Embedding vector in a row. Default is 320.
* @li mode: An optional string, currently there are two options: 'mod' and 'order'. Default is 'mod'.
