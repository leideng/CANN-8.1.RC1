...
* @li momentum: An optional float. Defaults to 0.01. \n
* @li epsilon: An optional float. Defaults to 0.00001. \n

* @par Outputs:
* include:
* @li invert_std: A Tensor. It's inverse of total variance. Must be one of the following types: float16, float32, bfloat16.
* @li running_var_update: A Tensor. It's moving variance of each device after the update. Must be one of the following types: float16, float32, bfloat16. \n
...
* @par Attributes:
* Two Attributes, including:
* @li momentum: An optional float. Defaults to 0.1. \n
...
*@li x: A 4D Tensor of type float16 or float32, with format NHWC, NCHW, the same shape with y_backprop.
*@li scale: A 1D Tensor of type float32, with format NHWC, NCHW, shape must be C channel.
*@li reserve_space_1: A 1D Tensor of type float32, with format NHWC, NCHW, shape must be C channel. It is an output of BatchNorm.
*@li reserve_space_2: A 1D Tensor of type float32, with format NHWC, NCHW, shape must be C channel. It is an output of BatchNorm .
...
*@par Outputs:
*@li x_backprop: A 4D Tensor of type float16 or float32, with format NHWC, NCHW, for the offset of "x", the same shape with y_backprop.
*@li scale_backprop: A Tensor of type float32, with format NHWC, NCHW, for the offset of "scale", the same shape format with scale.
*@li offset_backprop: A Tensor of type float32, with format NHWC, NCHW, for the offset of "offset", the same shape format with scale.
*@li reserve_space_4: A Tensor of type float32, with shape NHWC, NCHW. Pass "None" to skip this output, the same shape format with scale.
*@li reserve_space_5: A Tensor of type float32, with shape NHWC, NCHW. Pass "None" to skip this output , the same shape format with scale. \n
...
* @li b: An optional tensor of type float16 or float32 or bfloat16, no use. \n
