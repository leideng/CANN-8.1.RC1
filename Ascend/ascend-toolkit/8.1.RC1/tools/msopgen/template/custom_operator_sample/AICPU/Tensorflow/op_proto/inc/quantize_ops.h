...
* @li scales: A tensor. Must be one of the following types: float32, bfloat16. \n
* @li zero_points: An optional tensor. Must be one of the following types: int8, uint8, int32, bfloat16. \n
* @par Attributes:
* @li dtype: A required string from "torch.qint8", "torch.quint8", "torch.qint32".
* @li axis: An optional int, the processed dim. Default to 1. \n
* @par Outputs:
...
* be NC1HWC0, FRACTAL_NZ, NDC1HWC0 or ND. Shape support 1D ~ 8D.
* If "dst_type" is 29, the last dimension of the shape must be divisible by 2.
* When format is FRACTAL_NZ, shape support 4D ~ 8D.
...
* "2", represents dtype "DT_INT8". If the value of "dst_type" is "29", represents dtype "DT_INT4". \n

* @par Outputs:
* y: The quantized output tensor of type int8 or int4. The format must be
* NC1HWC0, FRACTAL_NZ, NDC1HWC0 or ND. Shape support 1D ~ 8D.
* When format is FRACTAL_NZ, shape support 4D ~ 8D.
* Has the same format and shape as input "x". \n

* @attention Constraints:
* @li round_mode value range is [Round, Floor, Ceil, Trunc]. \n
...
* float32, bfloat16. The format support ND. Shape support 1D ~ 8D.
* @li scale: A required Tensor. Must be one of the following types: float16,
* float32, bfloat16. The format support ND. Shape support 1D ~ 8D.
* If scale is 1D tensor, shape must be same as the last dimension of x. 
* Otherwise the number of dimensions should be equal to x,
...
* float32, bfloat16. The format support ND. Shape support 1D ~ 8D. Shape is same as "scale". \n
* @par Attributes:
...
* Defaults to "DT_INT8".
* @li axis: An optional int32, specifying axis to scale and offset.
* Defaults to "-1". \n
* @par Outputs:
* y: The quantized output tensor of type int8 or int4. The format support ND.
