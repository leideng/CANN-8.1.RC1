...
*@par Attributes:
*@li output_dtype: Output data type. Must be one of the following types: int32, int64. Defaults to int64. \n
...
* @li seed: 2 seeds (shape [2]).
* @li means: A Tensor. Must be one of the following types: float16, float32, double.
...
* @par Attributes:
* @li dtype:Output data type. Must be one of the following types: int32, int64, uint32, uint64.
* Defaults to int32. \n
...
* @par Attributes:
* @li dtype:Output data type. Must be one of the following types: float16, float32, double, int32, int64. \n
...
* @par Attributes:
* @li dtype:Output data type. Must be one of the following types: float16, bfloat16, float32, double. 
* Defaults to float32. \n
...
* @par Outputs:
* output:
* @li handle:Handle to the random number generator.
* @li deleter:Handle to the remover.Used when deleting the random number seed generator. \n
