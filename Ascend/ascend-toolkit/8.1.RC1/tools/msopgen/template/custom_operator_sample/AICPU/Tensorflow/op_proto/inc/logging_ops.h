...
*@par Attributes:
*output_stream: An optional string that specifying the output stream or logging level
to print to. Defaults to "stderr". \n
...
*@par Attributes:
*message: An optional string that prefix of the error message. Defaults to "". \n
*first_n: An optional int. Only log first_n number of times. Negative numbers 
*log always; Defaults to -1. \n
*summarize: An optional int. Only print this many entries of each tensor. 
*If None, then a maximum of 3 elements are printed per input tensor. Defaults to 3. \n
