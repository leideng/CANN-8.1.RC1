...
*@par Inputs:
*Inputs include:
* @li alpha: A Tensor. Must be one of the following types: float32, double.
...
* @li alpha: A Tensor. Must be one of the following types: float16, float32, double. \n
...
*Inputs include:
* @li shape: A Tensor. Must be one of the following types: int32, int64. 1-D integer tensor.
* @li rate: A Tensor. Must be one of the following types: float16, float32, double, int32, int64 . \n

*@par Attributes:
*@li dtype: An optional type from: float16, float32, double, int32, int64. Defaults to int64.
...
*@par Attributes:
*@li dtype: A type from: float16, float32, double. The type of the output.
*@li seed: An optional int. Defaults to 0. If either seed or seed2 are set to be non-zero, 
the random number generator is seeded by the given seed. Otherwise, it is seeded by a random seed.
*@li seed2: An optional int. Defaults to 0 . A second seed to avoid seed collision. \n
...
* @par Attributes:
* @li dtype: The data type for the elements of the output tensor.
...
*
* @par Inputs:
* @li x: A ND Tensor. Must be one of the following data types: float32, float16
* @li seed: A ND Tensor. Must be one of the following data types: float32. Seed is 
...
* @li mask: A tensor. Must be float32. Indicates which neural network units (neurons) 
