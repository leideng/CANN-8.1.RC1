...
*@par Attributes:
*N: An required attribute of type int32, means nums of inputs. Must be greater than "1" \n

*@par Outputs:
*y: A ND Tensor. Has the same shape and type as the elements of "x". \n
...
*@par Outputs:
*y: A ND Tensor. Has the bool dtype. \n
...
*Two inputs, including:
* @li x1: A ND Tensor with TensorType::RealNumberType().
* @li x2: A ND Tensor with the same dtype as "x1". \n
...
/**
*@brief Returns the max of "x" and "y" (i.e. x > y ? x: y) element-wise. Support broadcasting operations.

*@par Inputs:
*Two inputs, including:
* @li x1: A ND Tensor. Must be one of the following types: float16, float32, double, int8, int32, int64, bfloat16.
* @li x2: A ND Tensor of the same dtype as "x1". \n
...
*/
REG_OP(Maximum)
    .INPUT(x1, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT32, DT_INT8,
                           DT_INT64, DT_BF16}))
    .INPUT(x2, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT32, DT_INT8,
                           DT_INT64, DT_BF16}))
    .OUTPUT(y, TensorType({DT_FLOAT16, DT_FLOAT, DT_DOUBLE, DT_INT32, DT_INT8,
                           DT_INT64, DT_BF16}))
    .OP_END_FACTORY_REG(Maximum)

/**
* @brief Returns the min of x and y (i.e. x1 < x2 ? x1 : x2) element-wise. Support broadcasting operations.

* @par Inputs:
* Two inputs, include:
* @li x1: A ND Tensor. Must be one of the following types: bfloat16, float32, float16, double, int8, int32, int64.
* @li x2: A ND Tensor of the same dtype as "x1". \n
...
*/
REG_OP(Minimum)
    .INPUT(x1, TensorType({DT_BF16, DT_FLOAT, DT_FLOAT16, DT_DOUBLE, DT_INT8, DT_INT32, DT_INT64}))
    .INPUT(x2, TensorType({DT_BF16, DT_FLOAT, DT_FLOAT16, DT_DOUBLE, DT_INT8, DT_INT32, DT_INT64}))
    .OUTPUT(y, TensorType({DT_BF16, DT_FLOAT, DT_FLOAT16, DT_DOUBLE, DT_INT8, DT_INT32, DT_INT64}))
...
* bfloat16, float16, float32, double, int8, int16, int32, int64.
...
* when input is int32 and (x2 - x1) > 2**31 or < -2**31
* aicore accuracy is not guaranteed. Support broadcasting operations.

* @par Inputs:
* Two inputs, including:
* @li x1: A ND Tensor. Must be one of the following types: float32, double,
...
* @par Inputs:
* Two inputs, including:
* @li x1: A ND Tensor. Must be one of the following types: bfloat16, float16, float32, int32,
...
*@par Attributes:
* N:Represent the number of fusion mul operations,which is greater than or equal to 2.
    The supported type is the int.
...
/**
* @brief Clips tensor values to a specified min and max. Support broadcasting operations.
...
*@par Inputs:
*Inputs including:
* x: A ND Tensor of type bfloat16, float16, float, int64, double, complex64,
* complex128 or int32.

* @par Attributes:
* decimals: A optional int attr, number of decimal places to round to. Defaults to "0".

*@par Outputs:
*y: A ND Tensor. Has the same data type and shape as "x".
*@par Third-party framework compatibility
...
*@par Inputs:
*Two inputs, including:
* @li x: A ND tensor of type NumberType, formar list [NCHW, NHWC]. Must be one of the following types: float32, float64, int32, uint8, int16,
*int8, complex64, int64, qint8, quint8, qint32, bfloat16, uint16, complex128, float16, uint32, uint64.
* @li bias: A 1D tensor with size the C dimension of x(when x format is NCHW, C dimension is x.shape[1]. When x format is NHWC, C dimension is x.shape[-1]). \n
...
* @li input0: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li input1: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li input2: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li input3: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li input4: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li mul0_x: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li mul1_x: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li mul2_x: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li mul3_x: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li mul4_x: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li add2_y: A ND Tensor. Must be one of the following types: float16, float32, bfloat16. \n

* @par Outputs:
* Three outputs, including:
* @li output0: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li output1: A ND Tensor. Must be one of the following types: float16, float32, bfloat16.
* @li output2: A ND Tensor. Must be one of the following types: float16, float32, bfloat16. \n
...
*@attention Constraints:
*@li Shapes of all inputs must comply with the broadcast mechanism.
...
* @li value: A mutable input tensor of the same dtype as input_data which includes only one element. \n
...
* @li x1: A mutable input Tensor of the same dtype as input_data.
* @li x2: A mutable input Tensor of the same dtype as input_data.
* @li value: A tensor which includes only one element of the same dtype as input_data. \n
...
* @par Outputs:
* y: A ND tensor with the same shape and type as "x1". \n
 ...
 *     float16, float32, bfloat16. \n
 * The shape of self, end and weight should satisfy the broadcast relationship. \n
 ...
 * @par Outputs:
 * y: A ND Tensor with the same dtype and shape of input_x's. \n
 * The shape of 'out' is same as the shape of the tensor \n
 * whose shape is generated after 'self', 'end', and 'weight' broadcast opratioan.
