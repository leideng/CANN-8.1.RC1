...
*@par Attributes:
*@li PARAMS_RAGGED_RANK: An optional int, defaults to 1. The ragged rank of the params_nested_splits.
*@li Tsplits: A type of output_nested_splits.
*@li OUTPUT_RAGGED_RANK: An optional int, defaults to 0. The ragged rank of the output RaggedTensor. `output_nested_splits` will contain
