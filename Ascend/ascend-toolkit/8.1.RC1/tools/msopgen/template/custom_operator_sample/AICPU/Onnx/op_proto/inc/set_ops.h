...
*@par Attributes:
*@li set_operation: An optional string. Defaults to "".
...
* @li x2_values: A Tensor. Must have the same type as x1. 1D Tensor, values of a SparseTensor.
...
* @li x2_indices: A Tensor of type int64. 2D Tensor, indices of a SparseTensor.
* @li x2_values: A Tensor. Must have the same type as x1_values. 1D Tensor, values of a SparseTensor.
* @li x2_shape: A Tensor of type int64. 1D Tensor, shape of a SparseTensor. \n
...
* @li set_values: A Tensor. Must be one of the following types: int8, int16, int32, int64, uint8, uint16, string.
