...
struct OpImplKernelRegistry {
  ...
  struct OpImplFunctions {
    ...
    OpImplRegisterV2::InferShapeKernelFunc infer_shape;
    OpImplRegisterV2::InferShapeRangeKernelFunc infer_shape_range;
    OpImplRegisterV2::InferDataTypeKernelFunc infer_datatype;
    OpImplRegisterV2::TilingKernelFunc tiling;
    OpImplRegisterV2::KernelFunc tiling_parse;
    OpImplRegisterV2::CompileInfoCreatorFunc compile_info_creator;
    OpImplRegisterV2::CompileInfoDeleterFunc compile_info_deleter;
    ...
    OpImplRegisterV2::OpExecFunc op_execute_func;
    uint64_t tiling_dependency = 0UL;
    OpImplRegisterV2::GenSimplifiedKeyKernelFunc gen_simplifiedkey;
