...
*@par Inputs:
*@li log_probs: A tensor. Must be one of the following types: float32, double. Tensor of size (T, N, C), where T =input length, N =batch size,
...
*@par Outputs:
*@li neg_log_likelihood: A tensor. Must be one of the following types: float32, double. A loss value which is differentiable with respect to each input node.
*@li log_alpha: A tensor. Must be one of the following types: float32, double. The probability of possible trace of input to target.
...
* @par Inputs:
*@li grad_out: A tensor. Must be one of the following types: float32, double. Gradient renewal coefficient. Tensor of size (N), where N = batch size.
* @li log_probs: A tensor. Must be one of the following types: float32, double. Tensor of size (T, N, C), where T =input length, N =batch size,
                and C = number of classes (including blank).
                It represent the logarithmized probabilities of the outputs.
*@li targets: A tensor. Must be one of the following types: int32, int64. Tensor of size (N, S) or sum(target_lengths), where S = max target length.
...
* @par Outputs:
*@li grad: A tensor. Must be one of the following types: float32, double. Tensor of size (T, N, C), The grad of Connectionist Temporal Classification loss.
